...
module pck600_ppu_reg_sse710_secenc
#(
...
(
  ...
  begin
    ...
    {P_OFF,P_OFF},{P_MEM_RET,P_MEM_RET},{P_ON,P_ON},{P_WRM_RST,P_WRM_RST}:
    begin
      pwr_policy_match = 1'b1;
    end
    {P_OFF,P_MEM_RET},{P_OFF,P_ON},{P_OFF,P_WRM_RST},{P_MEM_RET,P_OFF},
    {P_MEM_RET,P_ON},{P_MEM_RET,P_WRM_RST},{P_ON,P_OFF},{P_ON,P_MEM_RET},
    {P_ON,P_WRM_RST},{P_WRM_RST,P_OFF},{P_WRM_RST,P_MEM_RET},{P_WRM_RST,P_ON}:
    begin
...
endgenerate
  ...
  pck600_ppu_edge_detector_sse710_secenc
  #(
