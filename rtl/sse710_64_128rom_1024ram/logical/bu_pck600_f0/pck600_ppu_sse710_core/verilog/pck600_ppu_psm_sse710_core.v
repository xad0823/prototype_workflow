...
module pck600_ppu_psm_sse710_core
#(
...
(
  ...
  output wire                 trans_emu_to_non_emu_o,
  ...
  reg                         devemuclken_r;
  reg                         devisolaten_r;
  reg                         devemuisolaten_r;
  reg                         devwarmresetn_r;
  reg                         devretresetn_r;
  reg                         devporesetn_r;

  reg                         nxt_devclken_r;
  reg                         nxt_devemuclken_r;
  reg                         nxt_devisolaten_r;
  reg                         nxt_devemuisolaten_r;
  reg                         nxt_devwarmresetn_r;
  reg                         nxt_devretresetn_r;
  ...
  begin
    ...
    EMU2NON_EMU,H2L_DCIRP,H2L_DCIR,L2H_PICDD,L2H_PICRD,L2H_ICRD,ON_WARM_DEV,WARM_ON_DEV:
    begin
  ...
  begin
    ...
    begin
      ...
      begin
        case(trans_path_i[TRANS_PATH_WIDTH-1:0])
        EMU2NON_EMU,H2L_DCIRP,H2L_DCIR,ON_WARM_DEV:
        begin
        ...
        L2H_ICRD:
        begin
          //Transition to SM_ISO and load CRI counter with ISO_CLKEN_DLY 
    ...
    begin
      ...
      {1'b0,EMU2NON_EMU},{1'b0,H2L_DCIRP},{1'b0,H2L_DCIR},{1'b0,ON_WARM_DEV}:
      begin
      ...
      {1'b1,EMU2NON_EMU},{1'b1,H2L_DCIRP},
      {1'b1,H2L_DCIR}:
      begin
    ...
    begin
      ...
      L2H_PICRD,L2H_ICRD:
      begin
        //Wait for CRI counter to expire then transition to SM_RST
        //and load the CRI counter with RST_HWSTAT_DLY
        nxt_state[3:0] = SM_RST;
        state_en = cri_counter_expired;
        diu_req[1:0] = 2'b00;
        diu_curr_value = 1'b0;
    ...
    begin
      ...
      L2H_PICRD,L2H_ICRD:
      begin
        //Only stay in this state for 1 cycle then transition to SM_DEV
        //requesting a handshake to the target value
        nxt_state[3:0] = SM_DEV;
        state_en = 1'b1;
        diu_req[1:0] = 2'b11;
        diu_curr_value = 1'b0;
  ...
  assign emulated_to_non_emulated = (trans_path_i[TRANS_PATH_WIDTH-1:0] == EMU2NON_EMU);
...
endgenerate
  ...
  begin
    ...
    begin
      ...
      devemuclken_r <= nxt_devemuclken_r;
    end
  end
  ...
  begin
    ...
    begin
      devisolaten_r <= 1'b0;
      devemuisolaten_r <= 1'b0;
    end
    else if(iso_en)
    begin
      devisolaten_r <= nxt_devisolaten_r;
      devemuisolaten_r <= nxt_devemuisolaten_r;
    end
  end
  ...
  begin
    ...
    begin
      ...
      devretresetn_r <= nxt_devretresetn_r;
  ...
  begin
    ...
    begin
      //OFF
      nxt_devclken_r = 1'b0;
      nxt_devemuclken_r = 1'b0;
      nxt_devisolaten_r = 1'b0;
      nxt_devemuisolaten_r = 1'b0;
      nxt_devwarmresetn_r = 1'b0;
      nxt_devretresetn_r = 1'b0;
    ...
    begin
      //OFF_EMU
      nxt_devclken_r = 1'b0;
      nxt_devemuclken_r = 1'b1;
      nxt_devisolaten_r = 1'b0;
      nxt_devemuisolaten_r = 1'b1;
      nxt_devwarmresetn_r = 1'b0;
      nxt_devretresetn_r = 1'b0;
      nxt_devporesetn_r = 1'b1;
      nxt_ppuhwstat_pwr_mode_r[15:0] = PPUHWSTAT_OFF_EMU;
    end
    P_FULL_RET:
    begin
      //FULL_RET
      ...
      nxt_devemuisolaten_r = 1'b0;
      nxt_devwarmresetn_r = 1'b0;
      nxt_devretresetn_r = 1'b1;
      nxt_devporesetn_r = 1'b1;
      nxt_ppuhwstat_pwr_mode_r[15:0] = PPUHWSTAT_FULL_RET;
    end
    P_ON:
    begin
      //ON
    ...
    begin
      //X-Prop
      nxt_devclken_r = 1'bx;
      nxt_devemuclken_r = 1'bx;
      nxt_devisolaten_r = 1'bx;
      nxt_devemuisolaten_r = 1'bx;
      nxt_devwarmresetn_r = 1'bx;
      nxt_devretresetn_r = 1'bx;
  ...
  assign devemuclken_o = devemuclken_r;
  assign devisolaten_o = devisolaten_r;
  assign devemuisolaten_o = devemuisolaten_r;
  assign devwarmresetn_o = devwarmresetn_r;
  assign devretresetn_o = devretresetn_r;
  ...
  assign trans_emu_to_non_emu_o = emulated_to_non_emulated;
