...
(
  ...
  `include "pck600_ppu_config_sse710_core.v"
  ...
  (
    ...
    .trans_emu_to_non_emu_i (trans_emu_to_non_emu),
  ...
  (
    ...
    .trans_emu_to_non_emu_o (trans_emu_to_non_emu),
  ...
  pck600_ppu_input_block_sse710_core
  #(
    .SYNC_EN(DEV_SYNC_EN)
  )
