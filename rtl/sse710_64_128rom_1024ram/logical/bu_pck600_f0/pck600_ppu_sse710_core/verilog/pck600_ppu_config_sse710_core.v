...
`include "pck600_ppu_param_sse710_core.v"
...
localparam STA_OFF_EMU_SPT_CFG = 1'b1;
localparam STA_MEM_RET_SPT_CFG = 1'b0;
localparam STA_MEM_RET_EMU_SPT_CFG = 1'b0;
localparam STA_LGC_RET_SPT_CFG = 1'b0;
localparam STA_FULL_RET_SPT_CFG = 1'b1;
...
localparam PWR_MODE_ENTRY_DEL_CFG = 1'b0;
...
localparam DEV_ACTIVE_SYNC_EN = 0;
