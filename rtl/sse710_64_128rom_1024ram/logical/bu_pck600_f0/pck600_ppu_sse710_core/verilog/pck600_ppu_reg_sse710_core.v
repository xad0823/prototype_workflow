...
module pck600_ppu_reg_sse710_core
#(
  ...
  parameter PWR_MODE_ENTRY_DEL_CFG = 1'b0,
...
(
  ...
  input wire                  trans_emu_to_non_emu_i,
  ...
  reg                         emu_accept_irq_mask_r;
  reg                         emu_deny_irq_mask_r;
  ...
  reg                         emu_accept_irq_st_r;
  reg                         emu_deny_irq_st_r;
  ...
  reg                         nxt_emu_accept_irq_st_r;
  reg                         nxt_emu_deny_irq_st_r;
  ...
  wire                        emu_accept_irq_pulse_mask;
  wire                        emu_deny_irq_pulse_mask;
  ...
  wire                        emu_accept_irq_clear;
  wire                        emu_deny_irq_clear;
  ...
  assign pmer_read_en = (paddr[11:2] == PPU_PMER[11:2]);
  ...
  assign pmer_write_en = (paddr[11:2] == PPU_PMER[11:2]) & global_write_en;
  ...
  begin
    ...
    begin
      ...
      pwr_policy_2_r <= DEF_PWR_POLICY[2];
    ...
    begin
      ...
      pwr_policy_2_r <= nxt_pwr_policy_2_r;
  ...
  begin
    ...
    begin
      ...
      nxt_pwr_policy_2_r = pwr_policy_init_i[2];
  ...
  begin
    ...
    else if(pmer_write_en)
    begin
      emu_en_r <= pwdata[0];
    end
  end

  assign pmer_rdata[31:0] = {31'h00000000,
                            (pmer_read_en & emu_en_r)};
  ...
  begin
    ...
    begin
      ...
      emu_accept_irq_mask_r <= 1'b1;
      emu_deny_irq_mask_r <= 1'b1;
    end
    ...
    begin
      ...
      emu_accept_irq_mask_r <= pwdata[3];
      emu_deny_irq_mask_r <= pwdata[4];
    end
  end

  assign imr_rdata[31:0] = {26'h0000000,
                           1'b0,
                           (imr_read_en & emu_deny_irq_mask_r),
                           (imr_read_en & emu_accept_irq_mask_r),
  ...
  begin
    ...
    begin
      ...
      emu_accept_irq_st_r <= 1'b0;
      emu_deny_irq_st_r <= 1'b0;
    ...
    begin
      ...
      emu_accept_irq_st_r <= nxt_emu_accept_irq_st_r;
      emu_deny_irq_st_r <= nxt_emu_deny_irq_st_r;
  ...
  assign isr_rdata[31:0] = {8'h00,
                           ...
                           1'b0,
                           1'b0,
                           (isr_read_en & emu_deny_irq_st_r),
                           (isr_read_en & emu_accept_irq_st_r),
  ...
  begin
    ...
    {P_OFF,P_OFF},{P_OFF,P_OFF_EMU},{P_OFF_EMU,P_OFF},{P_OFF_EMU,P_OFF_EMU},
    {P_FULL_RET,P_FULL_RET},{P_ON,P_ON},{P_WRM_RST,P_WRM_RST}:
    begin
      pwr_policy_match = 1'b1;
    end
    {P_OFF,P_FULL_RET},{P_OFF,P_ON},{P_OFF,P_WRM_RST},{P_OFF_EMU,P_FULL_RET},
    {P_OFF_EMU,P_ON},{P_OFF_EMU,P_WRM_RST},{P_FULL_RET,P_OFF},{P_FULL_RET,P_OFF_EMU},
    {P_FULL_RET,P_ON},{P_FULL_RET,P_WRM_RST},{P_ON,P_OFF},{P_ON,P_OFF_EMU},
    {P_ON,P_FULL_RET},{P_ON,P_WRM_RST},{P_WRM_RST,P_OFF},{P_WRM_RST,P_OFF_EMU},
    {P_WRM_RST,P_FULL_RET},{P_WRM_RST,P_ON}:
    begin
  ...
  assign sta_policy_trn_irq_trans_accept = trans_comp_accept_i & ~pwr_dyn_st_i & pwr_policy_match & ~trans_emu_to_non_emu_i &
  ...
  always@*
  begin
    case({emu_accept_irq_pulse_mask,emu_accept_irq_clear})
    2'b00:  nxt_emu_accept_irq_st_r = emu_accept_irq_st_r;
    2'b01:  nxt_emu_accept_irq_st_r = 1'b0;
    2'b10:  nxt_emu_accept_irq_st_r = 1'b1;
    2'b11:  nxt_emu_accept_irq_st_r = 1'b1;
    default:nxt_emu_accept_irq_st_r = 1'bx;
    endcase
  end

  assign emu_accept_irq_clear = isr_write_en & pwdata[3];
  assign emu_accept_irq_pulse_mask = trans_comp_accept_i & trans_emu_to_non_emu_i &
                                     ~trans_init_i & ~emu_accept_irq_mask_r;

  always@*
  begin
    case({emu_deny_irq_pulse_mask,emu_deny_irq_clear})
    2'b00:  nxt_emu_deny_irq_st_r = emu_deny_irq_st_r;
    2'b01:  nxt_emu_deny_irq_st_r = 1'b0;
    2'b10:  nxt_emu_deny_irq_st_r = 1'b1;
    2'b11:  nxt_emu_deny_irq_st_r = 1'b1;
    default:nxt_emu_deny_irq_st_r = 1'bx;
    endcase
  end

  assign emu_deny_irq_clear = isr_write_en & pwdata[4];
  assign emu_deny_irq_pulse_mask = trans_comp_deny_i & trans_emu_to_non_emu_i &
                                   ~trans_init_i & ~emu_deny_irq_mask_r;
...
endgenerate
  ...
  assign nxt_irq_r = |({nxt_pwr_active_edge_irq_st_r[NUM_PWR_DEVACTIVE-1:DEVACTIVE_LSB],
                        nxt_emu_deny_irq_st_r,
                        nxt_emu_accept_irq_st_r,
  ...
  pck600_ppu_edge_detector_sse710_core
  #(
