...
module pck600_lpd_p_pstatemap_sse710_clustop 
#(
  parameter DEV_ID          = 0,
...
localparam DEV_P_CH_0_PWR_PSTATE_MAP_0001 = 4'b0000;
localparam DEV_P_CH_0_PWR_PSTATE_MAP_0010 = 4'b0000;
localparam DEV_P_CH_0_PWR_PSTATE_MAP_0011 = 4'b0000;
localparam DEV_P_CH_0_PWR_PSTATE_MAP_0100 = 4'b0000;
localparam DEV_P_CH_0_PWR_PSTATE_MAP_0101 = 4'b0000;
localparam DEV_P_CH_0_PWR_PSTATE_MAP_0110 = 4'b0000;
localparam DEV_P_CH_0_PWR_PSTATE_MAP_0111 = 4'b1000;
localparam DEV_P_CH_0_PWR_PSTATE_MAP_1000 = 4'b1000;
localparam DEV_P_CH_0_PWR_PSTATE_MAP_1001 = 4'b0000;
localparam DEV_P_CH_0_PWR_PSTATE_MAP_1010 = 4'b1000;
...
localparam DEV_P_CH_1_PWR_PSTATE_MAP_0001 = 4'b0000;
localparam DEV_P_CH_1_PWR_PSTATE_MAP_0010 = 4'b0000;
localparam DEV_P_CH_1_PWR_PSTATE_MAP_0011 = 4'b0000;
localparam DEV_P_CH_1_PWR_PSTATE_MAP_0100 = 4'b0000;
localparam DEV_P_CH_1_PWR_PSTATE_MAP_0101 = 4'b0000;
localparam DEV_P_CH_1_PWR_PSTATE_MAP_0110 = 4'b0000;
localparam DEV_P_CH_1_PWR_PSTATE_MAP_0111 = 4'b0000;
localparam DEV_P_CH_1_PWR_PSTATE_MAP_1000 = 4'b1000;
localparam DEV_P_CH_1_PWR_PSTATE_MAP_1001 = 4'b0000;
localparam DEV_P_CH_1_PWR_PSTATE_MAP_1010 = 4'b1000;
...
localparam DEV_P_CH_2_PWR_PSTATE_MAP_0001 = 4'b0000;
localparam DEV_P_CH_2_PWR_PSTATE_MAP_0010 = 4'b0000;
localparam DEV_P_CH_2_PWR_PSTATE_MAP_0011 = 4'b0000;
localparam DEV_P_CH_2_PWR_PSTATE_MAP_0100 = 4'b0000;
localparam DEV_P_CH_2_PWR_PSTATE_MAP_0101 = 4'b0000;
localparam DEV_P_CH_2_PWR_PSTATE_MAP_0110 = 4'b0000;
localparam DEV_P_CH_2_PWR_PSTATE_MAP_0111 = 4'b1000;
localparam DEV_P_CH_2_PWR_PSTATE_MAP_1000 = 4'b1000;
localparam DEV_P_CH_2_PWR_PSTATE_MAP_1001 = 4'b0000;
localparam DEV_P_CH_2_PWR_PSTATE_MAP_1010 = 4'b1000;
...
localparam DEV_P_CH_3_PWR_PSTATE_MAP_0000 = 4'b0000;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_0001 = 4'b0000;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_0010 = 4'b0000;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_0011 = 4'b0000;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_0100 = 4'b0000;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_0101 = 4'b0000;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_0110 = 4'b0000;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_0111 = 4'b1000;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_1000 = 4'b1000;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_1001 = 4'b0000;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_1010 = 4'b1000;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_1011 = 4'b1011;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_1100 = 4'b1100;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_1101 = 4'b1101;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_1110 = 4'b1110;
localparam DEV_P_CH_3_PWR_PSTATE_MAP_1111 = 4'b1111;
  ...
  if (DEV_ID == 0) 
    ...
    begin         
      case (pstate_in[3:0])
        ...
        4'b0000 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_0000;
        4'b0001 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_0001;
        4'b0010 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_0010;
        4'b0011 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_0011;
        4'b0100 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_0100;
        4'b0101 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_0101;
        4'b0110 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_0110;
        4'b0111 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_0111;
        4'b1000 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_1000;
        4'b1001 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_1001;
        4'b1010 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_1010;
        4'b1011 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_1011;
        4'b1100 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_1100;
        4'b1101 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_1101;
        4'b1110 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_1110;
        4'b1111 : pstate_map[3:0] = DEV_P_CH_3_PWR_PSTATE_MAP_1111;
        default : pstate_map[3:0] = 4'hx;
      endcase
