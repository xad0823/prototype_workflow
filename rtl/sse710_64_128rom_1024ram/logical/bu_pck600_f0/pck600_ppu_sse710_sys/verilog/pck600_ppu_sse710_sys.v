...
(
  ...
  `include "pck600_ppu_config_sse710_sys.v"
  ...
  wire                        pwr_dyn_en;
  wire [7:0]                  off_del;
  wire [7:0]                  mem_ret_del;
  wire [7:0]                  func_ret_del;
  ...
  (
    ...
    //PPU_EDTR0
    .off_del_o              (off_del),
    .mem_ret_del_o          (mem_ret_del),
    //PPU_EDTR1
    .func_ret_del_o         (func_ret_del),
    //PPU_DCDR0
  ...
  (
    ...
    .off_del_i              (off_del),
    .mem_ret_del_i          (mem_ret_del),
    .func_ret_del_i         (func_ret_del),
  ...
  pck600_ppu_input_block_sse710_sys
  #(
    .SYNC_EN(DEV_SYNC_EN)
  )
