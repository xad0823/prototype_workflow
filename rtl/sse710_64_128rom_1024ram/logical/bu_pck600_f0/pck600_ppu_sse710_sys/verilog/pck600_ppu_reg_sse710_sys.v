...
module pck600_ppu_reg_sse710_sys
#(
  ...
  parameter OFF_MEM_RET_TRANS_CFG = 1'b1,
...
(
  ...
  output wire [7:0]           mem_ret_del_o,
  //PPU_EDTR1
  output wire [7:0]           func_ret_del_o,
  //PPU_DCDR0
  ...
  reg [7:0]                   off_del_r;
  reg [7:0]                   mem_ret_del_r;

  reg [7:0]                   func_ret_del_r;
  ...
  assign edtr1_read_en = (paddr[11:2] == PPU_EDTR1[11:2]);
  ...
  assign edtr1_write_en = (paddr[11:2] == PPU_EDTR1[11:2]) & global_write_en;
  ...
  begin
    ...
    begin
      ...
      pwr_policy_1_r <= DEF_PWR_POLICY[1];
    ...
    begin
      ...
      pwr_policy_1_r <= nxt_pwr_policy_1_r;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        nxt_pwr_policy_1_r = pwr_policy_1_r;
    ...
    begin
      ...
      nxt_pwr_policy_1_r = pwr_policy_init_i[1];
  ...
  begin
    ...
    {P_OFF,P_OFF},{P_MEM_RET,P_MEM_RET},{P_FUNC_RET,P_FUNC_RET},{P_ON,P_ON},
    {P_WRM_RST,P_WRM_RST}:
    begin
      pwr_policy_match = 1'b1;
    end
    {P_OFF,P_MEM_RET},{P_OFF,P_FUNC_RET},{P_OFF,P_ON},{P_OFF,P_WRM_RST},
    {P_MEM_RET,P_OFF},{P_MEM_RET,P_FUNC_RET},{P_MEM_RET,P_ON},{P_MEM_RET,P_WRM_RST},
    {P_FUNC_RET,P_OFF},{P_FUNC_RET,P_MEM_RET},{P_FUNC_RET,P_ON},{P_FUNC_RET,P_WRM_RST},
    {P_ON,P_OFF},{P_ON,P_MEM_RET},{P_ON,P_FUNC_RET},{P_ON,P_WRM_RST},
    {P_WRM_RST,P_OFF},{P_WRM_RST,P_MEM_RET},{P_WRM_RST,P_FUNC_RET},{P_WRM_RST,P_ON}:
    begin
...
endgenerate
  ...
  pck600_ppu_edge_detector_sse710_sys
  #(
  ...
  begin
    ...
    begin
      off_del_r[7:0] <= 8'h00;
      mem_ret_del_r[7:0] <= 8'h00;
    end
    else if(edtr0_write_en)
    begin
      off_del_r[7:0] <= pwdata[7:0];
      mem_ret_del_r[7:0] <= pwdata[15:8];
    end
  end

  assign edtr0_rdata[31:0] = {8'h00,
                             8'h00,
                             ({8{edtr0_read_en}} & mem_ret_del_r[7:0]),
  ...
  begin
    if(!reset_n)
    begin
      func_ret_del_r[7:0] <= 8'h00;
    end
    else if(edtr1_write_en)
    begin
      func_ret_del_r[7:0] <= pwdata[15:8];
    end
  end

  assign edtr1_rdata[31:0] = {16'h0000,
                             ({8{edtr1_read_en}} & func_ret_del_r[7:0]),
                             8'h00};
  ...
  assign mem_ret_del_o[7:0] = mem_ret_del_r[7:0];
  assign func_ret_del_o = func_ret_del_r;
