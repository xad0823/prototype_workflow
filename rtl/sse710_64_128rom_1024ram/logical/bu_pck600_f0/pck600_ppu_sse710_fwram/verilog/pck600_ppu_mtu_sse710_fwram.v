...
module pck600_ppu_mtu_sse710_fwram
#(
...
(
  ...
  `include "pck600_ppu_enum_sse710_fwram.v"
...
localparam SM_FINAL = 2'b11;
  ...
  begin
    ...
    {1'b0,P_FUNC_RET,P_OFF,P_OFF_EMU},{1'b1,P_FUNC_RET,P_OFF,P_OFF_EMU},
    {1'b0,P_FUNC_RET,P_OFF,P_MEM_RET},{1'b1,P_FUNC_RET,P_OFF,P_MEM_RET},
    ...
    {1'b0,P_FUNC_RET,P_FUNC_RET,P_OFF},{1'b1,P_FUNC_RET,P_FUNC_RET,P_OFF},
    {1'b0,P_FUNC_RET,P_FUNC_RET,P_OFF_EMU},{1'b1,P_FUNC_RET,P_FUNC_RET,P_OFF_EMU},
    {1'b0,P_FUNC_RET,P_FUNC_RET,P_MEM_RET},{1'b1,P_FUNC_RET,P_FUNC_RET,P_MEM_RET},
    {1'b0,P_FUNC_RET,P_FUNC_RET,P_MEM_RET_EMU},{1'b1,P_FUNC_RET,P_FUNC_RET,P_MEM_RET_EMU},
    {1'b0,P_FUNC_RET,P_FUNC_RET,P_LGC_RET},{1'b1,P_FUNC_RET,P_FUNC_RET,P_LGC_RET},
    {1'b0,P_FUNC_RET,P_FUNC_RET,P_FULL_RET},{1'b1,P_FUNC_RET,P_FUNC_RET,P_FULL_RET},
    {1'b0,P_FUNC_RET,P_FUNC_RET,P_MEM_OFF},{1'b1,P_FUNC_RET,P_FUNC_RET,P_MEM_OFF},
    {1'b0,P_FUNC_RET,P_FUNC_RET,P_FUNC_RET},{1'b1,P_FUNC_RET,P_FUNC_RET,P_FUNC_RET},
    {1'b0,P_FUNC_RET,P_FUNC_RET,P_ON},{1'b0,P_FUNC_RET,P_FUNC_RET,P_WRM_RST},
    {1'b1,P_FUNC_RET,P_WRM_RST,P_OFF},{1'b1,P_FUNC_RET,P_WRM_RST,P_OFF_EMU},
    {1'b1,P_FUNC_RET,P_WRM_RST,P_MEM_RET},{1'b1,P_FUNC_RET,P_WRM_RST,P_MEM_RET_EMU},
    {1'b1,P_FUNC_RET,P_WRM_RST,P_LGC_RET},{1'b1,P_FUNC_RET,P_WRM_RST,P_FULL_RET},
    {1'b1,P_FUNC_RET,P_WRM_RST,P_MEM_OFF},{1'b1,P_FUNC_RET,P_WRM_RST,P_FUNC_RET},
    {1'b1,P_FUNC_RET,P_WRM_RST,P_ON},{1'b0,P_ON,P_OFF,P_OFF_EMU},
    {1'b0,P_ON,P_OFF,P_MEM_RET},{1'b0,P_ON,P_OFF,P_MEM_RET_EMU},
    {1'b0,P_ON,P_OFF,P_LGC_RET},{1'b0,P_ON,P_OFF,P_FULL_RET},
    {1'b0,P_ON,P_OFF,P_MEM_OFF},{1'b0,P_ON,P_OFF,P_FUNC_RET},
    {1'b0,P_ON,P_OFF,P_ON},{1'b1,P_ON,P_OFF,P_ON},
    {1'b0,P_ON,P_OFF,P_WRM_RST},{1'b0,P_ON,P_FUNC_RET,P_ON},
    {1'b1,P_ON,P_FUNC_RET,P_ON},{1'b0,P_ON,P_FUNC_RET,P_WRM_RST},
    {1'b0,P_ON,P_ON,P_OFF},{1'b1,P_ON,P_ON,P_OFF},
    {1'b0,P_ON,P_ON,P_OFF_EMU},{1'b1,P_ON,P_ON,P_OFF_EMU},
    {1'b0,P_ON,P_ON,P_MEM_RET},{1'b1,P_ON,P_ON,P_MEM_RET},
    {1'b0,P_ON,P_ON,P_MEM_RET_EMU},{1'b1,P_ON,P_ON,P_MEM_RET_EMU},
    {1'b0,P_ON,P_ON,P_LGC_RET},{1'b1,P_ON,P_ON,P_LGC_RET},
    {1'b0,P_ON,P_ON,P_FULL_RET},{1'b1,P_ON,P_ON,P_FULL_RET},
    {1'b0,P_ON,P_ON,P_MEM_OFF},{1'b1,P_ON,P_ON,P_MEM_OFF},
    {1'b0,P_ON,P_ON,P_FUNC_RET},{1'b1,P_ON,P_ON,P_FUNC_RET},
    {1'b0,P_ON,P_ON,P_ON},{1'b1,P_ON,P_ON,P_ON},
    {1'b0,P_ON,P_ON,P_WRM_RST},{1'b1,P_ON,P_WRM_RST,P_OFF},
    {1'b1,P_ON,P_WRM_RST,P_OFF_EMU},{1'b1,P_ON,P_WRM_RST,P_MEM_RET},
    {1'b1,P_ON,P_WRM_RST,P_MEM_RET_EMU},{1'b1,P_ON,P_WRM_RST,P_LGC_RET},
    {1'b1,P_ON,P_WRM_RST,P_FULL_RET},{1'b1,P_ON,P_WRM_RST,P_MEM_OFF},
    {1'b1,P_ON,P_WRM_RST,P_FUNC_RET},{1'b1,P_ON,P_WRM_RST,P_ON},
    {1'b0,P_WRM_RST,P_OFF,P_OFF_EMU},{1'b0,P_WRM_RST,P_OFF,P_MEM_RET},
    {1'b0,P_WRM_RST,P_OFF,P_MEM_RET_EMU},{1'b0,P_WRM_RST,P_OFF,P_LGC_RET},
    {1'b0,P_WRM_RST,P_OFF,P_FULL_RET},{1'b0,P_WRM_RST,P_OFF,P_MEM_OFF},
    {1'b0,P_WRM_RST,P_OFF,P_FUNC_RET},{1'b0,P_WRM_RST,P_OFF,P_ON},
    {1'b0,P_WRM_RST,P_OFF,P_WRM_RST},{1'b1,P_WRM_RST,P_OFF,P_WRM_RST},
    {1'b0,P_WRM_RST,P_FUNC_RET,P_ON},{1'b0,P_WRM_RST,P_FUNC_RET,P_WRM_RST},
    {1'b1,P_WRM_RST,P_FUNC_RET,P_WRM_RST},{1'b0,P_WRM_RST,P_ON,P_WRM_RST},
    ...
    {1'b1,P_OFF,P_ON,P_OFF},{1'b0,P_OFF,P_ON,P_FUNC_RET},
    {1'b1,P_OFF,P_ON,P_FUNC_RET},{1'b0,P_OFF,P_ON,P_ON},
    {1'b1,P_OFF,P_ON,P_ON},{1'b0,P_OFF,P_ON,P_WRM_RST},
    {1'b0,P_OFF,P_WRM_RST,P_OFF},{1'b0,P_OFF,P_WRM_RST,P_FUNC_RET},
    ...
    {1'b1,P_FUNC_RET,P_OFF,P_ON},{1'b1,P_FUNC_RET,P_FUNC_RET,P_ON},
    {1'b0,P_FUNC_RET,P_ON,P_OFF},{1'b1,P_FUNC_RET,P_ON,P_OFF},
    {1'b0,P_FUNC_RET,P_ON,P_OFF_EMU},{1'b1,P_FUNC_RET,P_ON,P_OFF_EMU},
    {1'b0,P_FUNC_RET,P_ON,P_MEM_RET},{1'b1,P_FUNC_RET,P_ON,P_MEM_RET},
    {1'b0,P_FUNC_RET,P_ON,P_MEM_RET_EMU},{1'b1,P_FUNC_RET,P_ON,P_MEM_RET_EMU},
    {1'b0,P_FUNC_RET,P_ON,P_LGC_RET},{1'b1,P_FUNC_RET,P_ON,P_LGC_RET},
    {1'b0,P_FUNC_RET,P_ON,P_FULL_RET},{1'b1,P_FUNC_RET,P_ON,P_FULL_RET},
    {1'b0,P_FUNC_RET,P_ON,P_MEM_OFF},{1'b1,P_FUNC_RET,P_ON,P_MEM_OFF},
    {1'b0,P_FUNC_RET,P_ON,P_FUNC_RET},{1'b1,P_FUNC_RET,P_ON,P_FUNC_RET},
    {1'b0,P_FUNC_RET,P_ON,P_ON},{1'b1,P_FUNC_RET,P_ON,P_ON},
    {1'b0,P_FUNC_RET,P_ON,P_WRM_RST},{1'b0,P_FUNC_RET,P_WRM_RST,P_OFF},
    {1'b0,P_FUNC_RET,P_WRM_RST,P_OFF_EMU},{1'b0,P_FUNC_RET,P_WRM_RST,P_MEM_RET},
    {1'b0,P_FUNC_RET,P_WRM_RST,P_MEM_RET_EMU},{1'b0,P_FUNC_RET,P_WRM_RST,P_LGC_RET},
    {1'b0,P_FUNC_RET,P_WRM_RST,P_FULL_RET},{1'b0,P_FUNC_RET,P_WRM_RST,P_MEM_OFF},
    {1'b0,P_FUNC_RET,P_WRM_RST,P_FUNC_RET},{1'b0,P_FUNC_RET,P_WRM_RST,P_ON},
    {1'b0,P_FUNC_RET,P_WRM_RST,P_WRM_RST}:
    begin
      //Transition to, when there is no pipeline flush, P_ON
    ...
    {1'b1,P_ON,P_OFF,P_FUNC_RET},{1'b0,P_ON,P_FUNC_RET,P_OFF},
    {1'b1,P_ON,P_FUNC_RET,P_OFF},{1'b0,P_ON,P_FUNC_RET,P_OFF_EMU},
    {1'b1,P_ON,P_FUNC_RET,P_OFF_EMU},{1'b0,P_ON,P_FUNC_RET,P_MEM_RET},
    {1'b1,P_ON,P_FUNC_RET,P_MEM_RET},{1'b0,P_ON,P_FUNC_RET,P_MEM_RET_EMU},
    {1'b1,P_ON,P_FUNC_RET,P_MEM_RET_EMU},{1'b0,P_ON,P_FUNC_RET,P_LGC_RET},
    {1'b1,P_ON,P_FUNC_RET,P_LGC_RET},{1'b0,P_ON,P_FUNC_RET,P_FULL_RET},
    {1'b1,P_ON,P_FUNC_RET,P_FULL_RET},{1'b0,P_ON,P_FUNC_RET,P_MEM_OFF},
    {1'b1,P_ON,P_FUNC_RET,P_MEM_OFF},{1'b0,P_ON,P_FUNC_RET,P_FUNC_RET},
    {1'b1,P_ON,P_FUNC_RET,P_FUNC_RET}:
    begin
