...
module pck600_lpd_p_sse710_extsys 
#(
...
wire       int_clken;
wire       ctrl_preq_ss;
wire [2:0] dev_paccept_ss;
wire [2:0] dev_pdeny_ss;
wire       clk_enable;

pck600_lpd_p_diu_sse710_extsys  #(
    .SEQUENCER          (SEQUENCER),
    .DEV_P_CH_NUM       (3),
...
pck600_lpd_p_active_async_sse710_extsys  u_lpd_p_active (
...
pck600_lpd_p_pch_tinit_sync_sse710_extsys 
 #(
