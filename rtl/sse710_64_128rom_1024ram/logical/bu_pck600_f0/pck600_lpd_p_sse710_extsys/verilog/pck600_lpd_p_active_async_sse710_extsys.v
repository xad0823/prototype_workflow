...
module pck600_lpd_p_active_async_sse710_extsys 
(
  ...
  (
    .or_tree_i ({dev0_pactive_i[0],dev1_pactive_i[0],dev2_pactive_i[0]}),
  ...
  (
    .or_tree_i ({dev0_pactive_i[1],dev1_pactive_i[1],dev2_pactive_i[1]}),
  ...
  (
    .or_tree_i ({dev0_pactive_i[2],dev1_pactive_i[2],dev2_pactive_i[2]}),
  ...
  (
    .or_tree_i ({dev0_pactive_i[3],dev1_pactive_i[3],dev2_pactive_i[3]}),
  ...
  (
    .or_tree_i ({dev0_pactive_i[4],dev1_pactive_i[4],dev2_pactive_i[4]}),
  ...
  (
    .or_tree_i ({dev0_pactive_i[5],dev1_pactive_i[5],dev2_pactive_i[5]}),
  ...
  (
    .or_tree_i ({dev0_pactive_i[6],dev1_pactive_i[6],dev2_pactive_i[6]}),
  ...
  (
    .or_tree_i ({dev0_pactive_i[7],dev1_pactive_i[7],dev2_pactive_i[7]}),
  ...
  (
    .or_tree_i ({dev0_pactive_i[8],dev1_pactive_i[8],dev2_pactive_i[8]}),
  ...
  (
    .or_tree_i ({dev0_pactive_i[9],dev1_pactive_i[9],dev2_pactive_i[9]}),
  ...
  (
    .or_tree_i ({dev0_pactive_i[10],dev1_pactive_i[10],dev2_pactive_i[10]}),
