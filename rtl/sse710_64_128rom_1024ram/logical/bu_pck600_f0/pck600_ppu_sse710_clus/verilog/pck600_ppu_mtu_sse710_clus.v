...
module pck600_ppu_mtu_sse710_clus
#(
  ...
  parameter STA_MEM_OFF_SPT_CFG = 1'b1,
...
localparam SM_FINAL = 2'b11;
  ...
  begin
    ...
    {1'b0,P_MEM_OFF}:
    begin
      enable_modes_mask[NUM_PWR_DEVACTIVE-1:1] = {STA_MODES_EN[10:7],6'h3F};
    end
    {1'b0,P_FUNC_RET}:
    begin
    ...
    {1'b1,P_MEM_OFF}:
    begin
      enable_modes_mask[NUM_PWR_DEVACTIVE-1:1] = {DYN_MODES_EN[10:7],6'h3F};
    end
    {1'b1,P_FUNC_RET}:
    begin
  ...
  begin
    ...
    {1'b0,P_OFF,P_OFF,P_MEM_RET},{1'b0,P_OFF,P_OFF,P_MEM_OFF},
    {1'b0,P_OFF,P_OFF,P_FUNC_RET},{1'b0,P_OFF,P_OFF,P_ON},
    {1'b0,P_OFF,P_OFF,P_WRM_RST},{1'b1,P_OFF,P_WRM_RST,P_OFF},
    {1'b1,P_OFF,P_WRM_RST,P_MEM_RET},{1'b1,P_OFF,P_WRM_RST,P_FUNC_RET},
    {1'b1,P_OFF,P_WRM_RST,P_ON},{1'b0,P_MEM_RET,P_OFF,P_OFF_EMU},
    {1'b1,P_MEM_RET,P_OFF,P_OFF_EMU},{1'b0,P_MEM_RET,P_OFF,P_MEM_RET},
    {1'b1,P_MEM_RET,P_OFF,P_MEM_RET},{1'b0,P_MEM_RET,P_OFF,P_MEM_OFF},
    ...
    {1'b1,P_MEM_RET,P_MEM_RET,P_MEM_RET},{1'b0,P_MEM_RET,P_MEM_RET,P_MEM_OFF},
    {1'b0,P_MEM_RET,P_MEM_RET,P_FUNC_RET},{1'b0,P_MEM_RET,P_MEM_RET,P_ON},
    {1'b0,P_MEM_RET,P_MEM_RET,P_WRM_RST},{1'b1,P_MEM_RET,P_WRM_RST,P_OFF},
    {1'b1,P_MEM_RET,P_WRM_RST,P_OFF_EMU},{1'b1,P_MEM_RET,P_WRM_RST,P_MEM_RET},
    {1'b1,P_MEM_RET,P_WRM_RST,P_FUNC_RET},{1'b1,P_MEM_RET,P_WRM_RST,P_ON},
    {1'b0,P_MEM_OFF,P_OFF,P_OFF_EMU},{1'b0,P_MEM_OFF,P_OFF,P_MEM_RET},
    {1'b0,P_MEM_OFF,P_OFF,P_MEM_RET_EMU},{1'b0,P_MEM_OFF,P_OFF,P_LGC_RET},
    {1'b0,P_MEM_OFF,P_OFF,P_FULL_RET},{1'b0,P_MEM_OFF,P_OFF,P_MEM_OFF},
    {1'b1,P_MEM_OFF,P_OFF,P_MEM_OFF},{1'b0,P_MEM_OFF,P_OFF,P_FUNC_RET},
    {1'b0,P_MEM_OFF,P_OFF,P_ON},{1'b0,P_MEM_OFF,P_OFF,P_WRM_RST},
    {1'b0,P_MEM_OFF,P_MEM_RET,P_MEM_RET_EMU},{1'b0,P_MEM_OFF,P_MEM_RET,P_LGC_RET},
    {1'b0,P_MEM_OFF,P_MEM_RET,P_FULL_RET},{1'b0,P_MEM_OFF,P_MEM_RET,P_MEM_OFF},
    {1'b1,P_MEM_OFF,P_MEM_RET,P_MEM_OFF},{1'b0,P_MEM_OFF,P_MEM_RET,P_FUNC_RET},
    {1'b0,P_MEM_OFF,P_MEM_RET,P_ON},{1'b0,P_MEM_OFF,P_MEM_RET,P_WRM_RST},
    {1'b0,P_MEM_OFF,P_MEM_OFF,P_OFF},{1'b1,P_MEM_OFF,P_MEM_OFF,P_OFF},
    {1'b0,P_MEM_OFF,P_MEM_OFF,P_OFF_EMU},{1'b1,P_MEM_OFF,P_MEM_OFF,P_OFF_EMU},
    {1'b0,P_MEM_OFF,P_MEM_OFF,P_MEM_RET},{1'b1,P_MEM_OFF,P_MEM_OFF,P_MEM_RET},
    {1'b0,P_MEM_OFF,P_MEM_OFF,P_MEM_RET_EMU},{1'b1,P_MEM_OFF,P_MEM_OFF,P_MEM_RET_EMU},
    {1'b0,P_MEM_OFF,P_MEM_OFF,P_LGC_RET},{1'b1,P_MEM_OFF,P_MEM_OFF,P_LGC_RET},
    {1'b0,P_MEM_OFF,P_MEM_OFF,P_FULL_RET},{1'b1,P_MEM_OFF,P_MEM_OFF,P_FULL_RET},
    {1'b0,P_MEM_OFF,P_MEM_OFF,P_MEM_OFF},{1'b1,P_MEM_OFF,P_MEM_OFF,P_MEM_OFF},
    {1'b0,P_MEM_OFF,P_MEM_OFF,P_FUNC_RET},{1'b0,P_MEM_OFF,P_MEM_OFF,P_ON},
    {1'b0,P_MEM_OFF,P_MEM_OFF,P_WRM_RST},{1'b1,P_MEM_OFF,P_WRM_RST,P_OFF},
    {1'b1,P_MEM_OFF,P_WRM_RST,P_OFF_EMU},{1'b1,P_MEM_OFF,P_WRM_RST,P_MEM_RET},
    {1'b1,P_MEM_OFF,P_WRM_RST,P_MEM_RET_EMU},{1'b1,P_MEM_OFF,P_WRM_RST,P_LGC_RET},
    {1'b1,P_MEM_OFF,P_WRM_RST,P_FULL_RET},{1'b1,P_MEM_OFF,P_WRM_RST,P_MEM_OFF},
    {1'b1,P_MEM_OFF,P_WRM_RST,P_FUNC_RET},{1'b1,P_MEM_OFF,P_WRM_RST,P_ON},
    {1'b0,P_FUNC_RET,P_OFF,P_OFF_EMU},{1'b0,P_FUNC_RET,P_OFF,P_MEM_RET},
    {1'b0,P_FUNC_RET,P_OFF,P_MEM_RET_EMU},{1'b1,P_FUNC_RET,P_OFF,P_MEM_RET_EMU},
    {1'b0,P_FUNC_RET,P_OFF,P_LGC_RET},{1'b1,P_FUNC_RET,P_OFF,P_LGC_RET},
    {1'b0,P_FUNC_RET,P_OFF,P_FULL_RET},{1'b1,P_FUNC_RET,P_OFF,P_FULL_RET},
    {1'b0,P_FUNC_RET,P_OFF,P_MEM_OFF},{1'b1,P_FUNC_RET,P_OFF,P_MEM_OFF},
    {1'b0,P_FUNC_RET,P_OFF,P_FUNC_RET},{1'b1,P_FUNC_RET,P_OFF,P_FUNC_RET},
    {1'b0,P_FUNC_RET,P_OFF,P_ON},{1'b0,P_FUNC_RET,P_OFF,P_WRM_RST},
    {1'b0,P_FUNC_RET,P_MEM_RET,P_MEM_RET_EMU},{1'b1,P_FUNC_RET,P_MEM_RET,P_MEM_RET_EMU},
    {1'b0,P_FUNC_RET,P_MEM_RET,P_LGC_RET},{1'b1,P_FUNC_RET,P_MEM_RET,P_LGC_RET},
    {1'b0,P_FUNC_RET,P_MEM_RET,P_FULL_RET},{1'b1,P_FUNC_RET,P_MEM_RET,P_FULL_RET},
    {1'b0,P_FUNC_RET,P_MEM_RET,P_MEM_OFF},{1'b1,P_FUNC_RET,P_MEM_RET,P_MEM_OFF},
    {1'b0,P_FUNC_RET,P_MEM_RET,P_FUNC_RET},{1'b1,P_FUNC_RET,P_MEM_RET,P_FUNC_RET},
    {1'b0,P_FUNC_RET,P_MEM_RET,P_ON},{1'b0,P_FUNC_RET,P_MEM_RET,P_WRM_RST},
    {1'b1,P_FUNC_RET,P_MEM_OFF,P_OFF},{1'b1,P_FUNC_RET,P_MEM_OFF,P_OFF_EMU},
    {1'b1,P_FUNC_RET,P_MEM_OFF,P_MEM_RET},{1'b1,P_FUNC_RET,P_MEM_OFF,P_MEM_RET_EMU},
    {1'b1,P_FUNC_RET,P_MEM_OFF,P_LGC_RET},{1'b1,P_FUNC_RET,P_MEM_OFF,P_FULL_RET},
    {1'b1,P_FUNC_RET,P_MEM_OFF,P_MEM_OFF},{1'b0,P_FUNC_RET,P_MEM_OFF,P_FUNC_RET},
    {1'b1,P_FUNC_RET,P_MEM_OFF,P_FUNC_RET},{1'b0,P_FUNC_RET,P_MEM_OFF,P_ON},
    {1'b0,P_FUNC_RET,P_MEM_OFF,P_WRM_RST},{1'b0,P_FUNC_RET,P_FUNC_RET,P_OFF},
    ...
    {1'b0,P_ON,P_MEM_OFF,P_FUNC_RET},{1'b0,P_ON,P_MEM_OFF,P_ON},
    {1'b1,P_ON,P_MEM_OFF,P_ON},{1'b0,P_ON,P_MEM_OFF,P_WRM_RST},
    ...
    {1'b1,P_WRM_RST,P_MEM_RET,P_WRM_RST},{1'b0,P_WRM_RST,P_MEM_OFF,P_FUNC_RET},
    {1'b0,P_WRM_RST,P_MEM_OFF,P_ON},{1'b0,P_WRM_RST,P_MEM_OFF,P_WRM_RST},
    {1'b1,P_WRM_RST,P_MEM_OFF,P_WRM_RST},{1'b0,P_WRM_RST,P_FUNC_RET,P_ON},
    ...
    {1'b1,P_OFF,P_MEM_RET,P_MEM_RET},{1'b0,P_OFF,P_MEM_RET,P_MEM_OFF},
    {1'b0,P_OFF,P_MEM_RET,P_FUNC_RET},{1'b0,P_OFF,P_MEM_RET,P_ON},
    {1'b0,P_OFF,P_MEM_RET,P_WRM_RST}:
    begin
    ...
    {1'b1,P_OFF,P_MEM_OFF,P_OFF},{1'b1,P_OFF,P_MEM_OFF,P_MEM_RET},
    {1'b1,P_OFF,P_MEM_OFF,P_FUNC_RET},{1'b1,P_OFF,P_MEM_OFF,P_ON},
    {1'b0,P_OFF,P_FUNC_RET,P_OFF},{1'b1,P_OFF,P_FUNC_RET,P_OFF},
    {1'b0,P_OFF,P_FUNC_RET,P_MEM_RET},{1'b1,P_OFF,P_FUNC_RET,P_MEM_RET},
    {1'b0,P_OFF,P_FUNC_RET,P_MEM_OFF},{1'b0,P_OFF,P_FUNC_RET,P_FUNC_RET},
    {1'b1,P_OFF,P_FUNC_RET,P_FUNC_RET},{1'b0,P_OFF,P_FUNC_RET,P_ON},
    {1'b1,P_OFF,P_FUNC_RET,P_ON},{1'b0,P_OFF,P_FUNC_RET,P_WRM_RST},
    {1'b0,P_OFF,P_ON,P_OFF},{1'b1,P_OFF,P_ON,P_OFF},
    {1'b0,P_OFF,P_ON,P_MEM_RET},{1'b1,P_OFF,P_ON,P_MEM_RET},
    {1'b0,P_OFF,P_ON,P_MEM_OFF},{1'b0,P_OFF,P_ON,P_FUNC_RET},
    ...
    {1'b0,P_OFF,P_WRM_RST,P_MEM_OFF},{1'b0,P_OFF,P_WRM_RST,P_FUNC_RET},
    {1'b0,P_OFF,P_WRM_RST,P_ON},{1'b0,P_OFF,P_WRM_RST,P_WRM_RST},
    {1'b0,P_MEM_RET,P_OFF,P_OFF},{1'b1,P_MEM_RET,P_OFF,P_OFF},
    {1'b1,P_MEM_RET,P_OFF,P_FUNC_RET},{1'b1,P_MEM_RET,P_OFF,P_ON},
    {1'b1,P_MEM_RET,P_MEM_RET,P_FUNC_RET},{1'b1,P_MEM_RET,P_MEM_RET,P_ON},
    {1'b0,P_MEM_RET,P_MEM_OFF,P_OFF},{1'b1,P_MEM_RET,P_MEM_OFF,P_OFF},
    {1'b0,P_MEM_RET,P_MEM_OFF,P_OFF_EMU},{1'b1,P_MEM_RET,P_MEM_OFF,P_OFF_EMU},
    {1'b0,P_MEM_RET,P_MEM_OFF,P_MEM_RET},{1'b1,P_MEM_RET,P_MEM_OFF,P_MEM_RET},
    {1'b0,P_MEM_RET,P_MEM_OFF,P_MEM_OFF},{1'b0,P_MEM_RET,P_MEM_OFF,P_FUNC_RET},
    {1'b1,P_MEM_RET,P_MEM_OFF,P_FUNC_RET},{1'b0,P_MEM_RET,P_MEM_OFF,P_ON},
    {1'b1,P_MEM_RET,P_MEM_OFF,P_ON},{1'b0,P_MEM_RET,P_MEM_OFF,P_WRM_RST},
    {1'b0,P_MEM_RET,P_FUNC_RET,P_OFF},{1'b1,P_MEM_RET,P_FUNC_RET,P_OFF},
    {1'b0,P_MEM_RET,P_FUNC_RET,P_OFF_EMU},{1'b1,P_MEM_RET,P_FUNC_RET,P_OFF_EMU},
    {1'b0,P_MEM_RET,P_FUNC_RET,P_MEM_RET},{1'b1,P_MEM_RET,P_FUNC_RET,P_MEM_RET},
    {1'b0,P_MEM_RET,P_FUNC_RET,P_MEM_OFF},{1'b0,P_MEM_RET,P_FUNC_RET,P_FUNC_RET},
    ...
    {1'b0,P_MEM_RET,P_ON,P_MEM_OFF},{1'b0,P_MEM_RET,P_ON,P_FUNC_RET},
    {1'b1,P_MEM_RET,P_ON,P_FUNC_RET},{1'b0,P_MEM_RET,P_ON,P_ON},
    {1'b1,P_MEM_RET,P_ON,P_ON},{1'b0,P_MEM_RET,P_ON,P_WRM_RST},
    {1'b0,P_MEM_RET,P_WRM_RST,P_OFF},{1'b0,P_MEM_RET,P_WRM_RST,P_OFF_EMU},
    {1'b0,P_MEM_RET,P_WRM_RST,P_MEM_RET},{1'b0,P_MEM_RET,P_WRM_RST,P_MEM_OFF},
    ...
    {1'b0,P_OFF,P_MEM_OFF,P_OFF},{1'b0,P_OFF,P_MEM_OFF,P_MEM_RET},
    {1'b0,P_OFF,P_MEM_OFF,P_MEM_OFF},{1'b0,P_OFF,P_MEM_OFF,P_FUNC_RET},
    {1'b0,P_OFF,P_MEM_OFF,P_ON},{1'b0,P_OFF,P_MEM_OFF,P_WRM_RST}:
    begin
      //Transition to, when there is no pipeline flush, P_MEM_OFF
      //Using Trans Path L2H_PICDD
      pwr_trans_req = 1'b1;
      pwr_trans_path[TRANS_PATH_WIDTH-1:0] = L2H_PICDD;
      pwr_trans_target_mode[3:0] = P_MEM_OFF;
    end
    {1'b0,P_MEM_OFF,P_OFF,P_OFF},{1'b1,P_MEM_OFF,P_OFF,P_OFF},
    ...
    {1'b1,P_MEM_OFF,P_OFF,P_OFF_EMU},{1'b1,P_MEM_OFF,P_OFF,P_MEM_RET},
    {1'b1,P_MEM_OFF,P_OFF,P_MEM_RET_EMU},{1'b1,P_MEM_OFF,P_OFF,P_LGC_RET},
    {1'b1,P_MEM_OFF,P_OFF,P_FULL_RET},{1'b1,P_MEM_OFF,P_OFF,P_FUNC_RET},
    {1'b1,P_MEM_OFF,P_OFF,P_ON},{1'b0,P_MEM_OFF,P_MEM_RET,P_OFF},
    {1'b1,P_MEM_OFF,P_MEM_RET,P_OFF},{1'b0,P_MEM_OFF,P_MEM_RET,P_OFF_EMU},
    {1'b1,P_MEM_OFF,P_MEM_RET,P_OFF_EMU},{1'b0,P_MEM_OFF,P_MEM_RET,P_MEM_RET},
    {1'b1,P_MEM_OFF,P_MEM_RET,P_MEM_RET},{1'b1,P_MEM_OFF,P_MEM_RET,P_MEM_RET_EMU},
    {1'b1,P_MEM_OFF,P_MEM_RET,P_LGC_RET},{1'b1,P_MEM_OFF,P_MEM_RET,P_FULL_RET},
    {1'b1,P_MEM_OFF,P_MEM_RET,P_FUNC_RET},{1'b1,P_MEM_OFF,P_MEM_RET,P_ON},
    {1'b1,P_MEM_OFF,P_MEM_OFF,P_FUNC_RET},{1'b1,P_MEM_OFF,P_MEM_OFF,P_ON},
    {1'b0,P_MEM_OFF,P_FUNC_RET,P_OFF},{1'b1,P_MEM_OFF,P_FUNC_RET,P_OFF},
    {1'b0,P_MEM_OFF,P_FUNC_RET,P_OFF_EMU},{1'b1,P_MEM_OFF,P_FUNC_RET,P_OFF_EMU},
    {1'b0,P_MEM_OFF,P_FUNC_RET,P_MEM_RET},{1'b1,P_MEM_OFF,P_FUNC_RET,P_MEM_RET},
    {1'b0,P_MEM_OFF,P_FUNC_RET,P_MEM_RET_EMU},{1'b1,P_MEM_OFF,P_FUNC_RET,P_MEM_RET_EMU},
    {1'b0,P_MEM_OFF,P_FUNC_RET,P_LGC_RET},{1'b1,P_MEM_OFF,P_FUNC_RET,P_LGC_RET},
    {1'b0,P_MEM_OFF,P_FUNC_RET,P_FULL_RET},{1'b1,P_MEM_OFF,P_FUNC_RET,P_FULL_RET},
    {1'b0,P_MEM_OFF,P_FUNC_RET,P_MEM_OFF},{1'b1,P_MEM_OFF,P_FUNC_RET,P_MEM_OFF},
    {1'b0,P_MEM_OFF,P_FUNC_RET,P_FUNC_RET},{1'b1,P_MEM_OFF,P_FUNC_RET,P_FUNC_RET},
    {1'b0,P_MEM_OFF,P_FUNC_RET,P_ON},{1'b1,P_MEM_OFF,P_FUNC_RET,P_ON},
    {1'b0,P_MEM_OFF,P_FUNC_RET,P_WRM_RST},{1'b0,P_MEM_OFF,P_ON,P_OFF},
    {1'b1,P_MEM_OFF,P_ON,P_OFF},{1'b0,P_MEM_OFF,P_ON,P_OFF_EMU},
    {1'b1,P_MEM_OFF,P_ON,P_OFF_EMU},{1'b0,P_MEM_OFF,P_ON,P_MEM_RET},
    {1'b1,P_MEM_OFF,P_ON,P_MEM_RET},{1'b0,P_MEM_OFF,P_ON,P_MEM_RET_EMU},
    {1'b1,P_MEM_OFF,P_ON,P_MEM_RET_EMU},{1'b0,P_MEM_OFF,P_ON,P_LGC_RET},
    {1'b1,P_MEM_OFF,P_ON,P_LGC_RET},{1'b0,P_MEM_OFF,P_ON,P_FULL_RET},
    {1'b1,P_MEM_OFF,P_ON,P_FULL_RET},{1'b0,P_MEM_OFF,P_ON,P_MEM_OFF},
    {1'b1,P_MEM_OFF,P_ON,P_MEM_OFF},{1'b0,P_MEM_OFF,P_ON,P_FUNC_RET},
    {1'b1,P_MEM_OFF,P_ON,P_FUNC_RET},{1'b0,P_MEM_OFF,P_ON,P_ON},
    {1'b1,P_MEM_OFF,P_ON,P_ON},{1'b0,P_MEM_OFF,P_ON,P_WRM_RST},
    {1'b0,P_MEM_OFF,P_WRM_RST,P_OFF},{1'b0,P_MEM_OFF,P_WRM_RST,P_OFF_EMU},
    {1'b0,P_MEM_OFF,P_WRM_RST,P_MEM_RET},{1'b0,P_MEM_OFF,P_WRM_RST,P_MEM_RET_EMU},
    {1'b0,P_MEM_OFF,P_WRM_RST,P_LGC_RET},{1'b0,P_MEM_OFF,P_WRM_RST,P_FULL_RET},
    {1'b0,P_MEM_OFF,P_WRM_RST,P_MEM_OFF},{1'b0,P_MEM_OFF,P_WRM_RST,P_FUNC_RET},
    {1'b0,P_MEM_OFF,P_WRM_RST,P_ON},{1'b0,P_MEM_OFF,P_WRM_RST,P_WRM_RST},
    ...
    {1'b0,P_FUNC_RET,P_MEM_OFF,P_OFF},{1'b0,P_FUNC_RET,P_MEM_OFF,P_OFF_EMU},
    {1'b0,P_FUNC_RET,P_MEM_OFF,P_MEM_RET},{1'b0,P_FUNC_RET,P_MEM_OFF,P_MEM_RET_EMU},
    {1'b0,P_FUNC_RET,P_MEM_OFF,P_LGC_RET},{1'b0,P_FUNC_RET,P_MEM_OFF,P_FULL_RET},
    {1'b0,P_FUNC_RET,P_MEM_OFF,P_MEM_OFF},{1'b1,P_FUNC_RET,P_MEM_OFF,P_ON},
    ...
    {1'b1,P_ON,P_MEM_OFF,P_OFF},{1'b1,P_ON,P_MEM_OFF,P_OFF_EMU},
    {1'b1,P_ON,P_MEM_OFF,P_MEM_RET},{1'b1,P_ON,P_MEM_OFF,P_MEM_RET_EMU},
    {1'b1,P_ON,P_MEM_OFF,P_LGC_RET},{1'b1,P_ON,P_MEM_OFF,P_FULL_RET},
    {1'b1,P_ON,P_MEM_OFF,P_MEM_OFF},{1'b1,P_ON,P_MEM_OFF,P_FUNC_RET},
    ...
    {1'b0,P_ON,P_MEM_OFF,P_OFF},{1'b0,P_ON,P_MEM_OFF,P_OFF_EMU},
    {1'b0,P_ON,P_MEM_OFF,P_MEM_RET},{1'b0,P_ON,P_MEM_OFF,P_MEM_RET_EMU},
    {1'b0,P_ON,P_MEM_OFF,P_LGC_RET},{1'b0,P_ON,P_MEM_OFF,P_FULL_RET},
    {1'b0,P_ON,P_MEM_OFF,P_MEM_OFF}:
    begin
      //Transition to, when there is no pipeline flush, P_MEM_OFF
      //Using Trans Path H2L_DP
      pwr_trans_req = 1'b1;
    ...
    {1'b0,P_WRM_RST,P_MEM_OFF,P_OFF},{1'b1,P_WRM_RST,P_MEM_OFF,P_OFF},
    {1'b0,P_WRM_RST,P_MEM_OFF,P_OFF_EMU},{1'b1,P_WRM_RST,P_MEM_OFF,P_OFF_EMU},
    {1'b0,P_WRM_RST,P_MEM_OFF,P_MEM_RET},{1'b1,P_WRM_RST,P_MEM_OFF,P_MEM_RET},
    {1'b0,P_WRM_RST,P_MEM_OFF,P_MEM_RET_EMU},{1'b1,P_WRM_RST,P_MEM_OFF,P_MEM_RET_EMU},
    {1'b0,P_WRM_RST,P_MEM_OFF,P_LGC_RET},{1'b1,P_WRM_RST,P_MEM_OFF,P_LGC_RET},
    {1'b0,P_WRM_RST,P_MEM_OFF,P_FULL_RET},{1'b1,P_WRM_RST,P_MEM_OFF,P_FULL_RET},
    {1'b0,P_WRM_RST,P_MEM_OFF,P_MEM_OFF},{1'b1,P_WRM_RST,P_MEM_OFF,P_MEM_OFF},
    {1'b1,P_WRM_RST,P_MEM_OFF,P_FUNC_RET},{1'b1,P_WRM_RST,P_MEM_OFF,P_ON},
