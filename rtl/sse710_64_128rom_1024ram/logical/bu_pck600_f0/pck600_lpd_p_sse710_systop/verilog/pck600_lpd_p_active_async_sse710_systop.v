...
module pck600_lpd_p_active_async_sse710_systop 
(
...
assign ctrl_pactive_o[6] = 1'b0;
  ...
  (
    .or_tree_i ({dev0_pactive_i[8],dev2_pactive_i[8],dev3_pactive_i[8]}),
    .or_tree_o (ctrl_pactive_o[7])
  );

  pck600_or_tree
  #(
    .NUM_OR_TREE_INPUTS (1)
  )
  u_pck600_or_tree_ctrl_pactive_8 
  (
    .or_tree_i ({dev1_pactive_i[8]}),
