...
module pck600_lpd_p_sse710_cpu_expander 
#(
  parameter SEQUENCER          = 0,
  parameter DEV_P_CH_0_SAME_EN = 1,

  parameter DEV_P_CH_1_SAME_EN = 1,

  parameter CTRL_P_CH_SYNC     = 0,
  parameter DEV_P_CH_SYNC      = 1,
...
wire       int_clken;
wire       ctrl_preq_ss;
wire [1:0] dev_paccept_ss;
wire [1:0] dev_pdeny_ss;
wire       clk_enable;

pck600_lpd_p_diu_sse710_cpu_expander  #(
    .SEQUENCER          (SEQUENCER),
    .DEV_P_CH_NUM       (2),
...
pck600_lpd_p_active_async_sse710_cpu_expander  u_lpd_p_active (
...
pck600_lpd_p_pch_tinit_sync_sse710_cpu_expander 
 #(
