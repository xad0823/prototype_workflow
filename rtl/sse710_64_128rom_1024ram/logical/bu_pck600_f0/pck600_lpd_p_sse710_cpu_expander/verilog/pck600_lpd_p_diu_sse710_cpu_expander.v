...
module pck600_lpd_p_diu_sse710_cpu_expander 
#(
  parameter SEQUENCER          = 0,
  parameter DEV_P_CH_NUM       = 2,
...
wire all_stable     =  &stable;
  ...
  begin: g_exp_sm_inst
    pck600_lpd_p_expander_sse710_cpu_expander 
    #(
      .DEV_ID             (g),
...
assign dev_return_flag[DEV_P_CH_NUM+1] = 1'b1;
  ...
  for (g = 0; g < DEV_P_CH_NUM; g = g + 1)
      begin: g_seq_sm
        pck600_lpd_p_sequencer_sse710_cpu_expander 
        #(
          .DEV_ID             (g),
          .DEV_P_CH_0_SAME_EN (DEV_P_CH_0_SAME_EN),
