...
module pck600_ppu_mtu_sse710_dbg
#(
...
(
  ...
  `include "pck600_ppu_enum_sse710_dbg.v"
...
localparam SM_FINAL = 2'b11;
  ...
  begin
    ...
    {1'b0,P_ON,P_OFF,P_MEM_RET},{1'b1,P_ON,P_OFF,P_MEM_RET},
    ...
    {1'b0,P_ON,P_OFF,P_WRM_RST},{1'b0,P_ON,P_ON,P_OFF},
    ...
    {1'b1,P_OFF,P_OFF,P_ON},{1'b1,P_OFF,P_OFF,P_WRM_RST},{1'b0,P_OFF,P_ON,P_OFF},
    {1'b1,P_OFF,P_ON,P_OFF},{1'b0,P_OFF,P_ON,P_ON},{1'b1,P_OFF,P_ON,P_ON},
    {1'b0,P_OFF,P_ON,P_WRM_RST},{1'b1,P_OFF,P_ON,P_WRM_RST},{1'b0,P_OFF,P_WRM_RST,P_OFF},
    {1'b1,P_OFF,P_WRM_RST,P_OFF},{1'b0,P_OFF,P_WRM_RST,P_ON},{1'b1,P_OFF,P_WRM_RST,P_ON},
    ...
    {1'b1,P_ON,P_OFF,P_WRM_RST},{1'b1,P_ON,P_ON,P_WRM_RST},
