...
module sse710_integration_example_f0_top_3 #(
 ...
 /* output wire           PSEL_M,
  ...
  // QSPI
  inout wire           X_qspi_holdn,
  inout wire           X_qspi_wpn,
  inout wire           X_qspi_clk,  
  inout wire           X_qspi_csn,
  inout wire           X_qspi_miso,
  inout wire           X_qspi_mosi
);
...
wire  qspi_pclk;
wire  qspi_presetn;
wire  qspi_rx_dma_ack;
wire  qspi_rx_dma_req;
wire  qspi_tx_dma_ack;
wire  qspi_tx_dma_req;


assign qspi_paddr = aonexp_paddr[31:0];
assign qspi_penable = aonexp_penable;
assign qspi_pwrite = aonexp_pwrite;
assign qspi_pwdata = aonexp_pwdata;
assign vultan_clk_qacceptn = vultan_clk_qreqn;
assign vultan_clk_qdeny = 1'b0;
assign vultan_clk_qactive = 1'b0;
assign systop_qacceptn_internal = systop_qreqn_internal;
assign systop_qdeny_internal = 1'b0;
assign systop_qactive_internal = 1'b0;
assign vultan_irq = qspi_boot_intr;
...
QSPI u0_QSPI
(
	.qspi_psel_s( qspi_psel ),
	.qspi_paddr_s( qspi_paddr ),
	.qspi_penable_s( qspi_penable ),
	.qspi_pwdata_s( qspi_pwdata ),
	.qspi_pwrite_s( qspi_pwrite ),
	.qspi_prdata_s( qspi_prdata ),
	.qspi_pready_s( qspi_pready ),
	...
	.qspi_boot_intr( qspi_boot_intr ),
	.qspi_pclk( hostaonexpclk ),
	.qspi_presetn( aontop_warmresetn_s_hostaonexpclk ),
	.qspi_rx_dma_ack( qspi_rx_dma_ack ),
	.qspi_rx_dma_req( qspi_rx_dma_req ),
	.qspi_tx_dma_ack( qspi_tx_dma_ack ),
	.qspi_tx_dma_req( qspi_tx_dma_req ),
	.X_qspi_holdn( X_qspi_holdn ),
	.X_qspi_wpn( X_qspi_wpn ),
	.X_qspi_clk( X_qspi_clk ),
	.X_qspi_csn( X_qspi_csn ),
	.X_qspi_miso( X_qspi_miso ),
	.X_qspi_mosi( X_qspi_mosi )
);
...
assign EXTSYS0UARTDTRn = 1'b0; // auto-inserted for commented module
assign EXTSYS0UARTOUT1n = 1'b0; // auto-inserted for commented module
assign EXTSYS0UARTOUT2n = 1'b0; // auto-inserted for commented module
assign EXTSYS0UARTRTSn = 1'b0; // auto-inserted for commented module
assign EXTSYS0UARTTX = 1'b0; // auto-inserted for commented module
assign EXTSYS1UARTDTRn = 1'b0; // auto-inserted for commented module
assign EXTSYS1UARTOUT1n = 1'b0; // auto-inserted for commented module
assign EXTSYS1UARTOUT2n = 1'b0; // auto-inserted for commented module
assign EXTSYS1UARTRTSn = 1'b0; // auto-inserted for commented module
assign EXTSYS1UARTTX = 1'b0; // auto-inserted for commented module
assign GPIO_PORT_EN = 16'b0; // auto-inserted for commented module
assign GPIO_PORT_FUNC = 16'b0; // auto-inserted for commented module
assign GPIO_PORT_OUT = 16'b0; // auto-inserted for commented module
assign extsys0_aclk = 1'b0; // auto-inserted for commented module
assign extsys0_aclk_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_aontop_qacceptn = extsys0_aontop_qreqn; // auto-inserted for commented module
assign extsys0_aontop_qactive = 1'b0; // auto-inserted for commented module
assign extsys0_aontop_qdeny = 1'b0; // auto-inserted for commented module
assign extsys0_apb_pwr_qacceptn = extsys0_apb_pwr_qreqn; // auto-inserted for commented module
assign extsys0_apb_pwr_qactive = 1'b0; // auto-inserted for commented module
assign extsys0_apb_pwr_qdeny = 1'b0; // auto-inserted for commented module
assign extsys0_apb_pwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_ar_payld_async = 316'b0; // auto-inserted for commented module
assign extsys0_ar_rd_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys0_ar_wr_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys0_aresetn = 1'b0; // auto-inserted for commented module
assign extsys0_atclk = 1'b0; // auto-inserted for commented module
assign extsys0_atclk_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_atresetn = 1'b0; // auto-inserted for commented module
assign extsys0_aw_payld_async = 316'b0; // auto-inserted for commented module
assign extsys0_aw_rd_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys0_aw_wr_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys0_axi_pwr_qacceptn = extsys0_axi_pwr_qreqn; // auto-inserted for commented module
assign extsys0_axi_pwr_qactive = 1'b0; // auto-inserted for commented module
assign extsys0_axi_pwr_qdeny = 1'b0; // auto-inserted for commented module
assign extsys0_axi_pwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_axiaprom_csyspwrupack = 1'b0; // auto-inserted for commented module
assign extsys0_b_payld_async = 40'b0; // auto-inserted for commented module
assign extsys0_b_rd_ptr_async = 2'b0; // auto-inserted for commented module
assign extsys0_b_wr_ptr_async = 2'b0; // auto-inserted for commented module
assign extsys0_clk = 1'b0; // auto-inserted for commented module
assign extsys0_clock_override_extsystop = 9'b0; // auto-inserted for commented module
assign extsys0_core_resetn = 1'b0; // auto-inserted for commented module
assign extsys0_ctichin = 4'b0; // auto-inserted for commented module
assign extsys0_cticlk = 1'b0; // auto-inserted for commented module
assign extsys0_cticlk_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_ctiinpwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_ctioutpwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_ctiresetn = 1'b0; // auto-inserted for commented module
assign extsys0_dbg_prdata = 32'b0; // auto-inserted for commented module
assign extsys0_dbg_pready = 1'b0; // auto-inserted for commented module
assign extsys0_dbg_pslverr = 1'b0; // auto-inserted for commented module
assign extsys0_dbg_resetn = 1'b0; // auto-inserted for commented module
assign extsys0_dbgclkm = 1'b0; // auto-inserted for commented module
assign extsys0_dbgclkm_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_dbgclks = 1'b0; // auto-inserted for commented module
assign extsys0_dbgclks_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_dbgpresetmn = 1'b0; // auto-inserted for commented module
assign extsys0_dbgpresetsn = 1'b0; // auto-inserted for commented module
assign extsys0_dbgpwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_dbgtop_qacceptn = extsys0_dbgtop_qreqn; // auto-inserted for commented module
assign extsys0_dbgtop_qactive = 1'b0; // auto-inserted for commented module
assign extsys0_dbgtop_qdeny = 1'b0; // auto-inserted for commented module
assign extsys0_extdbg_paddr = 32'b0; // auto-inserted for commented module
assign extsys0_extdbg_penable = 1'b0; // auto-inserted for commented module
assign extsys0_extdbg_pprot = 3'b0; // auto-inserted for commented module
assign extsys0_extdbg_psel = 1'b0; // auto-inserted for commented module
assign extsys0_extdbg_pstrb = 4'b0; // auto-inserted for commented module
assign extsys0_extdbg_pwakeup = 1'b0; // auto-inserted for commented module
assign extsys0_extdbg_pwdata = 32'b0; // auto-inserted for commented module
assign extsys0_extdbg_pwrite = 1'b0; // auto-inserted for commented module
assign extsys0_extdbgpwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_extdbgrom_cdbgpwrupack = 1'b0; // auto-inserted for commented module
assign extsys0_mem_araddr = 32'b0; // auto-inserted for commented module
assign extsys0_mem_arburst = 2'b0; // auto-inserted for commented module
assign extsys0_mem_arcache = 4'b0; // auto-inserted for commented module
assign extsys0_mem_arid = 1'b0; // auto-inserted for commented module
assign extsys0_mem_arlen = 8'b0; // auto-inserted for commented module
assign extsys0_mem_arlock = 1'b0; // auto-inserted for commented module
assign extsys0_mem_arprot = 3'b0; // auto-inserted for commented module
assign extsys0_mem_arsize = 3'b0; // auto-inserted for commented module
assign extsys0_mem_arvalid = 1'b0; // auto-inserted for commented module
assign extsys0_mem_awaddr = 32'b0; // auto-inserted for commented module
assign extsys0_mem_awakeup = 1'b0; // auto-inserted for commented module
assign extsys0_mem_awburst = 2'b0; // auto-inserted for commented module
assign extsys0_mem_awcache = 4'b0; // auto-inserted for commented module
assign extsys0_mem_awid = 1'b0; // auto-inserted for commented module
assign extsys0_mem_awlen = 8'b0; // auto-inserted for commented module
assign extsys0_mem_awlock = 1'b0; // auto-inserted for commented module
assign extsys0_mem_awprot = 3'b0; // auto-inserted for commented module
assign extsys0_mem_awsize = 3'b0; // auto-inserted for commented module
assign extsys0_mem_awvalid = 1'b0; // auto-inserted for commented module
assign extsys0_mem_bready = 1'b0; // auto-inserted for commented module
assign extsys0_mem_rready = 1'b0; // auto-inserted for commented module
assign extsys0_mem_wdata = 1'b0; // auto-inserted for commented module
assign extsys0_mem_wlast = 1'b0; // auto-inserted for commented module
assign extsys0_mem_wstrb = 1'b0; // auto-inserted for commented module
assign extsys0_mem_wvalid = 1'b0; // auto-inserted for commented module
assign extsys0_mempwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_mhu_paddr = 19'b0; // auto-inserted for commented module
assign extsys0_mhu_penable = 1'b0; // auto-inserted for commented module
assign extsys0_mhu_pprot = 3'b0; // auto-inserted for commented module
assign extsys0_mhu_psel = 1'b0; // auto-inserted for commented module
assign extsys0_mhu_pstrb = 4'b0; // auto-inserted for commented module
assign extsys0_mhu_pwakeup = 1'b0; // auto-inserted for commented module
assign extsys0_mhu_pwdata = 32'b0; // auto-inserted for commented module
assign extsys0_mhu_pwrite = 1'b0; // auto-inserted for commented module
assign extsys0_mhuclk = 1'b0; // auto-inserted for commented module
assign extsys0_mhuclk_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_mhupwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_mhuresetn = 1'b0; // auto-inserted for commented module
assign extsys0_mi_to_si_wakeup_async = 1'b0; // auto-inserted for commented module
assign extsys0_mtx_resetn = 1'b0; // auto-inserted for commented module
assign extsys0_nts_m_lp = 1'b0; // auto-inserted for commented module
assign extsys0_nts_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_nts_rd_ptr_encd_gry = 4'b0; // auto-inserted for commented module
assign extsys0_nts_rd_ptr_sync_gry = 4'b0; // auto-inserted for commented module
assign extsys0_nts_s_lp_return = 1'b0; // auto-inserted for commented module
assign extsys0_ppu_apb_async_ack = 1'b0; // auto-inserted for commented module
assign extsys0_ppu_apb_async_req = 1'b0; // auto-inserted for commented module
assign extsys0_ppu_apb_async_req_payload = 48'b0; // auto-inserted for commented module
assign extsys0_ppu_apb_async_resp_payload = 33'b0; // auto-inserted for commented module
assign extsys0_ppu_irq = 1'b0; // auto-inserted for commented module
assign extsys0_r_payld_async = 212'b0; // auto-inserted for commented module
assign extsys0_r_rd_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys0_r_wr_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys0_si_to_mi_wakeup_async = 1'b0; // auto-inserted for commented module
assign extsys0_sleep_hold_ackn = 1'b0; // auto-inserted for commented module
assign extsys0_sleep_hold_reqn = 1'b0; // auto-inserted for commented module
assign extsys0_sleeping = 1'b0; // auto-inserted for commented module
assign extsys0_slvacceptn_async = 1'b0; // auto-inserted for commented module
assign extsys0_slvcandenyreqn_async = 1'b0; // auto-inserted for commented module
assign extsys0_slvdeny_async = 1'b0; // auto-inserted for commented module
assign extsys0_slvmustacceptreqn_async = 1'b0; // auto-inserted for commented module
assign extsys0_sysreg_apb_async_ack = 1'b0; // auto-inserted for commented module
assign extsys0_sysreg_apb_async_req = 1'b0; // auto-inserted for commented module
assign extsys0_sysreg_apb_async_req_payload = 48'b0; // auto-inserted for commented module
assign extsys0_sysreg_apb_async_resp_payload = 33'b0; // auto-inserted for commented module
assign extsys0_sysreset_req = 1'b0; // auto-inserted for commented module
assign extsys0_systop_qacceptn = extsys0_systop_qreqn; // auto-inserted for commented module
assign extsys0_systop_qactive = 1'b0; // auto-inserted for commented module
assign extsys0_systop_qdeny = 1'b0; // auto-inserted for commented module
assign extsys0_traceexp_afready = 1'b0; // auto-inserted for commented module
assign extsys0_traceexp_atbytes = 2'b0; // auto-inserted for commented module
assign extsys0_traceexp_atdata = 32'b0; // auto-inserted for commented module
assign extsys0_traceexp_atid = 7'b0; // auto-inserted for commented module
assign extsys0_traceexp_atvalid = 1'b0; // auto-inserted for commented module
assign extsys0_traceexp_atwakeup = 1'b0; // auto-inserted for commented module
assign extsys0_traceexppwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys0_uart_apb_async_ack = 1'b0; // auto-inserted for commented module
assign extsys0_uart_apb_async_req = 1'b0; // auto-inserted for commented module
assign extsys0_uart_apb_async_req_payload = 48'b0; // auto-inserted for commented module
assign extsys0_uart_apb_async_resp_payload = 33'b0; // auto-inserted for commented module
assign extsys0_uart_irq = 1'b0; // auto-inserted for commented module
assign extsys0_w_payld_async = 222'b0; // auto-inserted for commented module
assign extsys0_w_rd_ptr_async = 6'b0; // auto-inserted for commented module
assign extsys0_w_wr_ptr_async = 6'b0; // auto-inserted for commented module
assign extsys0_wdog_lockup_irq = 1'b0; // auto-inserted for commented module
assign extsys1_aclk = 1'b0; // auto-inserted for commented module
assign extsys1_aclk_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_aontop_qacceptn = extsys1_aontop_qreqn; // auto-inserted for commented module
assign extsys1_aontop_qactive = 1'b0; // auto-inserted for commented module
assign extsys1_aontop_qdeny = 1'b0; // auto-inserted for commented module
assign extsys1_apb_pwr_qacceptn = extsys1_apb_pwr_qreqn; // auto-inserted for commented module
assign extsys1_apb_pwr_qactive = 1'b0; // auto-inserted for commented module
assign extsys1_apb_pwr_qdeny = 1'b0; // auto-inserted for commented module
assign extsys1_apb_pwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_ar_payld_async = 316'b0; // auto-inserted for commented module
assign extsys1_ar_rd_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys1_ar_wr_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys1_aresetn = 1'b0; // auto-inserted for commented module
assign extsys1_atclk = 1'b0; // auto-inserted for commented module
assign extsys1_atclk_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_atresetn = 1'b0; // auto-inserted for commented module
assign extsys1_aw_payld_async = 316'b0; // auto-inserted for commented module
assign extsys1_aw_rd_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys1_aw_wr_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys1_axi_pwr_qacceptn = extsys1_axi_pwr_qreqn; // auto-inserted for commented module
assign extsys1_axi_pwr_qactive = 1'b0; // auto-inserted for commented module
assign extsys1_axi_pwr_qdeny = 1'b0; // auto-inserted for commented module
assign extsys1_axi_pwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_axiaprom_csyspwrupack = 1'b0; // auto-inserted for commented module
assign extsys1_b_payld_async = 40'b0; // auto-inserted for commented module
assign extsys1_b_rd_ptr_async = 2'b0; // auto-inserted for commented module
assign extsys1_b_wr_ptr_async = 2'b0; // auto-inserted for commented module
assign extsys1_clk = 1'b0; // auto-inserted for commented module
assign extsys1_clock_override_extsystop = 9'b0; // auto-inserted for commented module
assign extsys1_core_resetn = 1'b0; // auto-inserted for commented module
assign extsys1_ctichin = 4'b0; // auto-inserted for commented module
assign extsys1_cticlk = 1'b0; // auto-inserted for commented module
assign extsys1_cticlk_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_ctiinpwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_ctioutpwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_ctiresetn = 1'b0; // auto-inserted for commented module
assign extsys1_dbg_prdata = 32'b0; // auto-inserted for commented module
assign extsys1_dbg_pready = 1'b0; // auto-inserted for commented module
assign extsys1_dbg_pslverr = 1'b0; // auto-inserted for commented module
assign extsys1_dbg_resetn = 1'b0; // auto-inserted for commented module
assign extsys1_dbgclkm = 1'b0; // auto-inserted for commented module
assign extsys1_dbgclkm_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_dbgclks = 1'b0; // auto-inserted for commented module
assign extsys1_dbgclks_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_dbgpresetmn = 1'b0; // auto-inserted for commented module
assign extsys1_dbgpresetsn = 1'b0; // auto-inserted for commented module
assign extsys1_dbgpwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_dbgtop_qacceptn = extsys1_dbgtop_qreqn; // auto-inserted for commented module
assign extsys1_dbgtop_qactive = 1'b0; // auto-inserted for commented module
assign extsys1_dbgtop_qdeny = 1'b0; // auto-inserted for commented module
assign extsys1_extdbg_paddr = 32'b0; // auto-inserted for commented module
assign extsys1_extdbg_penable = 1'b0; // auto-inserted for commented module
assign extsys1_extdbg_pprot = 3'b0; // auto-inserted for commented module
assign extsys1_extdbg_psel = 1'b0; // auto-inserted for commented module
assign extsys1_extdbg_pstrb = 4'b0; // auto-inserted for commented module
assign extsys1_extdbg_pwakeup = 1'b0; // auto-inserted for commented module
assign extsys1_extdbg_pwdata = 32'b0; // auto-inserted for commented module
assign extsys1_extdbg_pwrite = 1'b0; // auto-inserted for commented module
assign extsys1_extdbgpwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_extdbgrom_cdbgpwrupack = 1'b0; // auto-inserted for commented module
assign extsys1_mem_araddr = 32'b0; // auto-inserted for commented module
assign extsys1_mem_arburst = 2'b0; // auto-inserted for commented module
assign extsys1_mem_arcache = 4'b0; // auto-inserted for commented module
assign extsys1_mem_arid = 1'b0; // auto-inserted for commented module
assign extsys1_mem_arlen = 8'b0; // auto-inserted for commented module
assign extsys1_mem_arlock = 1'b0; // auto-inserted for commented module
assign extsys1_mem_arprot = 3'b0; // auto-inserted for commented module
assign extsys1_mem_arsize = 3'b0; // auto-inserted for commented module
assign extsys1_mem_arvalid = 1'b0; // auto-inserted for commented module
assign extsys1_mem_awaddr = 32'b0; // auto-inserted for commented module
assign extsys1_mem_awakeup = 1'b0; // auto-inserted for commented module
assign extsys1_mem_awburst = 2'b0; // auto-inserted for commented module
assign extsys1_mem_awcache = 4'b0; // auto-inserted for commented module
assign extsys1_mem_awid = 1'b0; // auto-inserted for commented module
assign extsys1_mem_awlen = 8'b0; // auto-inserted for commented module
assign extsys1_mem_awlock = 1'b0; // auto-inserted for commented module
assign extsys1_mem_awprot = 3'b0; // auto-inserted for commented module
assign extsys1_mem_awsize = 3'b0; // auto-inserted for commented module
assign extsys1_mem_awvalid = 1'b0; // auto-inserted for commented module
assign extsys1_mem_bready = 1'b0; // auto-inserted for commented module
assign extsys1_mem_rready = 1'b0; // auto-inserted for commented module
assign extsys1_mem_wdata = 1'b0; // auto-inserted for commented module
assign extsys1_mem_wlast = 1'b0; // auto-inserted for commented module
assign extsys1_mem_wstrb = 1'b0; // auto-inserted for commented module
assign extsys1_mem_wvalid = 1'b0; // auto-inserted for commented module
assign extsys1_mempwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_mhu_paddr = 19'b0; // auto-inserted for commented module
assign extsys1_mhu_penable = 1'b0; // auto-inserted for commented module
assign extsys1_mhu_pprot = 3'b0; // auto-inserted for commented module
assign extsys1_mhu_psel = 1'b0; // auto-inserted for commented module
assign extsys1_mhu_pstrb = 4'b0; // auto-inserted for commented module
assign extsys1_mhu_pwakeup = 1'b0; // auto-inserted for commented module
assign extsys1_mhu_pwdata = 32'b0; // auto-inserted for commented module
assign extsys1_mhu_pwrite = 1'b0; // auto-inserted for commented module
assign extsys1_mhuclk = 1'b0; // auto-inserted for commented module
assign extsys1_mhuclk_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_mhupwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_mhuresetn = 1'b0; // auto-inserted for commented module
assign extsys1_mi_to_si_wakeup_async = 1'b0; // auto-inserted for commented module
assign extsys1_mtx_resetn = 1'b0; // auto-inserted for commented module
assign extsys1_nts_m_lp = 1'b0; // auto-inserted for commented module
assign extsys1_nts_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_nts_rd_ptr_encd_gry = 4'b0; // auto-inserted for commented module
assign extsys1_nts_rd_ptr_sync_gry = 4'b0; // auto-inserted for commented module
assign extsys1_nts_s_lp_return = 1'b0; // auto-inserted for commented module
assign extsys1_ppu_apb_async_ack = 1'b0; // auto-inserted for commented module
assign extsys1_ppu_apb_async_req = 1'b0; // auto-inserted for commented module
assign extsys1_ppu_apb_async_req_payload = 48'b0; // auto-inserted for commented module
assign extsys1_ppu_apb_async_resp_payload = 33'b0; // auto-inserted for commented module
assign extsys1_ppu_irq = 1'b0; // auto-inserted for commented module
assign extsys1_r_payld_async = 212'b0; // auto-inserted for commented module
assign extsys1_r_rd_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys1_r_wr_ptr_async = 4'b0; // auto-inserted for commented module
assign extsys1_si_to_mi_wakeup_async = 1'b0; // auto-inserted for commented module
assign extsys1_sleep_hold_ackn = 1'b0; // auto-inserted for commented module
assign extsys1_sleep_hold_reqn = 1'b0; // auto-inserted for commented module
assign extsys1_sleeping = 1'b0; // auto-inserted for commented module
assign extsys1_slvacceptn_async = 1'b0; // auto-inserted for commented module
assign extsys1_slvcandenyreqn_async = 1'b0; // auto-inserted for commented module
assign extsys1_slvdeny_async = 1'b0; // auto-inserted for commented module
assign extsys1_slvmustacceptreqn_async = 1'b0; // auto-inserted for commented module
assign extsys1_sysreg_apb_async_ack = 1'b0; // auto-inserted for commented module
assign extsys1_sysreg_apb_async_req = 1'b0; // auto-inserted for commented module
assign extsys1_sysreg_apb_async_req_payload = 48'b0; // auto-inserted for commented module
assign extsys1_sysreg_apb_async_resp_payload = 33'b0; // auto-inserted for commented module
assign extsys1_sysreset_req = 1'b0; // auto-inserted for commented module
assign extsys1_systop_qacceptn = extsys1_systop_qreqn; // auto-inserted for commented module
assign extsys1_systop_qactive = 1'b0; // auto-inserted for commented module
assign extsys1_systop_qdeny = 1'b0; // auto-inserted for commented module
assign extsys1_traceexp_afready = 1'b0; // auto-inserted for commented module
assign extsys1_traceexp_atbytes = 2'b0; // auto-inserted for commented module
assign extsys1_traceexp_atdata = 32'b0; // auto-inserted for commented module
assign extsys1_traceexp_atid = 7'b0; // auto-inserted for commented module
assign extsys1_traceexp_atvalid = 1'b0; // auto-inserted for commented module
assign extsys1_traceexp_atwakeup = 1'b0; // auto-inserted for commented module
assign extsys1_traceexppwr_qreqn = 1'b0; // auto-inserted for commented module
assign extsys1_uart_apb_async_ack = 1'b0; // auto-inserted for commented module
assign extsys1_uart_apb_async_req = 1'b0; // auto-inserted for commented module
assign extsys1_uart_apb_async_req_payload = 48'b0; // auto-inserted for commented module
assign extsys1_uart_apb_async_resp_payload = 33'b0; // auto-inserted for commented module
assign extsys1_uart_irq = 1'b0; // auto-inserted for commented module
assign extsys1_w_payld_async = 222'b0; // auto-inserted for commented module
assign extsys1_w_rd_ptr_async = 6'b0; // auto-inserted for commented module
assign extsys1_w_wr_ptr_async = 6'b0; // auto-inserted for commented module
assign extsys1_wdog_lockup_irq = 1'b0; // auto-inserted for commented module
assign gpio_irq = 1'b0; // auto-inserted for commented module
assign hostexp_aclk_qacceptn = hostexp_aclk_qreqn; // auto-inserted for commented module
assign hostexp_aclk_qactive = 4'b0; // auto-inserted for commented module
assign hostexp_aclk_qdeny = 4'b0; // auto-inserted for commented module
assign hostexpmst0_arready = 1'b0; // auto-inserted for commented module
assign hostexpmst0_awready = 1'b0; // auto-inserted for commented module
assign hostexpmst0_bid = 12'b0; // auto-inserted for commented module
assign hostexpmst0_bresp = 2'b0; // auto-inserted for commented module
assign hostexpmst0_bvalid = 1'b0; // auto-inserted for commented module
assign hostexpmst0_rdata = 64'b0; // auto-inserted for commented module
assign hostexpmst0_rid = 12'b0; // auto-inserted for commented module
assign hostexpmst0_rlast = 1'b0; // auto-inserted for commented module
assign hostexpmst0_rresp = 2'b0; // auto-inserted for commented module
assign hostexpmst0_rvalid = 1'b0; // auto-inserted for commented module
assign hostexpmst0_wready = 1'b0; // auto-inserted for commented module
assign hostexpmst1_arready = 1'b0; // auto-inserted for commented module
assign hostexpmst1_awready = 1'b0; // auto-inserted for commented module
assign hostexpmst1_bid = 12'b0; // auto-inserted for commented module
assign hostexpmst1_bresp = 2'b0; // auto-inserted for commented module
assign hostexpmst1_bvalid = 1'b0; // auto-inserted for commented module
assign hostexpmst1_rdata = 64'b0; // auto-inserted for commented module
assign hostexpmst1_rid = 12'b0; // auto-inserted for commented module
assign hostexpmst1_rlast = 1'b0; // auto-inserted for commented module
assign hostexpmst1_rresp = 2'b0; // auto-inserted for commented module
assign hostexpmst1_rvalid = 1'b0; // auto-inserted for commented module
assign hostexpmst1_wready = 1'b0; // auto-inserted for commented module
assign vultan_paddr_s = 32'b0; // auto-inserted for commented module
assign vultan_penable_s = 1'b0; // auto-inserted for commented module
assign vultan_pprot_s = 3'b0; // auto-inserted for commented module
assign vultan_psel_s = 1'b0; // auto-inserted for commented module
assign vultan_pstrb_s = 4'b0; // auto-inserted for commented module
assign vultan_pwdata_s = 32'b0; // auto-inserted for commented module
assign vultan_pwrite_s = 1'b0; // auto-inserted for commented module
endmodule
