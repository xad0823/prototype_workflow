...
module gcounter_syncapb_counter (
  input  wire         PCLK,              
  input  wire         PRESETn,           
...
wire         counter_start_forcesync;
  ...
  assign counter_start_stopn            =  counter_start_state[0] & ~dbgh;
  assign counter_preload_enable         = ~counter_start_state[1];         

gcounter_syncapb_counter_core #(
                                .P    (5)
                    ...
                    .counter_preload_enable  ( counter_preload_enable  ),  
