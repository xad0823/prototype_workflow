...
module nic400_ib_debug_axis_ib_master_domain_sse710_dbgaxi2apb
  (
  ...
  input   [8:0]       bid_axi4_m;               
  input   [1:0]       bresp_axi4_m;             
  input               bvalid_axi4_m;            
  output              bready_axi4_m;            

  output  [8:0]       arid_axi4_m;              
  ...
  nic400_ib_debug_axis_ib_aw_fifo_rd_sse710_dbgaxi2apb
  u_aw_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_debug_axis_ib_ar_fifo_rd_sse710_dbgaxi2apb
  u_ar_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_debug_axis_ib_r_fifo_wr_sse710_dbgaxi2apb
  u_r_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_debug_axis_ib_w_fifo_rd_sse710_dbgaxi2apb
  u_w_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_debug_axis_ib_b_fifo_wr_sse710_dbgaxi2apb
  u_b_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
...
nic400_ib_debug_axis_ib_maskcntl_sse710_dbgaxi2apb u_maskcntl (
