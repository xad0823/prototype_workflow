...
module nic400_ib_debug_axis_ib_slave_domain_sse710_dbgaxi2apb
  (
  ...
  wire [63:0]         aw_boundary_src_data;     
  wire [63:0]         aw_boundary_dst_data;     
  ...
  wire [63:0]         ar_boundary_src_data;     
  wire [63:0]         ar_boundary_dst_data;     
  ...
  nic400_ib_debug_axis_ib_aw_fifo_wr_sse710_dbgaxi2apb
  u_aw_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_debug_axis_ib_ar_fifo_wr_sse710_dbgaxi2apb
  u_ar_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_debug_axis_ib_r_fifo_rd_sse710_dbgaxi2apb
  u_r_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_debug_axis_ib_w_fifo_wr_sse710_dbgaxi2apb
  u_w_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_debug_axis_ib_b_fifo_rd_sse710_dbgaxi2apb
  u_b_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
