...
module nic400_amib_slave_2_apb_m_sse710_dbgaxi2apb
(
  aclk,
  aresetn,
  ...
  input                 pclken;               
  output                psel_extdbg_apb_i;     
  input                 pready_extdbg_apb_i;   
  input                 pslverr_extdbg_apb_i;  
  input         [31:0]  prdata_extdbg_apb_i;   
  output                penable;              
  output                pwrite;               
  ...
  wire                  pclken;               
  wire                  psel_extdbg_apb_i;     
  wire                  pready_extdbg_apb_i;   
  wire                  pslverr_extdbg_apb_i;  
  wire          [31:0]  prdata_extdbg_apb_i;   
  wire                  penable;              
  wire                  pwrite;               
  ...
  reg                  accumulated_err;
  wire [43:0]       axi_resp_payload_in;
  wire [43:0]       axi_resp_payload_out;

  nic400_amib_slave_2_a_gen_sse710_dbgaxi2apb #(
  ...
  assign psel_extdbg_apb_i = psel_i[0];

  assign prdata  = prdata_extdbg_apb_i;
  assign pslverr = pslverr_extdbg_apb_i & psel_i[0];
  assign pready  = pready_extdbg_apb_i | psel_i[1];
  ...
  nic400_rev_regd_slice_sse710_dbgaxi2apb #(44) u_axi_resp_ouput_buffer
  (
    .aresetn           (aresetn),
    .aclk              (aclk),
