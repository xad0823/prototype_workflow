...
module nic400_asib_debug_axis_decode_sse710_dbgaxi2apb
  (
    addr_s,
    security0,
    aprot,
  ...
  assign decode_int = (32'h18000000 <= addr_s) && (addr_s <= 32'h19FFFFFF);





  assign remap_decode = ~(aprot & security0) & decode_int;
