...
module nic400_asib_debug_axis_wr_spi_cdas_sse710_dbgaxi2apb
  (
    aw_enable,
    wr_enable,
    asel,
  ...
  reg            aready_reg;   
  reg   [4:0]    tt_cnt;   
  reg   [1:0]    spi_asel [18:0];   
  reg   [8:0]    spi_ids [18:0];   
  reg   [18:0]    spi_valid;   
  reg   [1:0]    hold_asel;   
  reg   [8:0]    hold_aid;   
  reg            hold_valid;   
  reg            t_ready;   
   ...
   assign resp_match[11] = ((spi_ids[11]  == resp_id[8:0]) &&
                            spi_valid[11]);
   assign resp_match[12] = ((spi_ids[12]  == resp_id[8:0]) &&
                            spi_valid[12]);
   assign resp_match[13] = ((spi_ids[13]  == resp_id[8:0]) &&
                            spi_valid[13]);
   assign resp_match[14] = ((spi_ids[14]  == resp_id[8:0]) &&
                            spi_valid[14]);
   assign resp_match[15] = ((spi_ids[15]  == resp_id[8:0]) &&
                            spi_valid[15]);
   assign resp_match[16] = ((spi_ids[16]  == resp_id[8:0]) &&
                            spi_valid[16]);
   assign resp_match[17] = ((spi_ids[17]  == resp_id[8:0]) &&
                            spi_valid[17]);
   assign resp_match[18] = ((spi_ids[18]  == resp_id[8:0]) &&
                            spi_valid[18]);
   ...
   assign hold_resp_match = (hold_aid == resp_id[8:0]) & (~|resp_sel)
   ...
   assign id_match[12] = (spi_ids[12] == aid[8:0]);
   assign id_match[13] = (spi_ids[13] == aid[8:0]);
   assign id_match[14] = (spi_ids[14] == aid[8:0]);
   assign id_match[15] = (spi_ids[15] == aid[8:0]);
   assign id_match[16] = (spi_ids[16] == aid[8:0]);
   assign id_match[17] = (spi_ids[17] == aid[8:0]);
   assign id_match[18] = (spi_ids[18] == aid[8:0]);
