...
module nic400_switch1_ml_blayer_0_sse710_dbgaxi2apb
  (
  ...
  nic400_switch1_wr_spi_tt_s0_sse710_dbgaxi2apb u_nic400_switch1_wr_spi_tt_6_2m_sse710_dbgaxi2apb (
        .aw_enable    (aw_enable),
  ...
  nic400_switch1_rd_spi_tt_s0_sse710_dbgaxi2apb u_nic400_switch1_rd_spi_tt_4_2m_sse710_dbgaxi2apb (
  ...
  assign bid_s_int[8:0] = bid_m0 & {9{tt_enable_wr[0]}};
  ...
  assign bid_s_int[17:9] = bid_m1 & {9{tt_enable_wr[1]}};
  ...
  assign bid_s = bid_s_int[8:0]
                 | bid_s_int[17:9];
  assign bresp_s = bresp_s_int[1:0]
                 | bresp_s_int[3:2];

  assign rid_s_int[8:0] = rid_m0 & {9{tt_enable_rd[0]}};
  ...
  assign rid_s_int[17:9] = rid_m1 & {9{tt_enable_rd[1]}};
