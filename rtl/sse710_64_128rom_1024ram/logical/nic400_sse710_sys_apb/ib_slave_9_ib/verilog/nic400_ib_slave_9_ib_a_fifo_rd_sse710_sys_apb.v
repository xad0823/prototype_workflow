...
module nic400_ib_slave_9_ib_a_fifo_rd_sse710_sys_apb
  (
  dst_valid,
  rpntr_gry_async,
  rpntr_bin,
...
`include "nic400_ib_slave_9_ib_a_fifo_fn_sse710_sys_apb.v"
  ...
  nic400_ib_slave_9_ib_a_fifo_sync_sse710_sys_apb u_sync_wr_ptr_gry
  (
    .clk       (rclk),
    .resetn    (rresetn),
  ...
  nic400_cdc_capt_nosync_sse710_sys_apb #(70) u_cdc_data_capt_nosync
  (
    .valid     (not_empty),
    .d_async   (src_data),
    .q         (dst_data)
  ...
  assign next_rpntr_gry = nic400_ib_slave_9_ib_a_fifo_next_gry_fn(rpntr_gry);
  ...
  always@(posedge rclk or negedge rresetn)
   ...
   assign next_rpntr_bin = nic400_ib_slave_9_ib_a_fifo_gry_to_bin_fn(next_rpntr_gry);
  ...
  assign empty = nic400_ib_slave_9_ib_a_fifo_empty_fn(wpntr_gry_rsync, rpntr_gry);
