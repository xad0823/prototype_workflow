...
module nic400_ib_slave_9_ib_master_domain_sse710_sys_apb
  (
  ...
  output              slave_9_ib_cactive;             


  output              slave_9_ib_cactive_wakeup;      


  input               slave_9_ib_port_enable;         
  ...
  wire [47:0]         d_boundary_src_data;     
  wire [47:0]         d_boundary_dst_data;     
  ...
  assign slave_9_ib_cactive = tracker_busy |
  ...
  assign slave_9_ib_cactive_wakeup = empty_async;
  ...
  assign avalid_itb_m = a_boundary_dst_valid & slave_9_ib_port_enable & ~pause_a & ~tracker_full;
  assign a_boundary_dst_ready = aready_itb_m & slave_9_ib_port_enable & ~pause_a & ~tracker_full;
  ...
  assign wvalid_itb_m = w_boundary_dst_valid & slave_9_ib_port_enable & ~pause_w;
  assign w_boundary_dst_ready = wready_itb_m & slave_9_ib_port_enable & ~pause_w;
  ...
  nic400_ib_slave_9_ib_a_fifo_rd_sse710_sys_apb
  u_a_fifo_rd
    (
     .rresetn               (aresetn_m),
     .rclk                  (aclk_m),
  ...
  nic400_ib_slave_9_ib_d_fifo_wr_sse710_sys_apb
  u_d_fifo_wr
    (
     .wresetn               (aresetn_m),
     .wclk                  (aclk_m),
  ...
  nic400_ib_slave_9_ib_w_fifo_rd_sse710_sys_apb
  u_w_fifo_rd
    (
     .rresetn               (aresetn_m),
     .rclk                  (aclk_m),
  ...
  nic400_ib_slave_9_ib_itb_trans_counter_sse710_sys_apb u_itb_trans_counter (
