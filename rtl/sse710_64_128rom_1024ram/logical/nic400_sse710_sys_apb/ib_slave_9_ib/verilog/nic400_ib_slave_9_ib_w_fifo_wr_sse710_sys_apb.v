...
module nic400_ib_slave_9_ib_w_fifo_wr_sse710_sys_apb
  (
   src_ready,
   dst_data,
...
`include "nic400_ib_slave_9_ib_w_fifo_fn_sse710_sys_apb.v"
   ...
   nic400_ib_slave_9_ib_w_fifo_sync_sse710_sys_apb u_sync_rd_ptr_gry
   (
      .clk       (wclk),
      .resetn    (wresetn),
   ...
   assign next_wpntr_gry = nic400_ib_slave_9_ib_w_fifo_next_gry_fn(wpntr_gry);

   assign wpntr_bin      = nic400_ib_slave_9_ib_w_fifo_gry_to_bin_fn(wpntr_gry);
  ...
  nic400_ib_slave_9_ib_cdc_air_corrupt_sse710_sys_apb #(37,"fwd") u_cdc_corrupt_fifo_0
   (
      .d   (fifo0),
      .q   (fifo0_corrupt)
   );
  
  nic400_ib_slave_9_ib_cdc_air_corrupt_sse710_sys_apb #(37,"fwd") u_cdc_corrupt_fifo_1
   (
      .d   (fifo1),
      .q   (fifo1_corrupt)
   );
   ...
   nic400_ib_slave_9_ib_w_fifo_wr_mux_sse710_sys_apb u_nic400_ib_slave_9_ib_w_fifo_wr_mux
   (
      .in_0  (fifo0_corrupt),
      .in_1  (fifo1_corrupt),
   ...
   assign full = nic400_ib_slave_9_ib_w_fifo_full_fn(wpntr_gry, rpntr_gry_wsync);
  
   assign empty = nic400_ib_slave_9_ib_w_fifo_empty_fn(wpntr_gry, rpntr_gry_wsync);
