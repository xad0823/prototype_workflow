...
module nic400_amib_slave_6_apb_m_sse710_sys_apb
(
  aclk,
  aresetn,
  ...
  pclken,
  psel_hostsysdbg_apb_i,
  psel_sdc600_apb_i,
  pready_hostsysdbg_apb_i,
  pready_sdc600_apb_i,
  pslverr_hostsysdbg_apb_i,
  pslverr_sdc600_apb_i,
  prdata_hostsysdbg_apb_i,
  prdata_sdc600_apb_i,
  penable,
  pwrite,
  paddr,
  ...
  input                 pclken;               
  output                psel_hostsysdbg_apb_i;     
  output                psel_sdc600_apb_i;     
  input                 pready_hostsysdbg_apb_i;   
  input                 pready_sdc600_apb_i;   
  input                 pslverr_hostsysdbg_apb_i;  
  input                 pslverr_sdc600_apb_i;  
  input         [31:0]  prdata_hostsysdbg_apb_i;   
  input         [31:0]  prdata_sdc600_apb_i;   
  output                penable;              
  output                pwrite;               
  ...
  wire                  pclken;               
  wire                  psel_hostsysdbg_apb_i;     
  wire                  psel_sdc600_apb_i;     
  wire                  pready_hostsysdbg_apb_i;   
  wire                  pready_sdc600_apb_i;   
  wire                  pslverr_hostsysdbg_apb_i;  
  wire                  pslverr_sdc600_apb_i;  
  wire          [31:0]  prdata_hostsysdbg_apb_i;   
  wire          [31:0]  prdata_sdc600_apb_i;   
  wire                  penable;              
  wire                  pwrite;               
  ...
  nic400_amib_slave_6_a_gen_sse710_sys_apb #(
  ...
  assign psel_dec[2] = ~|psel_dec[1:0];
          ...
          begin
            ...
            if (ok_to_start_nxt_apb_trans) begin
               ...
               nxt_bridge_state = 1'b1;
                ...
                nxt_psel     = (|psel_i) ? {3{~pready}} & psel_i : {3{1'b0}};
  ...
  assign psel_hostsysdbg_apb_i = psel_i[0];
  assign psel_sdc600_apb_i = psel_i[1];

  assign prdata = (prdata_hostsysdbg_apb_i & {32{psel_hostsysdbg_apb_i}}) |
                  (prdata_sdc600_apb_i & {32{psel_sdc600_apb_i}});

  assign pslverr = ((pslverr_hostsysdbg_apb_i & psel_hostsysdbg_apb_i) |
                     (pslverr_sdc600_apb_i & psel_sdc600_apb_i));

  assign pready = (pready_hostsysdbg_apb_i & psel_hostsysdbg_apb_i) |
                  (pready_sdc600_apb_i & psel_sdc600_apb_i) |
                  psel_i[2];
...
`include "std_ovl_defines.h"
  ...
  (
   ...
   assert_zero_one_hot #(0,3,0,"ERROR, More than one psel selected")
