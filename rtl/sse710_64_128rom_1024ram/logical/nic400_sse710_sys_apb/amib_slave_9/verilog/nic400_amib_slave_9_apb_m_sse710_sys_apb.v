...
module nic400_amib_slave_9_apb_m_sse710_sys_apb
(
  aclk,
  aresetn,
  ...
  pclken,
  psel_ppu_cpu_apb_i,
  pready_ppu_cpu_apb_i,
  pslverr_ppu_cpu_apb_i,
  prdata_ppu_cpu_apb_i,
  penable,
  pwrite,
  paddr,
  pwdata,
  ...
  input                 pclken;               
  output                psel_ppu_cpu_apb_i;     
  input                 pready_ppu_cpu_apb_i;   
  input                 pslverr_ppu_cpu_apb_i;  
  input         [31:0]  prdata_ppu_cpu_apb_i;   
  output                penable;              
  output                pwrite;               
  ...
  wire                  pclken;               
  wire                  psel_ppu_cpu_apb_i;     
  wire                  pready_ppu_cpu_apb_i;   
  wire                  pslverr_ppu_cpu_apb_i;  
  wire          [31:0]  prdata_ppu_cpu_apb_i;   
  wire                  penable;              
  wire                  pwrite;               
  ...
  nic400_amib_slave_9_a_gen_sse710_sys_apb #(
  ...
  assign psel_ppu_cpu_apb_i = psel_i[0];

  assign prdata  = prdata_ppu_cpu_apb_i;
  assign pslverr = pslverr_ppu_cpu_apb_i & psel_i[0];
  assign pready  = pready_ppu_cpu_apb_i | psel_i[1];
