...
`include "nic400_dmu_a_defs_sse710_sys_apb.v"

module nic400_dmu_a_sse710_sys_apb
  (
  ...
  input               sysperi_axis_cactive;             


  input               sysperi_axis_cactive_wakeup;      


  output              sysperi_axis_port_enable;         
  ...
  wire          sysperi_axis_cactive;
  wire          sysperi_axis_cactive_wakeup;
  wire          domain_active;
  wire          cactive_wakeup;
  wire          cactive_ot;
  ...
  assign cactive_ot = (sysperi_axis_cactive); 

  

  assign cactive_wakeup = sysperi_axis_cactive_wakeup;
  ...
  assign sysperi_axis_port_enable = port_enable_reg;
...
`include "nic400_dmu_a_undefs_sse710_sys_apb.v"
