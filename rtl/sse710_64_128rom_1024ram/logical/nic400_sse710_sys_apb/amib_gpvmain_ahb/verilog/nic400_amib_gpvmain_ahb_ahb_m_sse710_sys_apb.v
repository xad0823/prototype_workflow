...
module nic400_amib_gpvmain_ahb_ahb_m_sse710_sys_apb
(
  aclk,
  aresetn,
  ...
  wire                  aready_i;             
  wire                  avalid_i;             
  wire          [64:0]  a_src_data;           
  wire          [64:0]  a_dst_data;           
  wire                  awrite_mux;           
  wire        [11:0]    aid_mux;              
  wire        [7:0]     alen_mux;             
  wire           [2:0]  asize_mux;            
  ...
  wire           [3:0]  acache_mux;           
  wire                  ach_hndshk;           
  wire          [12:0]  acb_data_in;          
  wire                  acb_push;             
  wire                  acb_push_in;          
  wire                  acb_pop;              
  wire                  acb_pop_in;           
  wire          [12:0]  acb_data_out;         
  wire                  acb_ready;            
  wire                  acb_not_empty;        
  ...
  nic400_rev_regd_slice_sse710_sys_apb #(
    .PAYLD_WIDTH     (65)
  ) u_ach_reg_slice
  (
    .aresetn         (aresetn),
  ...
  nic400_ful_regd_slice_sse710_sys_apb #(
    .PAYLD_WIDTH    (13)
  ) u_ahb_amib_acb
  (
    .aresetn        (aresetn),
  ...
  nic400_amib_gpvmain_ahb_s_gen_sse710_sys_apb #(
    .DATA_WIDTH     (32)
  ) u_ahb_amib_s_gen
  (
  ...
  nic400_amib_gpvmain_ahb_a_gen_sse710_sys_apb #(
    .ADDR_WIDTH     (12)
  ) u_a_gen
  (
