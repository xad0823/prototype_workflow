...
`include "nic400_ib_sysperi_axis_ib_defs_sse710_sys_apb.v"



module nic400_ib_sysperi_axis_ib_master_domain_sse710_sys_apb
  (
  ...
  output  [6:0]       awvalid_vect_axi4_m;      
  output  [3:0]       awregion_axi4_m;          
  ...
  output  [6:0]       arvalid_vect_axi4_m;      
  output  [3:0]       arregion_axi4_m;          
  ...
  output  [13:0]      b_data;                   
  input   [3:0]       b_rpntr_gry;              
  input   [2:0]       b_rpntr_bin;              
  output  [3:0]       b_wpntr_gry;              
  ...
  wire [6:0]          awvalid_vector;
  wire [6:0]          arvalid_vector;
  ...
  wire [46:0]         r_boundary_src_data;     
  wire [46:0]         r_boundary_dst_data;     
  ...
  wire [13:0]         b_boundary_src_data;     
  wire [13:0]         b_boundary_dst_data;     
  ...
  wire [3:0]          b_rpntr_gry;           
  wire [2:0]          b_rpntr_bin;           
  wire [3:0]          b_wpntr_gry;           
  ...
  nic400_ib_sysperi_axis_ib_aw_fifo_rd_sse710_sys_apb
  u_aw_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_sysperi_axis_ib_ar_fifo_rd_sse710_sys_apb
  u_ar_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_sysperi_axis_ib_r_fifo_wr_sse710_sys_apb
  u_r_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_sysperi_axis_ib_w_fifo_rd_sse710_sys_apb
  u_w_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_sysperi_axis_ib_b_fifo_wr_sse710_sys_apb
  u_b_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
...
nic400_ib_sysperi_axis_ib_maskcntl_sse710_sys_apb u_maskcntl (
  ...
  assign awvalid_vect_axi4_m = ({7{awvalid_axi4_m}} & awvalid_vector);
  assign arvalid_vect_axi4_m = ({7{arvalid_axi4_m}} & arvalid_vector);
...
`include "nic400_ib_sysperi_axis_ib_undefs_sse710_sys_apb.v"
