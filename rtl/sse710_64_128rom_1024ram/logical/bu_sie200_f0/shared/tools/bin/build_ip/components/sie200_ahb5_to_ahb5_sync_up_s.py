...
class sie200_ahb5_to_ahb5_sync_up_s(sie200_base.AcgSlaveComponent):
    def __init__(self):
        super(sie200_ahb5_to_ahb5_sync_up_s, self).__init__()

        self.name = "sie200_ahb5_to_ahb5_sync_up_s"
        self.version = "r0p0_1"
        self.description = "AHB5 to AHB5 Sync Up Bridge Slave"
        ...
        intif_m = sie200_base.internal_sie200_ahb5_to_ahb5_sync_up_if(0)
        ...
        interfaces = [
            ahbif_s,
            sie200_base.irqif("ahb5_sync_up"),
            sie200_base.internalInterrupt("ahb5_sync_up", sig_clear = 1),
            intif_m
        ]
