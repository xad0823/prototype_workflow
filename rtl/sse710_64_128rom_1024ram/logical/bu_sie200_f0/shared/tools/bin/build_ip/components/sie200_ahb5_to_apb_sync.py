...
class ahb5_to_apb_sync_adhoc_if(base.Interface):
    def __init__(self):
        super(ahb5_to_apb_sync_adhoc_if, self).__init__()
...
class sie200_ahb5_to_apb_sync(sie200_base.AcgComponent):
    def __init__(self):
        super(sie200_ahb5_to_apb_sync, self).__init__("hclk","pclk")

        self.name = "sie200_ahb5_to_apb_sync"
        self.version = "r0p0_1"
        self.description = "AHB5 to APB Synchronous Bridge"
