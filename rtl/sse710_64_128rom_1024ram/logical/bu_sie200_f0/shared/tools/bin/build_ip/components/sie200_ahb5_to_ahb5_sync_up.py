...
class sie200_ahb5_to_ahb5_sync_up(sie200_base.AcgComponent):
    def __init__(self):
        super(sie200_ahb5_to_ahb5_sync_up, self).__init__()

        self.name = "sie200_ahb5_to_ahb5_sync_up"
        self.version = "r0p0_1"
        self.description = "AHB5 to AHB5 Sync Up Bridge"
