...
class sie200_ahb5_to_ahb5_ll_sync_down(sie200_base.BridgeComponent):
    def __init__(self):
        super(sie200_ahb5_to_ahb5_ll_sync_down, self).__init__()

        self.name = "sie200_ahb5_to_ahb5_ll_sync_down"
        self.version = "r0p0_0"
        self.description = "AHB5 to AHB5 Low Latency Sync Down Bridge"
        ...
        interfaces = [
            ahbif_s,
            ahbif_m,
            sie200_base.irqif("ahb5_ll_sync_down", clk_name="hclk"),
            sie200_base.internalInterrupt("ahb5_ll_sync_down", sig_clear = 1, clk_name="hclk")
        ]
