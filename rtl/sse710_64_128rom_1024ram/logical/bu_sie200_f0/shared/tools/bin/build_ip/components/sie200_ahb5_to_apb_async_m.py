...
class ahb5_to_apb_async_adhoc_if_m(base.Interface):
    def __init__(self):
        super(ahb5_to_apb_async_adhoc_if_m, self).__init__()
...
class sie200_ahb5_to_apb_async_m(sie200_base.AcgMasterComponent):
    def __init__(self):
        super(sie200_ahb5_to_apb_async_m, self).__init__("pclk")

        self.name = "sie200_ahb5_to_apb_async_m"
        self.version = "r0p0_1"
        self.description = "AHB5 to APB Asynchronous Bridge Master"
        ...
        intif_s = sie200_base.internal_sie200_ahb5_to_apb_async_if(1)
