...
class extmem16_adhoc_if(base.Interface):
    def __init__(self):
        super(extmem16_adhoc_if, self).__init__()
...
class sie200_ahb5_to_extmem16(base.Component):
    def __init__(self):
        super(sie200_ahb5_to_extmem16, self).__init__()

        self.name = "sie200_ahb5_to_extmem16"
        self.version = "r0p0_0"
        self.description = "AHB5 to External SRAM interface"
        ...
        ahbif_s = sie200_base.ahbif(mlock=0,nonsec=0,excl=0,prot=0,burst=0)
        sramif_m = sie200_base.extsramif()
        ...
        interfaces = [
            ...
            extmem16_adhoc_if(),
            sramif_m,
            sie200_base.cfgif("_read_cycle",3),
            sie200_base.cfgif("_write_cycle",3),
            sie200_base.cfgif("_turnaround_cycle",3),
            sie200_base.cfgif("_size")
        ]
        self.interfaces.extend(interfaces)

        files = [
            os.path.join("..","..",self.name,"verilog",self.name + "_ahb_fsm.v"),
            os.path.join("..","..",self.name,"verilog",self.name + "_mem_fsm.v")
        ]
