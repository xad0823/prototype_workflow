...
//      Version Information
//
//      Checked In          : Thu Sep 1 09:48:10 2016 +0100
//
//      Revision            : 0ad263d
//
...
module sie200_ahb5_to_ahb5_sync_up #(
...
wire    [DATA_WIDTH-1:0] hwdatas_reg;
wire    [USER_WIDTH-1:0] hwusers_reg;
wire                     hrespm_reg;
wire                     hexokaym_reg;
...
sie200_ahb5_to_ahb5_sync_up_s # (
  ...
  u_slave(
    ...
    .hrdata_s         (hrdata_s                ),
    .hruser_s         (hruser_s                ),
    .ahb5_sync_up_irq       (ahb5_sync_up_irq        ),
    .ahb5_sync_up_irq_clear (ahb5_sync_up_irq_clear  ),
