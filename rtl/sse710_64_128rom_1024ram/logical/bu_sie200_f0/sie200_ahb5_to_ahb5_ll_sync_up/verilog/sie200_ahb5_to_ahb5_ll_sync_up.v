...
module sie200_ahb5_to_ahb5_ll_sync_up #(
...
(
  ...
  output wire                    ahb5_ll_sync_up_irq,
  input  wire                    ahb5_ll_sync_up_irq_clear
  );
...
sie200_ahb5_to_ahb5_ll_sync_up_core # (
  ...
  if (WRITE_BUFFER == 1) begin: gen_wb_support
    ...
    sie200_ahb5_ll_write_buffer # (
      ...
      u_wb(
        ...
        .hrdata_m         (hrdatas_i   ),
        .hruser_m         (hrusers_i   ),
        .bwerr_clear      (ahb5_ll_sync_up_irq_clear),
        .bwerr            (ahb5_ll_sync_up_irq      )
    );
    ...
    assign ahb5_ll_sync_up_irq = 1'b0;
  end
endgenerate
