...
`ifndef VIP_AHB5_CHANNEL_COVERAGE_BASE_SVH
`define VIP_AHB5_CHANNEL_COVERAGE_BASE_SVH



class vip_ahb5_channel_coverage_base extends uvm_object;

    `uvm_object_utils(vip_ahb5_channel_coverage_base)

    vip_ahb5_channel_cov_item transfer;
...
endclass: vip_ahb5_channel_coverage_base
