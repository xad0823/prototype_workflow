...
module sie200_ahb5_to_ahb5_sync_down_m #(
 ...
 (
  ...
  input  wire                     hsels_i,
  input  wire [ADDR_WIDTH-1:0]    haddrs_i,
  input  wire [1:0]               htranss_i,
  input  wire [DATA_WIDTH-1:0]    hwdatas_i,
  input  wire [USER_WIDTH-1:0]    hwusers_i,
...
sie200_ahb5_to_ahb5_sync_down_core_m # (
    .AW                 (ADDR_WIDTH ),
    .DW                 (DATA_WIDTH ),
    .MW                 (MASTER_WIDTH ),
    .UW                 (USER_WIDTH ),
