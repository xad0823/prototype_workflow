...
// -----------------------------------------------------------------------------
    ...
    output [1:0] HAUSERM;    // User addr_opess bus
...
// -----------------------------------------------------------------------------
    ...
    wire [1:0] HAUSERM;    // User addr_opess bus
    ...
    wire [1:0] HWUSERM;    // User data bus
...
// -----------------------------------------------------------------------------
  ...
  cm0p_mtx_arbiterTARGCRYPTO u_output_arb (
  ...
  assign HAUSERM     = ( (addr_in_port == 1'b0) & !no_port ) ? auser_op0 : {2{1'b0}};
  ...
  assign HWDATAM = wdata_phase ? wdata_op0 : {32{1'b0}};

  // HWUSERM output decode
  assign HWUSERM = wdata_phase ? wuser_op0 : {2{1'b0}};
