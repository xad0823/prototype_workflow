...
module nic400_bm0_add_sel_ml2_secenc_f1
  (
    awuser_m,
    awid_m,
    awaddr_m,
  ...
  wire              wr_override;   
  wire              rd_override;   
  wire   [1:0]      rd_wr_awvalid;
  wire   [1:0]      rd_wr_arvalid;

  wire   [1:0]      awuser_masked0;
  wire              awid_masked0;
...
nic400_bm0_maskcntl_ml2_secenc_f1 u_nic400_bm0_maskcntl_ml2_secenc_f1 (
        .last_slot    (last_slot),
...
nic400_bm0_rd_wr_arb_2_secenc_f1 u_nic400_bm0_rd_wr_arb_2_secenc_f1 (
...
nic400_bm0_add_arb_ml2_secenc_f1 u_nic400_bm0_aw_arb_ml2_secenc_f1 (
...
nic400_bm0_add_arb_ml2_secenc_f1 u_nic400_bm0_ar_arb_ml2_secenc_f1 (
    ...
    assign awuser_masked0  = awuser_s0_i & {2{aw_sel_i[0]}}; 
    assign awid_masked0    = awid_s0_i & {1{aw_sel_i[0]}};
    ...
    assign aruser_masked0  = aruser_s0_i & {2{ar_sel_i[0]}};
    assign arid_masked0   = arid_s0_i & {1{ar_sel_i[0]}};
    ...
    assign awuser_masked1  = awuser_s1_i & {2{aw_sel_i[1]}}; 
    assign awid_masked1    = awid_s1_i & {1{aw_sel_i[1]}};
    ...
    assign aruser_masked1  = aruser_s1_i & {2{ar_sel_i[1]}};
    assign arid_masked1   = arid_s1_i & {1{ar_sel_i[1]}};
