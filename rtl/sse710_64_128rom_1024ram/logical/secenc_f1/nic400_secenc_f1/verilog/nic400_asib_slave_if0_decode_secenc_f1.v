...
module nic400_asib_slave_if0_decode_secenc_f1
  (
    addr_s,
    security63,
    security62,
  ...
  assign decode_int[0] = (32'h60000000 <= addr_s) && (addr_s <= 32'hDFFFFFFF);

  assign decode_int[1] = (32'h50200000 <= addr_s) && (addr_s <= 32'h503FFFFF);

  assign decode_int[2] = (32'h2F000000 <= addr_s) && (addr_s <= 32'h2FFFFFFF);
  ...
  assign remap_decode[2] = ~(aprot & security60) & decode_int[2];
  ...
  assign ahb_target    = avalid_int[0];
