...
module nic400_bm0_add_arb_ml4_secenc_f1
  (
    a_sel,
    a_valid_vector,
    aready,
...
nic400_bm0_qv_cmp_secenc_f1 #(.REQUESTS (REQUESTS), .QOS_WIDTH (QOS_WIDTH)) u_highest_qos (
...
nic400_bm0_lrg_arb_secenc_f1 #(.WIDTH(REQUESTS)) u_lrg_arb (
  .aclk       (aclk),
  .aresetn    (aresetn),
  .update_en  (update),
  .request    (request),
