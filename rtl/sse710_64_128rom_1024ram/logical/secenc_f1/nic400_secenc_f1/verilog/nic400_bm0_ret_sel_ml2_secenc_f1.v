...
module nic400_bm0_ret_sel_ml2_secenc_f1
  (
    wr_cnt_empty,
...
ovl_assert_illegal_rid
   (
    .clk       (nic400_bm0_secenc_f1.aclk),
    .reset_n   (nic400_bm0_secenc_f1.aresetn),
