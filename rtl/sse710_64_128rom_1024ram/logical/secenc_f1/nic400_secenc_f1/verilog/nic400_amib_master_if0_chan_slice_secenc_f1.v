...
module nic400_amib_master_if0_chan_slice_secenc_f1
  (
   aresetn,
   aclk,
...
`endif
  ...
  nic400_ful_regd_slice_secenc_f1 #(PAYLD_WIDTH) u_ful_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_fwd_regd_slice_secenc_f1 #(PAYLD_WIDTH) u_fwd_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_rev_regd_slice_secenc_f1 #(PAYLD_WIDTH) u_rev_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
