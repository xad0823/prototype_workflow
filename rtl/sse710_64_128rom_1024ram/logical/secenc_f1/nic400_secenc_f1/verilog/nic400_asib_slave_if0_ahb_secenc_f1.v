...
`include "nic400_asib_slave_if0_ahb_defs_secenc_f1.v"
`include "Axi.v"
`include "AhbDefns.v"

module nic400_asib_slave_if0_ahb_secenc_f1
(
  aclk,
  aresetn,
  ...
  reg                   r_override_int;         
  wire                  override_en;            
  wire  [42:0]          ti_reg_payload_in;      
  reg   [42:0]          ti_reg_payload_out;     
  ...
  wire  [49:0]          addr_payload;           
  wire                  addr_done;              
  reg   [49:0]          addr_payload_out;       
  reg                   avalid_out;             
  wire                  alock1_out;             
  wire                  awrite_out;             
  wire  [3:0]           acache_out;             
  ...
  begin : p_hold_addr_payload_mux_comb
      case (hold_addr_payload)
          ...
          default: addr_payload_out = {50{1'bx}};
      endcase
  end
...
`include "nic400_asib_slave_if0_ahb_undefs_secenc_f1.v"
