...
module nic400_bm0_ml_blayer_0_secenc_f1
  (
  ...
  nic400_bm0_wr_st_tt_s0_secenc_f1 u_nic400_bm0_wr_st_tt_1_4m_secenc_f1 (
        .aw_enable    (aw_enable),
  ...
  nic400_bm0_rd_st_tt_s0_secenc_f1 u_nic400_bm0_rd_st_tt_1_4m_secenc_f1 (
  ...
  assign bid_s_int[0] = bid_m0 & tt_enable_wr[0];
  ...
  assign bid_s_int[1] = bid_m1 & tt_enable_wr[1];
  ...
  assign bid_s_int[2] = bid_m2 & tt_enable_wr[2];
  ...
  assign bid_s_int[3] = bid_m3 & tt_enable_wr[3];
  ...
  assign rid_s_int[0] = rid_m0 & tt_enable_rd[0];
  ...
  assign rid_s_int[1] = rid_m1 & tt_enable_rd[1];
  ...
  assign rid_s_int[2] = rid_m2 & tt_enable_rd[2];
  ...
  assign rid_s_int[3] = rid_m3 & tt_enable_rd[3];
