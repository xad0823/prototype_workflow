...
module nic400_amib_master_if2_ahb_m_secenc_f1
(
  aclk,
  aresetn,
  ...
  wire                  aready_i;             
  wire                  avalid_i;             
  wire          [55:0]  a_src_data;           
  wire          [55:0]  a_dst_data;           
  wire                  awrite_mux;           
  wire                  aid_mux;              
  wire        [7:0]     alen_mux;             
  wire           [2:0]  asize_mux;            
  ...
  assign auser_mux  = ach_hndshk ? auser_reg  : auser_h;
  ...
  nic400_amib_master_if2_s_gen_secenc_f1 #(
    .DATA_WIDTH     (32)
  ) u_ahb_amib_s_gen
  (
  ...
  nic400_amib_master_if2_a_gen_secenc_f1 #(
    .ADDR_WIDTH     (12)
  ) u_a_gen
  (
