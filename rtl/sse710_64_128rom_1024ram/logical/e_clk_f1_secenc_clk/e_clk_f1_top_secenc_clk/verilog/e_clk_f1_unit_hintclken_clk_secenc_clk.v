...
module e_clk_f1_unit_hintclken_clk_secenc_clk (
    input   wire                        SYSTOP_RESETn,  
    
    input   wire                        SECENCDIVCLK_I_HINTCLKEN_CLK,
...
(
    .CLK                    (SECENCDIVCLK_I_HINTCLKEN_CLK), 
...
(
    .CLKIN                  (SECENCDIVCLK_I_HINTCLKEN_CLK), 
    .CLKOUT                 (clk_dct_cg), 
    .ENABLE                 (dct_cg_sync), 
    .DFTSE                  (DFTCGEN) 
);
...
assign HINTCLKEN_CLK = c_clk_buf;
