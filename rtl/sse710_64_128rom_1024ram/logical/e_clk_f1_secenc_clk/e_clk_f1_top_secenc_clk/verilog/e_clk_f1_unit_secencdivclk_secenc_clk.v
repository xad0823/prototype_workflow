...
module e_clk_f1_unit_secencdivclk_secenc_clk (
...
u_e_clk_f1_clock_buffer_secencdivclk 
(
    .clk_in                 (clk_dct_cg), 
    .clk_out                (c_clk_buf) 
);
