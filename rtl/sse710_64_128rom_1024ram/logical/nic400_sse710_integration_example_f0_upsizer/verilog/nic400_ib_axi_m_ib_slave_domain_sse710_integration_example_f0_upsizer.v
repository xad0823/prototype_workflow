...
module nic400_ib_axi_m_ib_slave_domain_sse710_integration_example_f0_upsizer
  (
  ...
  wire [53:0]         aw_slave_port_src_data;     
  wire [53:0]         aw_slave_port_dst_data;     
  ...
  wire [53:0]         ar_slave_port_src_data;     
  wire [53:0]         ar_slave_port_dst_data;     
  ...
  wire [35:0]         r_slave_port_src_data;     
  wire [35:0]         r_slave_port_dst_data;     

  wire [36:0]         w_slave_port_src_data;     
  wire [36:0]         w_slave_port_dst_data;     

  wire [2:0]          b_slave_port_src_data;     
  wire [2:0]          b_slave_port_dst_data;     
  ...
  wire [15:0]         arfifo_data;
  wire                arfifo_valid;
  wire                arfifo_ready;  
  wire  [53:0]        aw_fmt_src_data;
  wire  [53:0]        ar_fmt_src_data;
  wire  [53:0]        aw_fmt_dst_data;
  wire  [53:0]        ar_fmt_dst_data;
  ...
  nic400_ib_axi_m_ib_upsize_wr_addr_fmt_sse710_integration_example_f0_upsizer u_axi_write_address_format
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
...
nic400_ib_axi_m_ib_upsize_wr_cntrl_sse710_integration_example_f0_upsizer u_upsize_axi_write_control
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
  ...
  nic400_ib_axi_m_ib_upsize_wr_merge_buffer_sse710_integration_example_f0_upsizer u_upsize_axi_write_merge_buffer
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
  ...
  nic400_ib_axi_m_ib_upsize_wr_resp_block_sse710_integration_example_f0_upsizer u_upsize_axi_write_response_block
  (
  ...
  nic400_ib_axi_m_ib_upsize_rd_addr_fmt_sse710_integration_example_f0_upsizer u_axi_read_address_format
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
  ...
  nic400_ib_axi_m_ib_upsize_rd_chan_sse710_integration_example_f0_upsizer u_upsize_axi_read_channel
  (
  ...
  nic400_ib_axi_m_ib_chan_slice_sse710_integration_example_f0_upsizer
    #(
       `RS_REV_REG,  
       54  
     )
