...
module nic400_reg_slice_axi_sse710_integration_example_f0_upsizer
  (
   aresetn,
   aclk,
  ...
  nic400_ax_reg_slice_sse710_integration_example_f0_upsizer #(ID_WIDTH, AWUSER_WIDTH, AW_HNDSHK_MODE, ADDR_WIDTH) u_aw_reg_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_wr_reg_slice_sse710_integration_example_f0_upsizer #(ID_WIDTH, DATA_WIDTH, WUSER_WIDTH, W_HNDSHK_MODE) u_wr_reg_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_buf_reg_slice_sse710_integration_example_f0_upsizer #(ID_WIDTH, BUSER_WIDTH, B_HNDSHK_MODE) u_buf_reg_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_ax_reg_slice_sse710_integration_example_f0_upsizer #(ID_WIDTH, ARUSER_WIDTH, AR_HNDSHK_MODE, ADDR_WIDTH) u_ar_reg_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_rd_reg_slice_sse710_integration_example_f0_upsizer #(ID_WIDTH, DATA_WIDTH, RUSER_WIDTH, R_HNDSHK_MODE) u_rd_reg_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
