...
module nic400_ib_axi_m_ib_upsize_rd_chan_sse710_integration_example_f0_upsizer
  (
  rvalid_s,
  rdata_s,
  rlast_s,
...
`include "nic400_ib_axi_m_ib_defs_sse710_integration_example_f0_upsizer.v"
  ...
  output                    rlast_s;
   ...
   assign pop_slice = update && rlast_s_i;
     ...
     nic400_ib_axi_m_ib_upsize_rd_cam_slice_sse710_integration_example_f0_upsizer u_upsize_rd_cam_slice_0
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
