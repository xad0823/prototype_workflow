...
//  value of nxt_count.
// 32 bit counter is implemented as two 16 bit counters to improve FPGA synthesis.

  // Halfword 0, bits 15:0
  always @ (reg_count)
    begin : p_dec0comb
      nxt_count_low[15:0] = (reg_count[15:0] - 16'b1);
    end
  ...
  always @ (reg_count or reg_carry)
    begin : p_dec1comb
      if (reg_carry[0])
        nxt_count_high[15:0] = (reg_count[31:16] - 16'b1);
      else
