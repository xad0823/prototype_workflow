...
//------------------------------------------------------------------------------
localparam ST_IDLE      = 2'b00; // Idle state, initialisations
localparam ST_OFFSET    = 2'b01; // Offset value calculated in this state
localparam ST_RTCVALUE  = 2'b10; // RTC value calculated in this state
localparam ST_MATCHDATA = 2'b11; // Matchdata calculated in this state
//------------------------------------------------------------------------------
//
// Main Verilog code
// =================
