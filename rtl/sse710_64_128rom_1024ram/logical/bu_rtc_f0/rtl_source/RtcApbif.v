...
assign NextPRDATA =  (RdenRTCDR   == 1'b1)     ? RTCDR
                   ...
                   : (PERIPHID0rd == 1'b1)     ? {24'h000000, PERIPHID0}
                   : (PERIPHID1rd == 1'b1)     ? {24'h000000, PERIPHID1}
                   : (PERIPHID2rd == 1'b1)     ?
                                             {24'h000000, Revision, PERIPHID2}
                   : (PERIPHID3rd == 1'b1)     ? {24'h000000, PERIPHID3}
                   : (PRIMECELLID0rd == 1'b1)  ? {24'h000000, PCELLID0}
                   : (PRIMECELLID1rd == 1'b1)  ? {24'h000000, PCELLID1}
                   : (PRIMECELLID2rd == 1'b1)  ? {24'h000000, PCELLID2}
                   : (PRIMECELLID3rd == 1'b1)  ? {24'h000000, PCELLID3}
                   : 32'h00000000;
