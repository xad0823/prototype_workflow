...
module nic400_ib_hostcpu_axis_ib_w_fifo_wr_mux2_sse710_main
(
  din_0,
  din_1,
  sel,
...
nic400_cdc_comb_mux2_sse710_main u_cdc_mux_143
  (
    .din1_async (din_0[143]),
    .din2_async (din_1[143]),
    .sel        (sel),
    .dout_async (dout[143])
  );
nic400_cdc_comb_mux2_sse710_main u_cdc_mux_144
  (
    .din1_async (din_0[144]),
    .din2_async (din_1[144]),
    .sel        (sel),
    .dout_async (dout[144])
  );
