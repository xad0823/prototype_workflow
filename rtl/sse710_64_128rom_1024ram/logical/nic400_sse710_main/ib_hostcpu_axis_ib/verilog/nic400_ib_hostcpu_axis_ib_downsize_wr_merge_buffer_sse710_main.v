...
module nic400_ib_hostcpu_axis_ib_downsize_wr_merge_buffer_sse710_main
  (
  wdata_out, 
  wstrb_out,
  merge_skid_valid,
  ...
  input                                 merge_clear;
   ...
   assign wide_wdata_in     = {1{wdata_in}}; 
   assign wide_wstrb_masked = {1{wstrb_in}} | {16{all_bytes}}; 
   assign wide_wstrb_in     = {1{wstrb_in}};
   ...
   assign merge_byte_15 = merge && data_select[0] && wide_wstrb_masked[15];
   ...
   assign wstrb_out_i[15] = merge_byte_15 ? wide_wstrb_in[15] :
                           (((strb_skid_valid && data_select[0]) || (~strb_skid_valid && ~update_strb)) ? merged_strb_15 : 1'b0);
   ...
   assign merge_byte_14 = merge && data_select[0] && wide_wstrb_masked[14];
   ...
   assign wstrb_out_i[14] = merge_byte_14 ? wide_wstrb_in[14] :
                           (((strb_skid_valid && data_select[0]) || (~strb_skid_valid && ~update_strb)) ? merged_strb_14 : 1'b0);
   ...
   assign merge_byte_13 = merge && data_select[0] && wide_wstrb_masked[13];
   ...
   assign wstrb_out_i[13] = merge_byte_13 ? wide_wstrb_in[13] :
                           (((strb_skid_valid && data_select[0]) || (~strb_skid_valid && ~update_strb)) ? merged_strb_13 : 1'b0);
   ...
   assign merge_byte_12 = merge && data_select[0] && wide_wstrb_masked[12];
   ...
   assign wstrb_out_i[12] = merge_byte_12 ? wide_wstrb_in[12] :
                           (((strb_skid_valid && data_select[0]) || (~strb_skid_valid && ~update_strb)) ? merged_strb_12 : 1'b0);
   ...
   assign merge_byte_11 = merge && data_select[0] && wide_wstrb_masked[11];
   ...
   assign wstrb_out_i[11] = merge_byte_11 ? wide_wstrb_in[11] :
                           (((strb_skid_valid && data_select[0]) || (~strb_skid_valid && ~update_strb)) ? merged_strb_11 : 1'b0);
   ...
   assign merge_byte_10 = merge && data_select[0] && wide_wstrb_masked[10];
   ...
   assign wstrb_out_i[10] = merge_byte_10 ? wide_wstrb_in[10] :
                           (((strb_skid_valid && data_select[0]) || (~strb_skid_valid && ~update_strb)) ? merged_strb_10 : 1'b0);
   ...
   assign merge_byte_9 = merge && data_select[0] && wide_wstrb_masked[9];
   ...
   assign wstrb_out_i[9] = merge_byte_9 ? wide_wstrb_in[9] :
                           (((strb_skid_valid && data_select[0]) || (~strb_skid_valid && ~update_strb)) ? merged_strb_9 : 1'b0);
   ...
   assign merge_byte_8 = merge && data_select[0] && wide_wstrb_masked[8];
   ...
   assign wstrb_out_i[8] = merge_byte_8 ? wide_wstrb_in[8] :
                           (((strb_skid_valid && data_select[0]) || (~strb_skid_valid && ~update_strb)) ? merged_strb_8 : 1'b0);
