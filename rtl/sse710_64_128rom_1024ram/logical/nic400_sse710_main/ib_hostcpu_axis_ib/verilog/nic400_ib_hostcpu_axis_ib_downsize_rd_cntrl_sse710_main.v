...
module nic400_ib_hostcpu_axis_ib_downsize_rd_cntrl_sse710_main
  (
    rvalid_s,
    rlast_s,
  ...
  assign rbeat_in = |rbeats ? (rbeats - {{2{1'b0}},1'b1}) : 
                                          {3{1'b0}};

  assign next_rbeat_reg = ((busy_reg_next) & (~|rbeat_reg)) ? rbeat_in : 
                          (((busy_reg_next) & (rvalid_m & rready_s)) ? (rbeat_reg - {{2{1'b0}},1'b1}) : (rbeat_reg));
