...
module nic400_ib_hostcpu_axis_ib_apb_mask_sse710_main
  (
   pready,
   prdata, 
   pslverr,   
   ...
   nic400_ib_hostcpu_axis_ib_apb_cond_mask_sse710_main 
   ...
   nic400_ib_hostcpu_axis_ib_apb_reg_block_mask_sse710_main 
