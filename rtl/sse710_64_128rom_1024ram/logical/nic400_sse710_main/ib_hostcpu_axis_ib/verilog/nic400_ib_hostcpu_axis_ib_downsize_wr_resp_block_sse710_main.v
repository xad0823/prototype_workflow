...
module nic400_ib_hostcpu_axis_ib_downsize_wr_resp_block_sse710_main
  (
  bvalid_m,
  bready_s,
  bresp_m,
...
`include "nic400_ib_hostcpu_axis_ib_defs_sse710_main.v"
  ...
  input [11:0]            bchannel_data;


   wire [15:0]            match_bus;
   wire [15:0]            hazard_bus;
   ...
   reg [3:0]              hazard_pointer;
   reg [3:0]              match_pointer;
   ...
   assign awid = bchannel_data[11:4];
   ...
   assign next_bchannel_ready = ~(&(valid_bus | (store & {16{push_slice}}))) || (pop_slice);
   ...
   always @(valid_bus or match_bus)
     begin : store_decode
        if (!valid_bus[0])
           store = 16'b0000000000000001;
         else if (!valid_bus[1])
            store = 16'b0000000000000010;
         else if (!valid_bus[2])
            store = 16'b0000000000000100;
         else if (!valid_bus[3])
            store = 16'b0000000000001000;
         else if (!valid_bus[4])
            store = 16'b0000000000010000;
         else if (!valid_bus[5])
            store = 16'b0000000000100000;
         else if (!valid_bus[6])
            store = 16'b0000000001000000;
         else if (!valid_bus[7])
            store = 16'b0000000010000000;
         else if (!valid_bus[8])
            store = 16'b0000000100000000;
         else if (!valid_bus[9])
            store = 16'b0000001000000000;
         else if (!valid_bus[10])
            store = 16'b0000010000000000;
         else if (!valid_bus[11])
            store = 16'b0000100000000000;
         else if (!valid_bus[12])
            store = 16'b0001000000000000;
         else if (!valid_bus[13])
            store = 16'b0010000000000000;
         else if (!valid_bus[14])
            store = 16'b0100000000000000;
         else if (!valid_bus[15])
            store = 16'b1000000000000000;
        else
            store = match_bus;
      end 
   ...
   always @(hazard_bus)
     begin : hazard_num_distibution
       case (hazard_bus)
          16'b0 : hazard_pointer = 4'b0;
           16'd1 : hazard_pointer = 4'd0;
          16'd2 : hazard_pointer = 4'd1;
          16'd4 : hazard_pointer = 4'd2;
          16'd8 : hazard_pointer = 4'd3;
          16'd16 : hazard_pointer = 4'd4;
          16'd32 : hazard_pointer = 4'd5;
          16'd64 : hazard_pointer = 4'd6;
          16'd128 : hazard_pointer = 4'd7;
          16'd256 : hazard_pointer = 4'd8;
          16'd512 : hazard_pointer = 4'd9;
          16'd1024 : hazard_pointer = 4'd10;
          16'd2048 : hazard_pointer = 4'd11;
          16'd4096 : hazard_pointer = 4'd12;
          16'd8192 : hazard_pointer = 4'd13;
          16'd16384 : hazard_pointer = 4'd14;
          16'd32768 : hazard_pointer = 4'd15;
         default : hazard_pointer = 4'bx;
       endcase
     end
   ...
   always @(match_bus)
     begin : match_num_distibution
       case (match_bus)
          16'b0 : match_pointer = 4'b0;
           16'd1 : match_pointer = 4'd0;
          16'd2 : match_pointer = 4'd1;
          16'd4 : match_pointer = 4'd2;
          16'd8 : match_pointer = 4'd3;
          16'd16 : match_pointer = 4'd4;
          16'd32 : match_pointer = 4'd5;
          16'd64 : match_pointer = 4'd6;
          16'd128 : match_pointer = 4'd7;
          16'd256 : match_pointer = 4'd8;
          16'd512 : match_pointer = 4'd9;
          16'd1024 : match_pointer = 4'd10;
          16'd2048 : match_pointer = 4'd11;
          16'd4096 : match_pointer = 4'd12;
          16'd8192 : match_pointer = 4'd13;
          16'd16384 : match_pointer = 4'd14;
          16'd32768 : match_pointer = 4'd15;
         default : match_pointer = 4'bx;
       endcase
     end
    ...
    assign bvalid_s = (bvalid_m && match);
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_0
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_1
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_2
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_3
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_4
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_5
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_6
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_7
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_8
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_9
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_10
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_11
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_12
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_13
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_14
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_hostcpu_axis_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_15
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
...
`include "std_ovl_defines.h"
  ...
  assert_zero_one_hot #(`OVL_FATAL,16,0,"More than one B Channel Slice matched")
  ovl_single_ID_match
    (
     .clk              (aclk),
     .reset_n          (aresetn),
     .test_expr        ({16{bvalid_m}} & match_bus)
     );


  assert_zero_one_hot #(`OVL_FATAL,16,0,"More than one B Channel Slice hazard")
  ovl_single_hazard
    (
     .clk              (aclk),
     .reset_n          (aresetn),
     .test_expr        ({16{bchannel_valid}} & hazard_bus)
     );
  ...
  ovl_input_hndshk_error
   ...
   assert_fifo_index #(`OVL_FATAL, 16, 1, 1, 0,"ERROR, BChannel Look-Up under or overflowed")
