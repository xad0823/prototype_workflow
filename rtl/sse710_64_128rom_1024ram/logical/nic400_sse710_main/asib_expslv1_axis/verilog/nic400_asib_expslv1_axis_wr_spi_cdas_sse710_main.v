...
module nic400_asib_expslv1_axis_wr_spi_cdas_sse710_main
  (
    aw_enable,
    wr_enable,
    asel,
  ...
  wire  [28:0]    mask;   
  wire  [28:0]    id_match;   
  wire  [28:0]    dest_match;   
  wire  [28:0]    resp_match;   
  wire           cds_stall;    
  wire           t_push;     
  ...
  reg            aready_reg;   
  reg   [4:0]    tt_cnt;   
  reg   [9:0]    spi_asel [28:0];   
  reg   [7:0]    spi_ids [28:0];   
  reg   [28:0]    spi_valid;   
  reg   [9:0]    hold_asel;   
  reg   [7:0]    hold_aid;   
  reg            hold_valid;   
  reg            t_ready;   
   ...
   assign  mask[28] = {1{|(free_slot0|free_slot1|free_slot2|free_slot3|free_slot4|free_slot5|free_slot6)}}; 

   assign free_slot = {free_slot7,
                       free_slot6,
                       free_slot5,
                       free_slot4,
                       free_slot3,
   ...
   assign resp_sel7 =  resp_match[28];
   ...
   assign  resp_mask[28] = {1{|(resp_sel0|resp_sel1|resp_sel2|resp_sel3|resp_sel4|resp_sel5|resp_sel6)}}; 

   assign resp_sel = {resp_sel7,
                       resp_sel6,
                       resp_sel5,
                       resp_sel4,
                       resp_sel3,
   ...
   always @(posedge aclk or negedge aresetn)
    ...
    begin : p_ptr_seq
      ...
      begin
        if (t_push)
         begin
             for (tt_ptr_val = 0; tt_ptr_val<29; tt_ptr_val=tt_ptr_val+1)
   ...
   always @(posedge aclk)
    begin : p_tt_dat_seq
         ...
         if (t_push)
          begin
                for (tt_ptr = 0; tt_ptr<29; tt_ptr=tt_ptr+1)
