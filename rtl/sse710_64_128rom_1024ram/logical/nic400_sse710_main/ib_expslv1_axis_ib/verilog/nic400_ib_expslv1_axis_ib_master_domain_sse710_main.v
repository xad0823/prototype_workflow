...
`include "nic400_ib_expslv1_axis_ib_defs_sse710_main.v"



module nic400_ib_expslv1_axis_ib_master_domain_sse710_main
  (
  ...
  wire [75:0]         r_boundary_src_data;     
  wire [75:0]         r_boundary_dst_data;     
  ...
  wire [7:0]          rid;
  wire [7:0]          bid;
  wire [2:0]          asib_expslv1_axis_ib_siid;
  ...
  nic400_ib_expslv1_axis_ib_aw_fifo_rd_sse710_main
  u_aw_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_expslv1_axis_ib_ar_fifo_rd_sse710_main
  u_ar_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_expslv1_axis_ib_r_fifo_wr_sse710_main
  u_r_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_expslv1_axis_ib_w_fifo_rd_sse710_main
  u_w_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_expslv1_axis_ib_b_fifo_wr_sse710_main
  u_b_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  assign asib_expslv1_axis_ib_siid = 3'b101;
  assign iid = 1'd0;




  assign awid_axi4_m = {iid,awid,asib_expslv1_axis_ib_siid};
  assign arid_axi4_m = {iid,arid,asib_expslv1_axis_ib_siid};
...
nic400_ib_expslv1_axis_ib_maskcntl_sse710_main u_maskcntl (
...
`include "nic400_ib_expslv1_axis_ib_undefs_sse710_main.v"
