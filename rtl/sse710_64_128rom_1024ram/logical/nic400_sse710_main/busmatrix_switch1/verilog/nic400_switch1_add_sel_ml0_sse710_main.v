...
module nic400_switch1_add_sel_ml0_sse710_main
  (
    awuser_m,
    awid_m,
    awaddr_m,
  ...
  wire   [2:0]      arprot_m_i;
  wire              arvalid_m_i;
  wire   [9:0]      arvalid_vect_m_i;
  wire              arready_m_i;
  wire   [3:0]      ar_qv_m_i;

  wire   [24:0]      awuser_in;
  wire   [24:0]      awuser_out;
  wire   [23:0]      aruser_in;
  wire   [23:0]      aruser_out;
...
nic400_switch1_maskcntl_ml0_sse710_main u_nic400_switch1_maskcntl_ml0_sse710_main (
   ...
   assign last_rd = (rvalid_m & rlast_m);
    ...
    assign awvalid_vect_m_i = awvalid_vect_s0_i & {10{aw_sel_i}};
    ...
    assign arvalid_vect_m_i = arvalid_vect_s0_i & {10{ar_sel_i}};
   ...
   assign awvalid_vect_m    = awuser_out[9:0] & {10{awvalid_m}};
   assign aw_qv_m           = awuser_out[14:11];

   assign awuser_m          = awuser_out[24:15];
...
nic400_ax4_reg_slice_sse710_main
  ...
  u_aw_reg_slice
   ...
   assign ar_qv_m        = aruser_out[13:10];
   assign aruser_m       = aruser_out[23:14];
   assign arvalid_vect_m = aruser_out[9:0] & {10{arvalid_m}};
