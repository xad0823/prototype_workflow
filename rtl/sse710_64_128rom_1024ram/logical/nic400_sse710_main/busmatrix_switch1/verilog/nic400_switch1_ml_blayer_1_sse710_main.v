...
module nic400_switch1_ml_blayer_1_sse710_main
  (
  ...
  assign awvalid_vect_m0 = awvalid_vect_s[9:0] & {10{(aw_enable[0])}};
  ...
  assign awvalid_vect_m1 = awvalid_vect_s[10] & aw_enable[1]; 
  ...
  assign arvalid_vect_m0 = arvalid_vect_s[9:0];
  ...
  assign arvalid_vect_m1 = arvalid_vect_s[10];
  ...
  assign awsel[0] = awvalid_s & |awvalid_vect_s[9:0];
  assign arsel[0] = arvalid_s & |arvalid_vect_s[9:0];
  assign awsel[1] = awvalid_s & awvalid_vect_s[10];
  assign arsel[1] = arvalid_s & arvalid_vect_s[10];

  nic400_switch1_wr_spi_tt_s1_sse710_main u_nic400_switch1_wr_spi_tt_4_2m_sse710_main (
        .aw_enable    (aw_enable),
  ...
  nic400_switch1_rd_spi_tt_s1_sse710_main u_nic400_switch1_rd_spi_tt_4_2m_sse710_main (
