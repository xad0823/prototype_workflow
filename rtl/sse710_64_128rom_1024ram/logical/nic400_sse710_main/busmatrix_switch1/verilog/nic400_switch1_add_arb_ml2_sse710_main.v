...
module nic400_switch1_add_arb_ml2_sse710_main
  (
    a_sel,
    a_valid_vector,
    aready,
...
nic400_switch1_qv_cmp_sse710_main #(.REQUESTS (REQUESTS), .QOS_WIDTH (QOS_WIDTH)) u_highest_qos (
...
nic400_switch1_lrg_arb_sse710_main #(.WIDTH(REQUESTS)) u_lrg_arb (
  .aclk       (aclk),
  .aresetn    (aresetn),
  .update_en  (update),
  .request    (request),
