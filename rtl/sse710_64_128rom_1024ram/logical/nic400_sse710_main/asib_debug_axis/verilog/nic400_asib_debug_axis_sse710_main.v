...
`include "nic400_asib_debug_axis_defs_sse710_main.v"

module nic400_asib_debug_axis_sse710_main
 (
    ...
    awlen_debug_axis_m,
    awsize_debug_axis_m,
    awburst_debug_axis_m,
    awlock_debug_axis_m,
    awcache_debug_axis_m,
    awprot_debug_axis_m,
    awvalid_debug_axis_m,
    awvalid_vect_debug_axis_m,
    awready_debug_axis_m,
    ...
    arlen_debug_axis_m,
    arsize_debug_axis_m,
    arburst_debug_axis_m,
    arlock_debug_axis_m,
    arcache_debug_axis_m,
    arprot_debug_axis_m,
    arvalid_debug_axis_m,
    arvalid_vect_debug_axis_m,
    arready_debug_axis_m,
  ...
  output  [3:0]       rid_debug_axis_s;               
  output  [63:0]      rdata_debug_axis_s;             
  output  [1:0]       rresp_debug_axis_s;             
  output              rlast_debug_axis_s;             
  output              rvalid_debug_axis_s;            
  input               rready_debug_axis_s;            

  input   [9:0]       awuser_debug_axis_s;            
  output              buser_debug_axis_s;             
  input   [9:0]       aruser_debug_axis_s;            
  output              ruser_debug_axis_s;             



  output  [3:0]       awid_debug_axis_m;              
  output  [31:0]      awaddr_debug_axis_m;            
  output  [7:0]       awlen_debug_axis_m;             
  output  [2:0]       awsize_debug_axis_m;            
  output  [1:0]       awburst_debug_axis_m;           
  output              awlock_debug_axis_m;            
  output  [3:0]       awcache_debug_axis_m;           
  output  [2:0]       awprot_debug_axis_m;            
  output              awvalid_debug_axis_m;           
  output  [9:0]       awvalid_vect_debug_axis_m;      
  input               awready_debug_axis_m;           

  output  [63:0]      wdata_debug_axis_m;             
  output  [7:0]       wstrb_debug_axis_m;             
  output              wlast_debug_axis_m;             
  output              wvalid_debug_axis_m;            
  input               wready_debug_axis_m;            

  input   [3:0]       bid_debug_axis_m;               
  input   [1:0]       bresp_debug_axis_m;             
  input               bvalid_debug_axis_m;            
  output              bready_debug_axis_m;            

  output  [3:0]       arid_debug_axis_m;              
  output  [31:0]      araddr_debug_axis_m;            
  output  [7:0]       arlen_debug_axis_m;             
  output  [2:0]       arsize_debug_axis_m;            
  output  [1:0]       arburst_debug_axis_m;           
  output              arlock_debug_axis_m;            
  output  [3:0]       arcache_debug_axis_m;           
  output  [2:0]       arprot_debug_axis_m;            
  output              arvalid_debug_axis_m;           
  output  [9:0]       arvalid_vect_debug_axis_m;      
  input               arready_debug_axis_m;           

  input   [3:0]       rid_debug_axis_m;               
  input   [63:0]      rdata_debug_axis_m;             
  input   [1:0]       rresp_debug_axis_m;             
  input               rlast_debug_axis_m;             
  input               rvalid_debug_axis_m;            
  output              rready_debug_axis_m;            

  output  [9:0]       awuser_debug_axis_m;            
  input               buser_debug_axis_m;             
  output  [9:0]       aruser_debug_axis_m;            
  input               ruser_debug_axis_m;             
  ...
  wire [66:0]    aw_slave_port_src_data;     
  wire [66:0]    aw_slave_port_dst_data;     
  ...
  wire [66:0]    ar_slave_port_src_data;     
  wire [66:0]    ar_slave_port_dst_data;     
  ...
  wire [71:0]    r_slave_port_src_data;     
  wire [71:0]    r_slave_port_dst_data;     
  ...
  wire [6:0]     b_slave_port_src_data;     
  wire [6:0]     b_slave_port_dst_data;     
  ...
  wire                security56;
  wire                security59;
  wire [9:0]          awvalid_vect_debug_axis_m;            
  wire [9:0]          arvalid_vect_debug_axis_m;            
  wire                rvalid_maskcntl;
  wire                wr_cnt_empty;

  wire [3:0]          arcache_int_debug_axis_m;
  wire [3:0]          awcache_int_debug_axis_m;
  wire                arready_int_m;
  wire                awready_int_m;
  wire                arvalid_int_m;
  wire                awvalid_int_m;
  ...
  assign pop_wr_post_count  = wlast_debug_axis_m & wvalid_debug_axis_m & wready_debug_axis_m;
  ...
  assign next_leading_write = (wvalid_debug_axis_m & wready_debug_axis_m & ~push_wr_post_count & (wr_post_count == 3'b001)) ? 1'b1 :
                              ((push_wr_post_count & ~(wvalid_debug_axis_m & wready_debug_axis_m & (wr_post_count == 3'b000))) ? 1'b0 :
                               leading_write);
  ...
  assign arvalid_debug_axis_m = arvalid_int_m & cds_ar_enable;
  assign awvalid_debug_axis_m = awvalid_int_m & cds_aw_enable;
  assign arready_int_m  = arready_debug_axis_m & cds_ar_enable;
  assign awready_int_m  = awready_debug_axis_m & cds_aw_enable;

  assign awaddr_int_m = awaddr_int_s;
  assign araddr_int_m = araddr_int_s;

  assign awaddr_debug_axis_m = awaddr_int_m;
  assign araddr_debug_axis_m = araddr_int_m;


  nic400_asib_debug_axis_decode_sse710_main u_aw_add_decode
  (
    .addr_s                 (awaddr_int_s),
    ...
    .aprot                  (awprot_debug_axis_m[1]),
    .acache_in              (awcache_int_debug_axis_m),
    .acache_out             (awcache_debug_axis_m),
    .avalid_int             (awvalid_vect_debug_axis_m)

  );

nic400_asib_debug_axis_wr_spi_cdas_sse710_main u_asib_debug_axis_wr_spi_cdas
  (
    .aw_enable              (cds_aw_enable),
    .wr_enable              (cds_w_enable),
    .asel                   (awvalid_vect_debug_axis_m),
    .avalid                 (awvalid_int_m),
    .aready                 (awready_int_m),
    .aid                    (awid_debug_axis_m),
    .wvalid                 (wvalid_debug_axis_m),
    .wready                 (wready_debug_axis_m),
    .wlast                  (wlast_debug_axis_m),
    .resp_valid             (bvalid_debug_axis_m),
    .resp_ready             (bready_debug_axis_m),
    .resp_id                (bid_debug_axis_m),
  ...
  nic400_asib_debug_axis_decode_sse710_main u_ar_add_decode
  (
    .addr_s                 (araddr_int_s),
    .security63               (security63),
    .security62               (security62),
    ...
    .security56               (security56),
    .security59               (security59),
    .aprot                  (arprot_debug_axis_m[1]),
    .acache_in              (arcache_int_debug_axis_m),
    .acache_out             (arcache_debug_axis_m),
    .avalid_int             (arvalid_vect_debug_axis_m)

  );

nic400_asib_debug_axis_rd_spi_cdas_sse710_main u_asib_debug_axis_rd_spi_cdas
  (
    .ar_enable              (cds_ar_enable),
    .asel                   (arvalid_vect_debug_axis_m),
    .avalid                 (arvalid_int_m),
    .aready                 (arready_int_m),
    .aid                    (arid_debug_axis_m),
    .resp_valid             (rvalid_debug_axis_m),
    .resp_last              (rlast_debug_axis_m),
    .resp_ready             (rready_debug_axis_m),
    .resp_id                (rid_debug_axis_m),
  ...
  nic400_asib_debug_axis_maskcntl_sse710_main u_asib_debug_axis_maskcntl (
      .awvalid_m    (awvalid_int_m),
      .arvalid_m    (arvalid_int_m),
      .awready_m    (awready_int_m),
      .arready_m    (arready_int_m),
      .bvalid_m     (bvalid_debug_axis_m),
      .bready_m     (bready_debug_axis_m),
      .rvalid_m     (rvalid_maskcntl),
      .rready_m     (rready_debug_axis_m),
  ...
  assign rvalid_maskcntl = rvalid_debug_axis_m & rlast_debug_axis_m;
  ...
  assign {awid_debug_axis_m,
          awaddr_int_s,
          awlen_debug_axis_m,
          awsize_debug_axis_m,
          awburst_debug_axis_m,
          awlock_debug_axis_m,
          awcache_int_debug_axis_m,
          awuser_debug_axis_m,
          awprot_debug_axis_m} = aw_slave_port_dst_data;
  ...
  assign {arid_debug_axis_m,
          araddr_int_s,
          arlen_debug_axis_m,
          arsize_debug_axis_m,
          arburst_debug_axis_m,
          arlock_debug_axis_m,
          arcache_int_debug_axis_m,
          aruser_debug_axis_m,
          arprot_debug_axis_m} = ar_slave_port_dst_data;
  ...
  assign {wdata_debug_axis_m,
          wstrb_debug_axis_m,
          wlast_debug_axis_m} = w_slave_port_dst_data;



  assign wvalid_debug_axis_m = w_slave_port_dst_valid & lwrite_en_w;
  assign w_slave_port_dst_ready = wready_debug_axis_m & lwrite_en_w;
  ...
  assign r_slave_port_src_data = {rid_debug_axis_m,
          rdata_debug_axis_m,
          rresp_debug_axis_m,
          ruser_debug_axis_m,
          rlast_debug_axis_m};
  ...
  assign r_slave_port_src_valid = rvalid_debug_axis_m;
  assign rready_debug_axis_m = r_slave_port_src_ready;



  assign b_slave_port_src_data = {bid_debug_axis_m,
          bresp_debug_axis_m,
          buser_debug_axis_m};

  assign {bid_debug_axis_s,
          bresp_debug_axis_s,
          buser_debug_axis_s} = b_slave_port_dst_data;


  assign bvalid_debug_axis_s =  b_slave_port_dst_valid;
  assign b_slave_port_dst_ready = bready_debug_axis_s;

  assign b_slave_port_src_valid = bvalid_debug_axis_m;
  assign bready_debug_axis_m = b_slave_port_src_ready;



  nic400_asib_debug_axis_chan_slice_sse710_main
    #(
       `RS_REGD,  
       67  
     )
  ...
  assert_zero_one_hot
    #(`OVL_FATAL, 10, `OVL_ASSERT,
      ...
      (
        .clk (aclk),
        .reset_n (aresetn),
        .test_expr ( {10{arvalid_int_m}} & arvalid_vect_debug_axis_m )
      );
  assert_never
    #(`OVL_FATAL, `OVL_ASSERT,
      ...
      (
        .clk (aclk),
        .reset_n (aresetn),
        .test_expr ( arvalid_int_m & ~|arvalid_vect_debug_axis_m )
      );
  ...
  assert_zero_one_hot
    #(`OVL_FATAL, 10, `OVL_ASSERT,
      ...
      (
        .clk (aclk),
        .reset_n (aresetn),
        .test_expr ( {10{awvalid_int_m}} & awvalid_vect_debug_axis_m )
      );
  assert_never
    #(`OVL_FATAL, `OVL_ASSERT,
      ...
      (
        .clk (aclk),
        .reset_n (aresetn),
        .test_expr ( awvalid_int_m & ~|awvalid_vect_debug_axis_m )
      );
...
`include "nic400_asib_debug_axis_undefs_sse710_main.v"
