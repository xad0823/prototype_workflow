...
module nic400_asib_debug_axis_rd_spi_cdas_sse710_main
  (
    ar_enable,
    asel,
    avalid,
  ...
  wire           next_full;     
   ...
   assign next_full = (next_tt_cnt == 3'd5) ? 1'b1 : 1'b0;
   ...
   assign free_slot1 =  slots[4];

   assign  mask[3:0] = {4{1'b0}}; 
   assign  mask[4] = {1{|(free_slot0)}}; 
   ...
   assign resp_sel1 =  resp_match[4];

   assign  resp_mask[3:0] = {4{1'b0}}; 
   assign  resp_mask[4] = {1{|(resp_sel0)}}; 
   ...
   always @(posedge aclk or negedge aresetn)
    ...
    begin : p_ptr_seq
      ...
      begin
       if (t_push)
         begin
             for (tt_ptr_val = 0; tt_ptr_val<5; tt_ptr_val=tt_ptr_val+1)
   ...
   always @(posedge aclk)
    begin : p_tt_dat_seq
         ...
         if (t_push)
          begin
                for (tt_ptr = 0; tt_ptr<5; tt_ptr=tt_ptr+1)
