...
module nic400_ib_secenc_axis_ib_apb_reg_block_mask_sse710_main (
      aclk,
      aresetn,
      pclken,
      addr,
...
nic400_ib_secenc_axis_ib_reg_mask_sse710_main u_reg_mask(
      .aclk (aclk),
      .aresetn  (aresetn),
      .pclken  (pclken),
      .data_in  (data_in),
...
nic400_ib_secenc_axis_ib_apb_decode_mask_sse710_main u_ib_secenc_axis_ib_apb_decode (
      .addr   (addr),
      .enable   (enable),
      .write   (write),
      .wr_strb  (wr_strb),
...
nic400_ib_secenc_axis_ib_data_out_mux_mask_sse710_main u_ib_secenc_axis_ib_data_out_mux (
      .rd_mask   (rd_mask),
      .data_out_mask   (data_out_mask),
