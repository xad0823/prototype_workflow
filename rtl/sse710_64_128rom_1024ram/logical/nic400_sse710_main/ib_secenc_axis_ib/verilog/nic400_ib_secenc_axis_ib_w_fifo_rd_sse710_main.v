...
module nic400_ib_secenc_axis_ib_w_fifo_rd_sse710_main
  (
  dst_valid,
  rpntr_gry,
  rpntr_bin,
...
`include "nic400_ib_secenc_axis_ib_w_fifo_fn_sse710_main.v"
  ...
  assign next_rpntr_gry = nic400_ib_secenc_axis_ib_w_fifo_next_gry_fn(rpntr_gry);
  ...
  assign rpntr_bin = nic400_ib_secenc_axis_ib_w_fifo_gry_to_bin_fn(rpntr_gry);

  assign empty = nic400_ib_secenc_axis_ib_w_fifo_empty_fn(wpntr_gry, rpntr_gry);
