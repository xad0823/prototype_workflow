...
module nic400_ib_secenc_axis_ib_b_fifo_wr_sse710_main
  (
   src_ready,
   dst_data,
...
`include "nic400_ib_secenc_axis_ib_b_fifo_fn_sse710_main.v"
   ...
   assign next_wpntr_gry = nic400_ib_secenc_axis_ib_b_fifo_next_gry_fn(wpntr_gry);

   assign wpntr_bin      = nic400_ib_secenc_axis_ib_b_fifo_gry_to_bin_fn(wpntr_gry);
   ...
   nic400_ib_secenc_axis_ib_b_fifo_wr_mux_sse710_main u_nic400_ib_secenc_axis_ib_b_fifo_wr_mux
   (
      .in_0  (fifo0),
      .in_1  (fifo1),
      .in_2  (fifo2),
   ...
   assign full = nic400_ib_secenc_axis_ib_b_fifo_full_fn(wpntr_gry, rpntr_gry);
