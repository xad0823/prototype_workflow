...
module nic400_apb_bridge_hcg_master_domain_sse710_main
(
    ...
    apb_async_cactive_wakeup,

    apb_async_port_enable,
  ...
  input               empty_apb_async;               


  output              apb_async_cactive;             


  output              apb_async_cactive_wakeup;      


  input               apb_async_port_enable;         
  ...
  assign clk_en = pclkenm & 
                  ((apbs_req_sync | (current_state_q == `APBAS_ST_ACK)) & apb_async_port_enable);
  ...
  assign apb_async_cactive = ~(current_state_q == `APBAS_ST_IDLE);
  ...
  assign apb_async_cactive_wakeup = empty_apb_async;
