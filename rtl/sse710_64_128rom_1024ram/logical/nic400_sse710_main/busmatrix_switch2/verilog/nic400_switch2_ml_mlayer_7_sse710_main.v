...
module nic400_switch2_ml_mlayer_7_sse710_main
  (
    awuser_m,
    awid_m,
    awaddr_m,
...
nic400_switch2_add_sel_ml7_sse710_main u_nic400_switch2_add_sel_ml7_sse710_main (
        .awuser_m       (awuser_m),
        .awid_m         (awid_m),
        .awaddr_m       (awaddr_m),
        .awlen_m        (awlen_m),
...
nic400_switch2_wr_sel_ml7_sse710_main u_nic400_switch2_wr_sel_ml7_sse710_main (
        .wdata_s0     (wdata_s0),
        .wstrb_s0     (wstrb_s0),
        .wlast_s0     (wlast_s0),
        .wvalid_s0    (wvalid_s0),
...
nic400_switch2_ret_sel_ml7_sse710_main u_nic400_switch2_ret_sel_ml7_sse710_main (
        .wr_cnt_empty (wr_cnt_empty),
        .buser_s0     (buser_s0),
        .bid_s0       (bid_s0),
        .bresp_s0     (bresp_s0),
 ...
 wire [5:0] rsel;
 wire [5:0] bsel;
 assign rsel = u_nic400_switch2_ret_sel_ml7_sse710_main.rsel;
 assign bsel = u_nic400_switch2_ret_sel_ml7_sse710_main.rsel;

      assert_zero_one_hot #(0,6,0,"ERROR, More than one read response destination")
         ovl_rsel_en7
           (
            .clk       (aclk),
            .reset_n   (aresetn),
      ...
      assert_zero_one_hot #(0,6,0,"ERROR, More than one buffered response destination")
         ovl_bsel_en7
           (
            .clk       (aclk),
            .reset_n   (aresetn),
