...
module nic400_switch2_ml_blayer_0_sse710_main
  (
  ...
  wire [7:0]           aw_enable;
  wire [7:0]           awready_s_int;
  wire [7:0]           wready_s_int;
  wire [7:0]           arready_s_int;
  wire [7:0]           awsel;
  wire [7:0]           arsel;
  wire [7:0]           tt_enable_wr;
  wire [7:0]           wr_enable;
  wire [7:0]           tt_enable_rd;
  wire [7:0]           buser_s_int;
  wire [7:0]           bvalid_s_int;
  wire [95:0]           bid_s_int;
  wire [15:0]           bresp_s_int;
  wire [7:0]           ruser_s_int;
  wire [7:0]           rvalid_s_int;
  wire [7:0]           rlast_s_int;
  wire [95:0]           rid_s_int;
  wire [511:0]           rdata_s_int;
  wire [15:0]           rresp_s_int;
  ...
  assign awvalid_vect_m7 = awvalid_vect_s[10] & aw_enable[7]; 
  ...
  assign arvalid_vect_m7 = arvalid_vect_s[10];
  ...
  assign awsel[7] = awvalid_s & awvalid_vect_s[10];
  assign arsel[7] = arvalid_s & arvalid_vect_s[10];

  nic400_switch2_wr_spi_tt_s0_sse710_main u_nic400_switch2_wr_spi_tt_16_8m_sse710_main (
        .aw_enable    (aw_enable),
  ...
  nic400_switch2_rd_spi_tt_s0_sse710_main u_nic400_switch2_rd_spi_tt_32_8m_sse710_main (
  ...
  assign buser_s_int[7] = buser_m7 & tt_enable_wr[7];
  assign bid_s_int[95:84] = bid_m7 & {12{tt_enable_wr[7]}};
  ...
  assign ruser_s_int[7] = ruser_m7 & tt_enable_rd[7];
  assign rid_s_int[95:84] = rid_m7 & {12{tt_enable_rd[7]}};
  assign rdata_s_int[511:448] = rdata_m7 & {64{tt_enable_rd[7]}};
