...
module nic400_switch2_ret_sel_ml4_sse710_main
  (
    wr_cnt_empty,
  ...
  reg [7:0]       iid_rsel;
   ...
   assign bvalid_masked = bvalid_m & ~wr_cnt_empty;
    ...
    assign buser_s6  = buser_m & {1{bsel[6]}};
    assign bid_s6  = bid_m & {12{bsel[6]}};
    assign bresp_s6  = bresp_m & {2{bsel[6]}};
    assign bvalid_s6  = bvalid_masked & bsel[6];
    ...
    assign ruser_s6 = ruser_m & {1{rsel[6]}};
    assign rid_s6 = rid_m & {12{rsel[6]}};
    assign rdata_s6 = rdata_m & {64{rsel[6]}};
    assign rresp_s6 = rresp_m & {2{rsel[6]}};
    assign rlast_s6 = rlast_m & rsel[6];
    assign rvalid_s6 = rvalid_m & rsel[6];
    ...
    assign bready_masked6 = bready_s6 & bsel[6];
    assign rready_masked6 = rready_s6 & rsel[6];

    assign bready_comb = bready_masked0 | bready_masked1 | bready_masked2 | bready_masked3 | bready_masked4 | bready_masked5 | bready_masked6;
    assign bready_m = bready_comb & ~wr_cnt_empty;
    assign rready_m = rready_masked0 | rready_masked1 | rready_masked2 | rready_masked3 | rready_masked4 | rready_masked5 | rready_masked6;
...
ovl_assert_illegal_rid
   (
    .clk       (nic400_switch2_sse710_main.aclk),
    .reset_n   (nic400_switch2_sse710_main.aresetn),
    .test_expr ((iid_rsel[7]) & p_r_ret_sel.i_rid_m > 7));
...
ovl_assert_illegal_bid
   (
    .clk       (nic400_switch2_sse710_main.aclk),
    .reset_n   (nic400_switch2_sse710_main.aresetn),
    .test_expr ((iid_bsel[7]) & p_b_ret_sel.i_bid_m > 7));
