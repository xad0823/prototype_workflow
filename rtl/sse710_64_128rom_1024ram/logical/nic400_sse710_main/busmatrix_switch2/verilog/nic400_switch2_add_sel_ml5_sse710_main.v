...
module nic400_switch2_add_sel_ml5_sse710_main
  (
    awuser_m,
    awid_m,
    awaddr_m,
  ...
  wire   [6:0]      aw_valid_vector;
  wire   [6:0]      ar_valid_vector;
  wire   [6:0]      aw_sel_i;
  wire   [6:0]      ar_sel_i;
  wire              last_rd;
  ...
  wire   [3:0]      arvalid_vect_masked5;

  wire   [9:0]      awuser_masked6;
  wire   [11:0]      awid_masked6;
  wire   [39:0]     awaddr_masked6;
  wire   [7:0]      awlen_masked6;
  wire   [2:0]      awsize_masked6;
  wire   [1:0]      awburst_masked6;
  wire              awlock_masked6;
  wire   [3:0]      awcache_masked6;
  wire   [2:0]      awprot_masked6;
  wire   [3:0]      aw_qv_masked6;
  wire              awvalid_masked6;
  wire   [3:0]      awvalid_vect_masked6;
  wire   [9:0]      aruser_masked6;
  wire   [11:0]      arid_masked6;
  wire   [39:0]     araddr_masked6;
  wire   [7:0]      arlen_masked6;
  wire   [2:0]      arsize_masked6;
  wire   [1:0]      arburst_masked6;
  wire              arlock_masked6;
  wire   [3:0]      arcache_masked6;
  wire   [2:0]      arprot_masked6;
  wire   [3:0]      ar_qv_masked6;
  wire              arvalid_masked6;
  wire   [3:0]      arvalid_vect_masked6;
  ...
  wire              arvalid_s5_i;
  wire   [3:0]      arvalid_vect_s5_i;
  wire              arready_s5_i;
  wire   [3:0]      ar_qv_s5_i;
  

  wire   [9:0]      awuser_s6_i;
  wire   [11:0]      awid_s6_i;
  wire   [39:0]     awaddr_s6_i;
  wire   [7:0]      awlen_s6_i;
  wire   [2:0]      awsize_s6_i;
  wire   [1:0]      awburst_s6_i;
  wire              awlock_s6_i;
  wire   [3:0]      awcache_s6_i;
  wire   [2:0]      awprot_s6_i;
  wire              awvalid_s6_i;
  wire   [3:0]      awvalid_vect_s6_i;
  wire              awready_s6_i;
  wire   [3:0]      aw_qv_s6_i;
  
  wire   [9:0]      aruser_s6_i;
  wire   [11:0]      arid_s6_i;
  wire   [39:0]     araddr_s6_i;
  wire   [7:0]      arlen_s6_i;
  wire   [2:0]      arsize_s6_i;
  wire   [1:0]      arburst_s6_i;
  wire              arlock_s6_i;
  wire   [3:0]      arcache_s6_i;
  wire   [2:0]      arprot_s6_i;
  wire              arvalid_s6_i;
  wire   [3:0]      arvalid_vect_s6_i;
  wire              arready_s6_i;
  wire   [3:0]      ar_qv_s6_i;
  ...
  assign awuser_s6_i = awuser_s6;
  assign awid_s6_i = awid_s6;
  assign awaddr_s6_i = awaddr_s6;
  assign awlen_s6_i = awlen_s6;
  assign awsize_s6_i = awsize_s6;
  assign awburst_s6_i = awburst_s6;
  assign awlock_s6_i = awlock_s6;
  assign awcache_s6_i = awcache_s6;
  assign awprot_s6_i = awprot_s6;
  assign awvalid_s6_i = awvalid_s6;
  assign awvalid_vect_s6_i = awvalid_vect_s6;
  assign aw_qv_s6_i = aw_qv_s6;
  assign awready_s6 = awready_s6_i;
   
  assign aruser_s6_i = aruser_s6;
  assign arid_s6_i = arid_s6;
  assign araddr_s6_i = araddr_s6;
  assign arlen_s6_i = arlen_s6;
  assign arsize_s6_i = arsize_s6;
  assign arburst_s6_i = arburst_s6;
  assign arlock_s6_i = arlock_s6;
  assign arcache_s6_i = arcache_s6;
  assign arprot_s6_i = arprot_s6;
  assign arvalid_s6_i = arvalid_s6;
  assign arvalid_vect_s6_i = arvalid_vect_s6;
  assign ar_qv_s6_i = ar_qv_s6;
  assign arready_s6 = arready_s6_i;



nic400_switch2_maskcntl_ml5_sse710_main u_nic400_switch2_maskcntl_ml5_sse710_main (
   ...
   assign aw_valid_vector[6] = awvalid_s6_i;
   ...
   assign ar_valid_vector[6] = arvalid_s6_i;

nic400_switch2_add_arb_ml5_sse710_main u_nic400_switch2_aw_arb_ml5_sse710_main (
        .a_sel          (aw_sel_i),
...
nic400_switch2_add_arb_ml5_sse710_main u_nic400_switch2_ar_arb_ml5_sse710_main (
        .a_sel          (ar_sel_i),
    ...
    assign awvalid_vect_masked0 = awvalid_vect_s0_i & {4{aw_sel_i[0]}};
    ...
    assign arvalid_vect_masked0 = arvalid_vect_s0_i & {4{ar_sel_i[0]}};
    ...
    assign awvalid_vect_masked1 = awvalid_vect_s1_i & {4{aw_sel_i[1]}};
    ...
    assign arvalid_vect_masked1 = arvalid_vect_s1_i & {4{ar_sel_i[1]}};
    ...
    assign awvalid_vect_masked2 = awvalid_vect_s2_i & {4{aw_sel_i[2]}};
    ...
    assign arvalid_vect_masked2 = arvalid_vect_s2_i & {4{ar_sel_i[2]}};
    ...
    assign awvalid_vect_masked3 = awvalid_vect_s3_i & {4{aw_sel_i[3]}};
    ...
    assign arvalid_vect_masked3 = arvalid_vect_s3_i & {4{ar_sel_i[3]}};
    ...
    assign awvalid_vect_masked4 = awvalid_vect_s4_i & {4{aw_sel_i[4]}};
    ...
    assign arvalid_vect_masked4 = arvalid_vect_s4_i & {4{ar_sel_i[4]}};
    ...
    assign awvalid_vect_masked5 = awvalid_vect_s5_i & {4{aw_sel_i[5]}};
    ...
    assign arvalid_vect_masked5 = arvalid_vect_s5_i & {4{ar_sel_i[5]}};

    assign awuser_masked6  = awuser_s6_i & {10{aw_sel_i[6]}}; 
    assign awid_masked6    = awid_s6_i & {12{aw_sel_i[6]}};
    assign awaddr_masked6  = awaddr_s6_i & {40{aw_sel_i[6]}};
    assign awlen_masked6   = awlen_s6_i & {8{aw_sel_i[6]}};
    assign awsize_masked6  = awsize_s6_i & {3{aw_sel_i[6]}};
    assign awburst_masked6 = awburst_s6_i & {2{aw_sel_i[6]}};
    assign awlock_masked6  = awlock_s6_i & {1{aw_sel_i[6]}};
    assign awcache_masked6 = awcache_s6_i & {4{aw_sel_i[6]}};
    assign awprot_masked6  = awprot_s6_i & {3{aw_sel_i[6]}};
    assign aw_qv_masked6   = aw_qv_s6_i & {4{aw_sel_i[6]}};
    assign awvalid_masked6 = awvalid_s6_i & aw_sel_i[6];
    assign awvalid_vect_masked6 = awvalid_vect_s6_i & {4{aw_sel_i[6]}};
  
    assign aruser_masked6  = aruser_s6_i & {10{ar_sel_i[6]}};
    assign arid_masked6   = arid_s6_i & {12{ar_sel_i[6]}};
    assign araddr_masked6  = araddr_s6_i & {40{ar_sel_i[6]}};
    assign arlen_masked6   = arlen_s6_i & {8{ar_sel_i[6]}};
    assign arsize_masked6  = arsize_s6_i & {3{ar_sel_i[6]}};
    assign arburst_masked6 = arburst_s6_i & {2{ar_sel_i[6]}};
    assign arlock_masked6  = arlock_s6_i & {1{ar_sel_i[6]}};
    assign arcache_masked6 = arcache_s6_i & {4{ar_sel_i[6]}};
    assign arprot_masked6  = arprot_s6_i & {3{ar_sel_i[6]}};
    assign ar_qv_masked6   = ar_qv_s6_i & {4{ar_sel_i[6]}};
    assign arvalid_masked6 = arvalid_s6_i & ar_sel_i[6];
    assign arvalid_vect_masked6 = arvalid_vect_s6_i & {4{ar_sel_i[6]}};
    ...
    assign awready_s6_i     = awready_m_i & aw_sel_i[6];
    assign arready_s6_i     = arready_m_i & ar_sel_i[6];
