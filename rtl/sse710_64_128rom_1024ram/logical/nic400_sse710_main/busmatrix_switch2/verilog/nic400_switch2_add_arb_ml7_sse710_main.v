...
module nic400_switch2_add_arb_ml7_sse710_main
  (
    a_sel,
    a_valid_vector,
    aready,
  ...
  parameter REQUESTS      = 6;
  parameter QOS_WIDTH     = 4;


  output [5:0]      a_sel;
  input  [5:0]      a_valid_vector;
  input             aready;
  input  [5:0]      mask;
  input  [3:0]      qv0;
  input  [3:0]      qv1;
...
`ifdef ARM_ASSERT_ON
   ...
   assert_zero_one_hot #(0,6,0,"ERROR, More than one slave interface arbitrated")
     ovl_slave_if_arb
       (
        .clk       (aclk),
        .reset_n   (aresetn),
