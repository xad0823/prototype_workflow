...
module nic400_switch2_rd_spi_tt_s0_sse710_main
  (
    tt_enable,
    resp_valid,
    resp_last,
  ...
  reg   [2:0]    ptr7;     
   ...
   assign resp_valid_vector[7] = rvalid_m7;
...
`ifdef ARM_ASSERT_ON
   ...
   assert_always #(0,0,"ERROR, LRG item 7 is not unique")
      ovl_lrg_qv_list_unique7
       (
        .clk       (aclk),
        .reset_n   (aresetn),
        .test_expr (
