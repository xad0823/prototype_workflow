...
module nic400_ib_ib1_upsize_wr_addr_fmt_sse710_main
  (
    aresetn,
    aclk,
...
`include "Axi.v"
 ...
 assign awaddr_aligned = {awaddr_s[39:10],((awaddr_s[9:0]) & (~total_bytes))};
 ...
 always @(*)
  begin : total_bytes_p
    case (awsize_s)
       ...
       `AXI_ASIZE_256,
       `AXI_ASIZE_512,
       `AXI_ASIZE_1024 : total_bytes = {2'b0, awlen_s};    
 ...
 always @(*)
  begin : total_bytes_masked_p
    case (awsize_s)
       ...
       `AXI_ASIZE_256,
       `AXI_ASIZE_512,
       `AXI_ASIZE_1024 : total_bytes_masked = {2'b0, awlen_s};    
