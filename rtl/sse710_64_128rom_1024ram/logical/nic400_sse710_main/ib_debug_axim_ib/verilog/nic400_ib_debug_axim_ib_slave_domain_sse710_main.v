...
module nic400_ib_debug_axim_ib_slave_domain_sse710_main
  (
  ...
  wire                downsize;  
  wire  [74:0]        aw_fmt_src_data;
  wire  [74:0]        ar_fmt_src_data;
  wire  [74:0]        aw_fmt_dst_data;
  wire  [74:0]        ar_fmt_dst_data;
  ...
  nic400_ib_debug_axim_ib_downsize_wr_addr_fmt_sse710_main u_axi_write_address_format
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
...
nic400_ib_debug_axim_ib_downsize_wr_cntrl_sse710_main u_downsize_axi_write_control
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
  ...
  nic400_ib_debug_axim_ib_downsize_wr_merge_buffer_sse710_main u_downsize_axi_write_merge_buffer
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
  ...
  nic400_ib_debug_axim_ib_downsize_wr_resp_block_sse710_main u_downsize_axi_write_response_block
  (
  ...
  nic400_ib_debug_axim_ib_downsize_rd_addr_fmt_sse710_main u_axi_read_address_format
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
  ...
  nic400_ib_debug_axim_ib_downsize_rd_cntrl_sse710_main u_downsize_read_control
  (
     .aresetn                        (aresetn),
     .aclk                           (aclk),
  ...
  assign rvalid_axi4_s = r_slave_port_dst_valid;
  assign r_slave_port_dst_ready = rready_axi4_s;
  ...
  assign w_slave_port_src_valid = wvalid_axi4_s;
  assign wready_axi4_s = w_slave_port_src_ready;
  ...
  assign {
          bid_axi4_s,
          bresp_axi4_s,
          buser_axi4_s} = b_slave_port_dst_data;


  assign bvalid_axi4_s = b_slave_port_dst_valid;
  assign b_slave_port_dst_ready = bready_axi4_s;

  assign b_slave_port_src_valid = bvalid_axi_r;
  assign bready_axi_r = b_slave_port_src_ready;


  nic400_ib_debug_axim_ib_chan_slice_sse710_main
    #(
       `RS_REGD,  
       75  
     )
