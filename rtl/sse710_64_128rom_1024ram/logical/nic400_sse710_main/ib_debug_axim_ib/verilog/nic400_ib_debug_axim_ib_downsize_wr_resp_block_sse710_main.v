...
module nic400_ib_debug_axim_ib_downsize_wr_resp_block_sse710_main
  (
  bvalid_m,
  bready_s,
  bresp_m,
  ...
  input [15:0]            bchannel_data;
   ...
   always @(match_bus)
    ...
    assign bvalid_s = (bvalid_m && match);
     ...
     nic400_ib_debug_axim_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_0
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_debug_axim_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_1
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_debug_axim_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_2
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_debug_axim_ib_downsize_resp_cam_slice_sse710_main u_downsize_resp_cam_slice_3
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
