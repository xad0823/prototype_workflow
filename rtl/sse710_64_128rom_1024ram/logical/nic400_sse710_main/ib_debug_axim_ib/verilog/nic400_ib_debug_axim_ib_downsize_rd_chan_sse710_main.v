...
module nic400_ib_debug_axim_ib_downsize_rd_chan_sse710_main
  (
  rvalid_m,
  rdata_m,
  rlast_m,
...
`include "Axi.v"
  ...
  always @(archannel_data)
   ...
   assign pop_slice = update && rlast_out;
     ...
     nic400_ib_debug_axim_ib_downsize_rd_cam_slice_sse710_main u_downsize_rd_cam_slice_0
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_debug_axim_ib_downsize_rd_cam_slice_sse710_main u_downsize_rd_cam_slice_1
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_debug_axim_ib_downsize_rd_cam_slice_sse710_main u_downsize_rd_cam_slice_2
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_debug_axim_ib_downsize_rd_cam_slice_sse710_main u_downsize_rd_cam_slice_3
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
