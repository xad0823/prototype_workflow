...
module nic400_ib_debug_axim_ib_downsize_rd_cam_slice_sse710_main
  (
    aresetn,
    aclk,
...
`include "std_ovl_defines.h"
  ...
  (
    ...
    .reset_n    (aresetn),
    .qualifier  (valid_reg),
    .test_expr  (rdata_buffer_enables & {7{nic400_ib_debug_axim_ib_downsize_rd_chan_sse710_main.rvalid_m}})
  );
`endif
