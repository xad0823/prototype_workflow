...
module nic400_asib_extsys1_axis_rd_spi_cdas_sse710_main
  (
    ar_enable,
    asel,
    avalid,
  ...
  wire  [17:0]    mask;   
  wire  [17:0]    id_match;    
  wire  [17:0]    dest_match;    
  wire  [17:0]    resp_match;    
  wire           cds_stall;    
  ...
  reg   [4:0]    tt_cnt;    
  reg   [9:0]    spi_asel [17:0];     
  reg   [7:0]    spi_ids [17:0];     
  reg   [17:0]    spi_valid;     
  reg   [9:0]    hold_asel;     
  reg            hold_valid;     
  reg   [7:0]    hold_aid;     
  ...
  wire           next_full;     
   ...
   assign next_full = (next_tt_cnt == 5'd18) ? 1'b1 : 1'b0;
   ...
   assign  mask[17:16] = {2{|(free_slot0|free_slot1|free_slot2|free_slot3)}}; 
   ...
   assign  resp_mask[17:16] = {2{|(resp_sel0|resp_sel1|resp_sel2|resp_sel3)}}; 
   ...
   always @(posedge aclk or negedge aresetn)
    ...
    begin : p_ptr_seq
      ...
      begin
       if (t_push)
         begin
             for (tt_ptr_val = 0; tt_ptr_val<18; tt_ptr_val=tt_ptr_val+1)
   ...
   always @(posedge aclk)
    begin : p_tt_dat_seq
         ...
         if (t_push)
          begin
                for (tt_ptr = 0; tt_ptr<18; tt_ptr=tt_ptr+1)
