...
`include "nic400_asib_gpvmain_ahb_ahb_defs_sse710_main.v"
`include "Axi.v"
`include "AhbDefns.v"

module nic400_asib_gpvmain_ahb_ahb_sse710_main
(
  aclk,
  aresetn,
  ...
  assign cactive = (|htrans_current) | (|htrans_new);
...
`include "nic400_asib_gpvmain_ahb_ahb_undefs_sse710_main.v"
