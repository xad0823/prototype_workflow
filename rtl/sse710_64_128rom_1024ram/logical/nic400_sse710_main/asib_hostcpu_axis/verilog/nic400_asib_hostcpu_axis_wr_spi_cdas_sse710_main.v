...
module nic400_asib_hostcpu_axis_wr_spi_cdas_sse710_main
  (
    aw_enable,
    wr_enable,
    asel,
  ...
  wire  [32:0]    mask;   
  wire  [32:0]    id_match;   
  wire  [32:0]    dest_match;   
  wire  [32:0]    resp_match;   
  wire           cds_stall;    
  wire           t_push;     
  ...
  reg            aready_reg;   
  reg   [5:0]    tt_cnt;   
  reg   [10:0]    spi_asel [32:0];   
  reg   [7:0]    spi_ids [32:0];   
  reg   [32:0]    spi_valid;   
  reg   [10:0]    hold_asel;   
  reg   [7:0]    hold_aid;   
  reg            hold_valid;   
  reg            t_ready;   
   ...
   assign  mask[32] = {1{|(free_slot0|free_slot1|free_slot2|free_slot3|free_slot4|free_slot5|free_slot6|free_slot7)}}; 

   assign free_slot = {free_slot8,
                       free_slot7,
                       free_slot6,
                       free_slot5,
                       free_slot4,
   ...
   assign resp_sel8 =  resp_match[32];
   ...
   assign  resp_mask[32] = {1{|(resp_sel0|resp_sel1|resp_sel2|resp_sel3|resp_sel4|resp_sel5|resp_sel6|resp_sel7)}}; 

   assign resp_sel = {resp_sel8,
                       resp_sel7,
                       resp_sel6,
                       resp_sel5,
                       resp_sel4,
   ...
   assign hold_resp_match = (hold_aid == resp_id[7:0]) & (~|resp_sel)
   ...
   always @(posedge aclk or negedge aresetn)
    ...
    begin : p_ptr_seq
      ...
      begin
        if (t_push)
         begin
             for (tt_ptr_val = 0; tt_ptr_val<33; tt_ptr_val=tt_ptr_val+1)
   ...
   always @(posedge aclk)
    begin : p_tt_dat_seq
         ...
         if (t_push)
          begin
                for (tt_ptr = 0; tt_ptr<33; tt_ptr=tt_ptr+1)
