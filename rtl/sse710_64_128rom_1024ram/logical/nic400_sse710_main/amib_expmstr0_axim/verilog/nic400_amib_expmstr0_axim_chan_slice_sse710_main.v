...
module nic400_amib_expmstr0_axim_chan_slice_sse710_main
  (
   aresetn,
   aclk,
...
`endif
  ...
  nic400_ful_regd_slice_sse710_main #(PAYLD_WIDTH) u_ful_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_fwd_regd_slice_sse710_main #(PAYLD_WIDTH) u_fwd_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_rev_regd_slice_sse710_main #(PAYLD_WIDTH) u_rev_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
