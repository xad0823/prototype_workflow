...
module nic400_ib_debug_axis_ib_w_fifo_wr_sse710_main
  (
   src_ready,
   dst_data,
...
`include "nic400_ib_debug_axis_ib_w_fifo_fn_sse710_main.v"
   ...
   nic400_ib_debug_axis_ib_w_fifo_wr_mux_sse710_main u_nic400_ib_debug_axis_ib_w_fifo_wr_mux
   (
      .in_0  (fifo0),
      .in_1  (fifo1),
      .in_2  (fifo2),
