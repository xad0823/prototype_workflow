...
module nic400_ib_expslv0_axis_ib_slave_domain_sse710_main
  (
  ...
  wire [84:0]         aw_boundary_src_data;     
  wire [84:0]         aw_boundary_dst_data;     
  ...
  wire [84:0]         ar_boundary_src_data;     
  wire [84:0]         ar_boundary_dst_data;     
  ...
  nic400_ib_expslv0_axis_ib_aw_fifo_wr_sse710_main
  u_aw_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_expslv0_axis_ib_ar_fifo_wr_sse710_main
  u_ar_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_expslv0_axis_ib_r_fifo_rd_sse710_main
  u_r_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_expslv0_axis_ib_w_fifo_wr_sse710_main
  u_w_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_expslv0_axis_ib_b_fifo_rd_sse710_main
  u_b_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
