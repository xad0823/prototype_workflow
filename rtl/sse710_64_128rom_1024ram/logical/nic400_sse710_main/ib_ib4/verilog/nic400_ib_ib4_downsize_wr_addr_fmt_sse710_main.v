...
module nic400_ib_ib4_downsize_wr_addr_fmt_sse710_main
  (
    aresetn,
    aclk,
...
`include "Axi.v"
 ...
 assign awaddr_aligned = {awaddr_s[39:11],((awaddr_s[10:0]) & (~total_bytes))};
 ...
 always @(posedge aclk or negedge aresetn)
  ...
  assign awaddr_boundary = ({awaddr_aligned[39:12],boundary_incr,awaddr_aligned[5:0]});
