...
module nic400_ib_ib4_downsize_rd_cam_slice_sse710_main
  (
    aresetn,
    aclk,
...
`include "Axi.v"
 ...
 assign hazard_id     = ar_cam_data[18:7];
...
`include "std_ovl_defines.h"
  ...
  (
    ...
    .reset_n    (aresetn),
    .qualifier  (valid_reg),
    .test_expr  (rdata_buffer_enables & {7{nic400_ib_ib4_downsize_rd_chan_sse710_main.rvalid_m}})
  );
`endif
