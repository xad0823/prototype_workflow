...
`include "nic400_asib_secenc_axis_defs_sse710_main.v"

module nic400_asib_secenc_axis_sse710_main
 (
  

    awid_secenc_axis_s,
    awaddr_secenc_axis_s,
    awlen_secenc_axis_s,
    awsize_secenc_axis_s,
    awburst_secenc_axis_s,
    awlock_secenc_axis_s,
    awcache_secenc_axis_s,
    awprot_secenc_axis_s,
    awvalid_secenc_axis_s,
    awready_secenc_axis_s,

    wdata_secenc_axis_s,
    wstrb_secenc_axis_s,
    wlast_secenc_axis_s,
    wvalid_secenc_axis_s,
    wready_secenc_axis_s,

    bid_secenc_axis_s,
    bresp_secenc_axis_s,
    bvalid_secenc_axis_s,
    bready_secenc_axis_s,

    arid_secenc_axis_s,
    araddr_secenc_axis_s,
    arlen_secenc_axis_s,
    arsize_secenc_axis_s,
    arburst_secenc_axis_s,
    arlock_secenc_axis_s,
    arcache_secenc_axis_s,
    arprot_secenc_axis_s,
    arvalid_secenc_axis_s,
    arready_secenc_axis_s,

    rid_secenc_axis_s,
    rdata_secenc_axis_s,
    rresp_secenc_axis_s,
    rlast_secenc_axis_s,
    rvalid_secenc_axis_s,
    rready_secenc_axis_s,

    awuser_secenc_axis_s,
    buser_secenc_axis_s,
    aruser_secenc_axis_s,
    ruser_secenc_axis_s,
  ...
  input   [7:0]       awid_secenc_axis_s;              
  input   [39:0]      awaddr_secenc_axis_s;            
  input   [7:0]       awlen_secenc_axis_s;             
  input   [2:0]       awsize_secenc_axis_s;            
  input   [1:0]       awburst_secenc_axis_s;           
  input               awlock_secenc_axis_s;            
  input   [3:0]       awcache_secenc_axis_s;           
  input   [2:0]       awprot_secenc_axis_s;            
  input               awvalid_secenc_axis_s;           
  output              awready_secenc_axis_s;           

  input   [31:0]      wdata_secenc_axis_s;             
  input   [3:0]       wstrb_secenc_axis_s;             
  input               wlast_secenc_axis_s;             
  input               wvalid_secenc_axis_s;            
  output              wready_secenc_axis_s;            

  output  [7:0]       bid_secenc_axis_s;               
  output  [1:0]       bresp_secenc_axis_s;             
  output              bvalid_secenc_axis_s;            
  input               bready_secenc_axis_s;            

  input   [7:0]       arid_secenc_axis_s;              
  input   [39:0]      araddr_secenc_axis_s;            
  input   [7:0]       arlen_secenc_axis_s;             
  input   [2:0]       arsize_secenc_axis_s;            
  input   [1:0]       arburst_secenc_axis_s;           
  input               arlock_secenc_axis_s;            
  input   [3:0]       arcache_secenc_axis_s;           
  input   [2:0]       arprot_secenc_axis_s;            
  input               arvalid_secenc_axis_s;           
  output              arready_secenc_axis_s;           

  output  [7:0]       rid_secenc_axis_s;               
  output  [31:0]      rdata_secenc_axis_s;             
  output  [1:0]       rresp_secenc_axis_s;             
  output              rlast_secenc_axis_s;             
  output              rvalid_secenc_axis_s;            
  input               rready_secenc_axis_s;            

  input   [9:0]       awuser_secenc_axis_s;            
  output              buser_secenc_axis_s;             
  input   [9:0]       aruser_secenc_axis_s;            
  output              ruser_secenc_axis_s;             



  output  [7:0]       awid_secenc_axis_m;              
  output  [39:0]      awaddr_secenc_axis_m;            
  ...
  output  [10:0]      awvalid_vect_secenc_axis_m;      
  ...
  input   [7:0]       bid_secenc_axis_m;               
  input   [1:0]       bresp_secenc_axis_m;             
  input               bvalid_secenc_axis_m;            
  output              bready_secenc_axis_m;            

  output  [7:0]       arid_secenc_axis_m;              
  output  [39:0]      araddr_secenc_axis_m;            
  ...
  output  [10:0]      arvalid_vect_secenc_axis_m;      
  input               arready_secenc_axis_m;           

  input   [7:0]       rid_secenc_axis_m;               
  ...
  output  [9:0]       awuser_secenc_axis_m;            
  input               buser_secenc_axis_m;             
  output  [9:0]       aruser_secenc_axis_m;            
  input               ruser_secenc_axis_m;             
  ...
  output              secenc_axis_cactive;             


  output              secenc_axis_cactive_wakeup;      


  input               secenc_axis_port_enable;         
  ...
  wire                secenc_axis_ar_enable;
  wire                secenc_axis_aw_enable;
  wire                secenc_axis_w_enable;
  ...
  wire                security56;
  wire                security54;
  wire [10:0]         awvalid_vect_secenc_axis_m;            
  wire [10:0]         arvalid_vect_secenc_axis_m;            
  ...
  assign secenc_axis_ot = (tracker_busy | ar_slave_port_dst_valid | aw_slave_port_dst_valid | w_slave_port_dst_valid | leading_write | cactive_wakeup_reg);


  assign secenc_axis_cactive_wakeup = awvalid_secenc_axis_s | arvalid_secenc_axis_s | wvalid_secenc_axis_s;

  always @(posedge aclk or negedge aresetn)
    begin : p_cactive_wakeup_seq
      if (!aresetn)
        cactive_wakeup_reg <= 1'b0;
      else if (secenc_axis_port_enable)
        cactive_wakeup_reg <= secenc_axis_cactive_wakeup;
    end


  assign secenc_axis_cactive = secenc_axis_ot;
  assign secenc_axis_ar_enable = secenc_axis_port_enable;
  assign secenc_axis_aw_enable = secenc_axis_port_enable;
  assign secenc_axis_w_enable  = secenc_axis_port_enable;
  ...
  nic400_asib_secenc_axis_decode_sse710_main u_aw_add_decode
  (
    .addr_s                 (awaddr_int_s),
...
nic400_asib_secenc_axis_wr_spi_cdas_sse710_main u_asib_secenc_axis_wr_spi_cdas
  (
  ...
  nic400_asib_secenc_axis_decode_sse710_main u_ar_add_decode
  (
    .addr_s                 (araddr_int_s),
    .security63               (security63),
    .security62               (security62),
...
nic400_asib_secenc_axis_rd_spi_cdas_sse710_main u_asib_secenc_axis_rd_spi_cdas
  (
  ...
  nic400_asib_secenc_axis_maskcntl_sse710_main u_asib_secenc_axis_maskcntl (
  ...
  assign aw_slave_port_src_data = {awid_secenc_axis_s,
          awaddr_secenc_axis_s,
          awlen_secenc_axis_s,
          awsize_secenc_axis_s,
          awburst_secenc_axis_s,
  ...
  assign aw_slave_port_src_valid = awvalid_secenc_axis_s & secenc_axis_aw_enable;
  assign awready_secenc_axis_s = aw_slave_port_src_ready & secenc_axis_aw_enable;


  assign ar_slave_port_src_data = {arid_secenc_axis_s,
          araddr_secenc_axis_s,
          arlen_secenc_axis_s,
          arsize_secenc_axis_s,
          arburst_secenc_axis_s,
  ...
  assign ar_slave_port_src_valid = arvalid_secenc_axis_s & secenc_axis_ar_enable;
  assign arready_secenc_axis_s = ar_slave_port_src_ready & secenc_axis_ar_enable;


  assign w_slave_port_src_data = {wdata_secenc_axis_s,
          wstrb_secenc_axis_s,
          wlast_secenc_axis_s};
  ...
  assign w_slave_port_src_valid = wvalid_secenc_axis_s & secenc_axis_w_enable;
  assign wready_secenc_axis_s = w_slave_port_src_ready & secenc_axis_w_enable;
  ...
  assign {rid_secenc_axis_s,
          rdata_secenc_axis_s,
          rresp_secenc_axis_s,
          ruser_secenc_axis_s,
          rlast_secenc_axis_s} = r_slave_port_dst_data;


  assign r_slave_port_dst_data = r_slave_port_src_data;

  assign rvalid_secenc_axis_s = rvalid_secenc_axis_m;
  assign rready_secenc_axis_m = rready_secenc_axis_s;
  ...
  assign {bid_secenc_axis_s,
          bresp_secenc_axis_s,
          buser_secenc_axis_s} = b_slave_port_dst_data;


  assign b_slave_port_dst_data = b_slave_port_src_data;

  assign bvalid_secenc_axis_s = bvalid_secenc_axis_m;
  assign bready_secenc_axis_m = bready_secenc_axis_s;



  nic400_asib_secenc_axis_chan_slice_sse710_main
    #(
       `RS_REV_REG,  
       79  
     )
  ...
  assert_zero_one_hot
    #(`OVL_FATAL, 11, `OVL_ASSERT,
      ...
      (
        .clk (aclk),
        .reset_n (aresetn),
        .test_expr ( {11{arvalid_int_m}} & arvalid_vect_secenc_axis_m )
      );
  assert_never
  ...
  assert_zero_one_hot
    #(`OVL_FATAL, 11, `OVL_ASSERT,
      ...
      (
        .clk (aclk),
        .reset_n (aresetn),
        .test_expr ( {11{awvalid_int_m}} & awvalid_vect_secenc_axis_m )
      );
  assert_never
    #(`OVL_FATAL, `OVL_ASSERT,
...
`include "nic400_asib_secenc_axis_undefs_sse710_main.v"
