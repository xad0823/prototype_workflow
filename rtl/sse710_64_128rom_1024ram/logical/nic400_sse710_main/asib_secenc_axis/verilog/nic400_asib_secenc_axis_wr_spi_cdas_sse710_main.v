...
module nic400_asib_secenc_axis_wr_spi_cdas_sse710_main
  (
    aw_enable,
    wr_enable,
    asel,
  ...
  wire  [12:0]    mask;   
  wire  [12:0]    id_match;   
  wire  [12:0]    dest_match;   
  wire  [12:0]    resp_match;   
  wire           cds_stall;    
  wire           t_push;     
  ...
  reg            aready_reg;   
  reg   [3:0]    tt_cnt;   
  reg   [10:0]    spi_asel [12:0];   
  reg   [7:0]    spi_ids [12:0];   
  reg   [12:0]    spi_valid;   
  reg   [10:0]    hold_asel;   
  reg   [7:0]    hold_aid;   
  reg            hold_valid;   
  reg            t_ready;   
   ...
   assign free_slot3 =  slots[12];

   assign  mask[3:0] = {4{1'b0}}; 
   assign  mask[7:4] = {4{|(free_slot0)}}; 
   assign  mask[11:8] = {4{|(free_slot0|free_slot1)}}; 
   assign  mask[12] = {1{|(free_slot0|free_slot1|free_slot2)}}; 

   assign free_slot = {free_slot3,
                       free_slot2,
                       free_slot1,
                       free_slot0} & ~mask;
   ...
   assign resp_sel3 =  resp_match[12];

   assign  resp_mask[3:0] = {4{1'b0}}; 
   assign  resp_mask[7:4] = {4{|(resp_sel0)}}; 
   assign  resp_mask[11:8] = {4{|(resp_sel0|resp_sel1)}}; 
   assign  resp_mask[12] = {1{|(resp_sel0|resp_sel1|resp_sel2)}}; 

   assign resp_sel = {resp_sel3,
                       resp_sel2,
                       resp_sel1,
                       resp_sel0} & ~resp_mask;
   ...
   always @(posedge aclk or negedge aresetn)
    ...
    begin : p_ptr_seq
      ...
      begin
        if (t_push)
         begin
             for (tt_ptr_val = 0; tt_ptr_val<13; tt_ptr_val=tt_ptr_val+1)
   ...
   always @(posedge aclk)
    begin : p_tt_dat_seq
         ...
         if (t_push)
          begin
                for (tt_ptr = 0; tt_ptr<13; tt_ptr=tt_ptr+1)
