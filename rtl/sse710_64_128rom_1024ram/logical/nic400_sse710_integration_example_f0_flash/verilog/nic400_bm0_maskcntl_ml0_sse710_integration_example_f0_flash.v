...
module nic400_bm0_maskcntl_ml0_sse710_integration_example_f0_flash
  (
    last_slot,
    awvalid_m,
    awready_m,
   ...
   always @(push_wr or push_rd or pop_wr or pop_rd or comb_cnt)
     begin : p_next_comb
      case({push_wr, push_rd, pop_wr, pop_rd})
        ...
        4'b0010,
        4'b0111,
        4'b1011  : next_comb_cnt = (comb_cnt - 2'b01);
        4'b0011  : next_comb_cnt = (comb_cnt - 2'b10);
        4'b0100,
        4'b1000,
        4'b1101,
        4'b1110  : next_comb_cnt = (comb_cnt + 2'b01);
        4'b1100  : next_comb_cnt = (comb_cnt + 2'b10);
        default  : next_comb_cnt = comb_cnt;
      endcase
     end 

  assign next_last_slot = ((next_comb_cnt == 2'd1)
                           && (next_wr_cnt != 2'b10)
                           && (next_rd_cnt != 2'b10));
  ...
  always @(next_wr_cnt or next_rd_cnt or next_comb_cnt) 
   begin : p_mask_comb
     next_mask_w = {1{1'b0}};
     next_mask_r = {1{1'b0}};
     if (next_wr_cnt == 2'b10 || next_comb_cnt == 2'b10)
        next_mask_w = {1{1'b1}};
     if (next_rd_cnt ==  2'b10 || next_comb_cnt == 2'b10)
        next_mask_r = {1{1'b1}};
  end 
