...
module nic400_ib_xnvm_axi_m_ib_upsize_wr_resp_block_sse710_integration_example_f0_flash
  (
  bvalid_m,
  bready_s,
  bresp_m,
  ...
  input [12:0]            bchannel_data;
   ...
   always @(match_bus)
    ...
    assign bvalid_s = (bvalid_m && match);
     ...
     nic400_ib_xnvm_axi_m_ib_upsize_resp_cam_slice_sse710_integration_example_f0_flash u_upsize_resp_cam_slice_0
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_xnvm_axi_m_ib_upsize_resp_cam_slice_sse710_integration_example_f0_flash u_upsize_resp_cam_slice_1
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_xnvm_axi_m_ib_upsize_resp_cam_slice_sse710_integration_example_f0_flash u_upsize_resp_cam_slice_2
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_xnvm_axi_m_ib_upsize_resp_cam_slice_sse710_integration_example_f0_flash u_upsize_resp_cam_slice_3
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
