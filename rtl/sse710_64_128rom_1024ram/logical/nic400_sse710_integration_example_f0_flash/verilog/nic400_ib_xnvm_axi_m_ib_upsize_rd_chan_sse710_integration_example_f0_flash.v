...
module nic400_ib_xnvm_axi_m_ib_upsize_rd_chan_sse710_integration_example_f0_flash
  (
  rvalid_s,
  rdata_s,
  rlast_s,
...
`include "nic400_ib_xnvm_axi_m_ib_defs_sse710_integration_example_f0_flash.v"
  ...
  output                    rlast_s;
   ...
   wire [7:0]               rdata_byte_mask0;
   wire [7:0]               rdata_byte_mask1;
   wire [7:0]               rdata_byte_mask2;
   wire [7:0]               rdata_byte_mask3;
   wire [7:0]               rdata_byte_mask;

   wire [63:0]              rdata_beat_mask;

   wire [63:0]              rdata_s;


   reg [63:0]               rdata_s_demux;
   ...
   assign rdata_beat_mask = {{8{rdata_byte_mask[7]}},
                             {8{rdata_byte_mask[6]}},
                             {8{rdata_byte_mask[5]}},
                             {8{rdata_byte_mask[4]}},
                             {8{rdata_byte_mask[3]}},
   ...
   always @(data_select or rdata)
     begin : rdata_demux
     case (data_select)
         1'd0 : rdata_s_demux = rdata[63:0];
         1'd1 : rdata_s_demux = rdata[127:64];
         default : rdata_s_demux = 64'bx;
        endcase
     end 
   ...
   assign pop_slice = update && rlast_s_i;
     ...
     nic400_ib_xnvm_axi_m_ib_upsize_rd_cam_slice_sse710_integration_example_f0_flash u_upsize_rd_cam_slice_0
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_xnvm_axi_m_ib_upsize_rd_cam_slice_sse710_integration_example_f0_flash u_upsize_rd_cam_slice_1
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_xnvm_axi_m_ib_upsize_rd_cam_slice_sse710_integration_example_f0_flash u_upsize_rd_cam_slice_2
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_xnvm_axi_m_ib_upsize_rd_cam_slice_sse710_integration_example_f0_flash u_upsize_rd_cam_slice_3
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
