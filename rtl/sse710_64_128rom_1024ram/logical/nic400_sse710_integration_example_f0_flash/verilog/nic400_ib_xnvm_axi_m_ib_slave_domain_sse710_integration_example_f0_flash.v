...
module nic400_ib_xnvm_axi_m_ib_slave_domain_sse710_integration_example_f0_flash
  (
  ...
  wire                arfifo_valid;
  wire                arfifo_ready;  
  wire  [64:0]        aw_fmt_src_data;
  wire  [64:0]        ar_fmt_src_data;
  wire  [64:0]        aw_fmt_dst_data;
  wire  [64:0]        ar_fmt_dst_data;
  ...
  nic400_ib_xnvm_axi_m_ib_upsize_wr_addr_fmt_sse710_integration_example_f0_flash u_axi_write_address_format
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
...
nic400_ib_xnvm_axi_m_ib_upsize_wr_cntrl_sse710_integration_example_f0_flash u_upsize_axi_write_control
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
  ...
  nic400_ib_xnvm_axi_m_ib_upsize_wr_merge_buffer_sse710_integration_example_f0_flash u_upsize_axi_write_merge_buffer
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
  ...
  nic400_ib_xnvm_axi_m_ib_upsize_wr_resp_block_sse710_integration_example_f0_flash u_upsize_axi_write_response_block
  (
  ...
  nic400_ib_xnvm_axi_m_ib_upsize_rd_addr_fmt_sse710_integration_example_f0_flash u_axi_read_address_format
  (
    .aresetn                          (aresetn),
    .aclk                             (aclk),
  ...
  nic400_ib_xnvm_axi_m_ib_upsize_rd_chan_sse710_integration_example_f0_flash u_upsize_axi_read_channel
  (
  ...
  nic400_ib_xnvm_axi_m_ib_chan_slice_sse710_integration_example_f0_flash
    #(
       `RS_REV_REG,  
       65  
     )
