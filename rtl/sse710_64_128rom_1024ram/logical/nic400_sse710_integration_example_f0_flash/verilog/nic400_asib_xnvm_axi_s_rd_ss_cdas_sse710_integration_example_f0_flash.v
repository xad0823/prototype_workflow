...
module nic400_asib_xnvm_axi_s_rd_ss_cdas_sse710_integration_example_f0_flash
  (
    ar_enable,
    asel,
    avalid,
  ...
  reg            empty;     
  reg   [1:0]    tt_reg;     
  reg   [1:0]    current_dest;     




   assign asel_mask = current_dest | {2{empty}};
   ...
   assign next_tt_reg = (|asel && aready) ? asel
                        : (tt_cnt == 3'b001 && dec_tt_cnt) ? {2{1'b0}}
                        : tt_reg;
