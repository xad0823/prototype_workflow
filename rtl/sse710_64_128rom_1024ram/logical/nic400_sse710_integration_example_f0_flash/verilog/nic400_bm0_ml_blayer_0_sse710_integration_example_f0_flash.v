...
module nic400_bm0_ml_blayer_0_sse710_integration_example_f0_flash
  (
  ...
  output  [127:0]    wdata_m0;
  output  [15:0]     wstrb_m0;
  output            wlast_m0;
  output            wvalid_m0;
  input             wready_m0;
  ...
  output  [127:0]    wdata_m1;
  output  [15:0]     wstrb_m1;
  output            wlast_m1;
  output            wvalid_m1;
  input             wready_m1;
  ...
  nic400_bm0_wr_ss_tt_s0_sse710_integration_example_f0_flash u_nic400_bm0_wr_ss_tt_2_2m_sse710_integration_example_f0_flash (
        .aw_enable    (aw_enable),
  ...
  nic400_bm0_rd_ss_tt_s0_sse710_integration_example_f0_flash u_nic400_bm0_rd_ss_tt_2_2m_sse710_integration_example_f0_flash (
        .ar_enable    (ar_enable),
  ...
  assign rdata_s_int[127:0] = rdata_m0 & {128{tt_enable_rd[0]}};
  ...
  assign rdata_s_int[255:128] = rdata_m1 & {128{tt_enable_rd[1]}};
  ...
  assign rresp_s = rresp_s_int[1:0]
                 | rresp_s_int[3:2];
  assign rdata_s = rdata_s_int[127:0]
                 | rdata_s_int[255:128];
