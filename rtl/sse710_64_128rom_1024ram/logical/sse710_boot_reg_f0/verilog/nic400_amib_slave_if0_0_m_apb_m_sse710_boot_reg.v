...
module nic400_amib_slave_if0_0_m_apb_m_sse710_boot_reg
(
  aclk,
  aresetn,
  ...
  input                 pclken;               
  output                psel_master_if0_i;     
  input                 pready_master_if0_i;   
  input                 pslverr_master_if0_i;  
  input         [31:0]  prdata_master_if0_i;   
  output                penable;              
  output                pwrite;               
  ...
  wire                  pclken;               
  wire                  psel_master_if0_i;     
  wire                  pready_master_if0_i;   
  wire                  pslverr_master_if0_i;  
  wire          [31:0]  prdata_master_if0_i;   
  wire                  penable;              
  wire                  pwrite;               
  ...
  reg                  accumulated_err;
  wire [44:0]       axi_resp_payload_in;
  wire [44:0]       axi_resp_payload_out;

  nic400_amib_slave_if0_0_m_a_gen_sse710_boot_reg #(
  ...
  assign psel_master_if0_i = psel_i[0];

  assign prdata  = prdata_master_if0_i;
  assign pslverr = pslverr_master_if0_i & psel_i[0];
  assign pready  = pready_master_if0_i | psel_i[1];
  ...
  nic400_rev_regd_slice_sse710_boot_reg #(45) u_axi_resp_ouput_buffer
  (
    .aresetn           (aresetn),
    .aclk              (aclk),
