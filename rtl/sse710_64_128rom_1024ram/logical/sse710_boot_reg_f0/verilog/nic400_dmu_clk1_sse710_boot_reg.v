...
`include "nic400_dmu_clk1_defs_sse710_boot_reg.v"

module nic400_dmu_clk1_sse710_boot_reg
  (
  ...
  input               slave_if0_0_m_ib_cactive;             


  input               slave_if0_0_m_ib_cactive_wakeup;      


  output              slave_if0_0_m_ib_port_enable;         


  input               cd_clk1_clk;                          
  input               cd_clk1_resetn;                       
  output              cd_clk1_cactive;                      
  input               cd_clk1_csysreq;                      
  output              cd_clk1_csysack;                      



  wire          slave_if0_0_m_ib_cactive;
  wire          slave_if0_0_m_ib_cactive_wakeup;
  wire          domain_active;
  wire          cactive_wakeup;
  wire          cactive_ot;
  ...
  assign aclk    = cd_clk1_clk;
  assign aresetn = cd_clk1_resetn;


  assign cactive_ot = (slave_if0_0_m_ib_cactive); 

  

  assign cactive_wakeup = slave_if0_0_m_ib_cactive_wakeup;
  
  nic400_cdc_comb_or2_sse710_boot_reg u_nic400_cdc_comb_or2_sse710_boot_reg (
       .din1_async       (cactive_ot),
       .din2_async       (cactive_wakeup),
       .dout_async       (domain_active)
   );
    
  assign cd_clk1_cactive     = domain_active;  

  assign cd_clk1_csysack   = domain_ack;



  nic400_cdc_capt_sync_sse710_boot_reg #(1) u_csysreq_sync (
    .clk            (aclk),
    .resetn         (aresetn),
    .d_async        (cd_clk1_csysreq),
    .sync_en        (1'b1),
    .q              (csysreq_sync)
  );

  nic400_cdc_capt_sync_sse710_boot_reg #(1) u_cactive_wakeup_sync (
    .clk            (aclk),
    .resetn         (aresetn),
  ...
  assign slave_if0_0_m_ib_port_enable = port_enable_reg;
...
`include "nic400_dmu_clk1_undefs_sse710_boot_reg.v"
