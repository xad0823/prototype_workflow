...
module nic400_ib_slave_if0_0_m_ib_downsize_wr_resp_block_sse710_boot_reg
  (
  bvalid_m,
  bready_s,
  bresp_m,
...
`include "nic400_ib_slave_if0_0_m_ib_defs_sse710_boot_reg.v"
  ...
  input [13:0]            bchannel_data;
   ...
   assign awid = bchannel_data[13:4];
   ...
   always @(match_bus)
    ...
    assign bvalid_s = (bvalid_m && match);
     ...
     nic400_ib_slave_if0_0_m_ib_downsize_resp_cam_slice_sse710_boot_reg u_downsize_resp_cam_slice_0
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_slave_if0_0_m_ib_downsize_resp_cam_slice_sse710_boot_reg u_downsize_resp_cam_slice_1
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_slave_if0_0_m_ib_downsize_resp_cam_slice_sse710_boot_reg u_downsize_resp_cam_slice_2
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_slave_if0_0_m_ib_downsize_resp_cam_slice_sse710_boot_reg u_downsize_resp_cam_slice_3
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
