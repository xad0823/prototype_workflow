...
module nic400_ib_slave_if0_0_m_ib_downsize_rd_cam_slice_sse710_boot_reg
  (
    aresetn,
    aclk,
...
`include "Axi.v"
 ...
 assign hazard_id     = ar_cam_data[16:7];
...
`include "std_ovl_defines.h"
  ...
  (
    ...
    .reset_n    (aresetn),
    .qualifier  (valid_reg),
    .test_expr  (rdata_buffer_enables & {7{nic400_ib_slave_if0_0_m_ib_downsize_rd_chan_sse710_boot_reg.rvalid_m}})
  );
`endif
