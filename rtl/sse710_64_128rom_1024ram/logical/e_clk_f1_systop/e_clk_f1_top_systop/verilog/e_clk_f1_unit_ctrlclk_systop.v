...
module e_clk_f1_unit_ctrlclk_systop (
    input   wire                        RESETN,  
...
u_clkrst_f1_clkdiv_modulate_top_syspll(
    .clkin                  (SYSPLL), 
    .divratio               (CTRLCLK_ON_SYSPLL_DIVRATIO), 
    ...
    .dftdivbypass           (DFTCTRLCLKDIVBYPASS_ON_SYSPLL), 
    .dftcgen                (DFTCGEN), 
    .dftrstdisable          (DFTRSTDISABLE), 
        
    .divratio_cur           (CTRLCLK_ON_SYSPLL_DIVRATIO_CUR), 
...
clkselNway_f0_2 u_clkselnway_f0_2(
    ...
    .clksel                 (CTRLCLK_CLKSEL), 
    .select_cur             (CTRLCLK_CLKSEL_CUR), 
    .dftclksel              (DFTCTRLCLKSEL), 
    
    .resetn                 (RESETN), 
    
    .dftclkselen            (DFTCTRLCLKSELEN), 
    .dftrstdisable          (DFTRSTDISABLE), 
...
u_e_clk_f1_clock_buffer_ctrlclk 
(
    .clk_in                 (clk_sel), 
    .clk_out                (c_clk_buf) 
);
