...
module nic400_amib_cvm_master_if_chan_slice_sse710_integration_example_f0_cvm
  (
   aresetn,
   aclk,
...
`endif
  ...
  nic400_ful_regd_slice_sse710_integration_example_f0_cvm #(PAYLD_WIDTH) u_ful_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_fwd_regd_slice_sse710_integration_example_f0_cvm #(PAYLD_WIDTH) u_fwd_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_rev_regd_slice_sse710_integration_example_f0_cvm #(PAYLD_WIDTH) u_rev_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
