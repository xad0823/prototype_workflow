...
module nic400_amib_slave_2_chan_slice_sse710_sctrl_apb
  (
   aresetn,
   aclk,
...
`endif
  ...
  nic400_ful_regd_slice_sse710_sctrl_apb #(PAYLD_WIDTH) u_ful_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_fwd_regd_slice_sse710_sctrl_apb #(PAYLD_WIDTH) u_fwd_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_rev_regd_slice_sse710_sctrl_apb #(PAYLD_WIDTH) u_rev_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
