...
`include "nic400_amib_slave_2_defs_sse710_sctrl_apb.v"

module nic400_amib_slave_2_sse710_sctrl_apb
  (
  ...
  nic400_amib_slave_2_axi_to_itb_sse710_sctrl_apb u_axi_to_itb
  (
    .awid           (awid_slave_2_s),
  ...
  nic400_amib_slave_2_apb_m_sse710_sctrl_apb #(
    .ID_WIDTH         (12),
    .ADDR_WIDTH       (32)
  ) u_apb_m
  (
    ...
    .pclken           (apb_pclken),
    .psel_uart_apb_i     (psel_uart_apb),
    .pready_uart_apb_i   (pready_uart_apb),
    .pslverr_uart_apb_i  (pslverr_uart_apb),
    .prdata_uart_apb_i   (prdata_uart_apb),
    .penable          (penable_apb),
    .pwrite           (pwrite_apb),
    .paddr            (paddr_apb),
    .pwdata           (pwdata_apb),
  ...
  assign penable_uart_apb = penable_apb;

  assign pwrite_uart_apb = pwrite_apb;

  assign paddr_uart_apb = paddr_apb;

  assign pwdata_uart_apb = pwdata_apb;

  assign pprot_uart_apb = pprot_apb;

  assign pstrb_uart_apb = pstrb_apb;





  nic400_amib_slave_2_chan_slice_sse710_sctrl_apb
    #(
       `RS_REV_REG,  
       37  
     )
...
`include "nic400_amib_slave_2_undefs_sse710_sctrl_apb.v"
