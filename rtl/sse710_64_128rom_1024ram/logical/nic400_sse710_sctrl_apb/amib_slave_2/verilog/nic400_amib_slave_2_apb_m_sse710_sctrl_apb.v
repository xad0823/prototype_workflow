...
module nic400_amib_slave_2_apb_m_sse710_sctrl_apb
(
  aclk,
  aresetn,
  ...
  input                 pclken;               
  output                psel_uart_apb_i;     
  input                 pready_uart_apb_i;   
  input                 pslverr_uart_apb_i;  
  input         [31:0]  prdata_uart_apb_i;   
  output                penable;              
  output                pwrite;               
  ...
  wire                  pclken;               
  wire                  psel_uart_apb_i;     
  wire                  pready_uart_apb_i;   
  wire                  pslverr_uart_apb_i;  
  wire          [31:0]  prdata_uart_apb_i;   
  wire                  penable;              
  wire                  pwrite;               
  ...
  nic400_amib_slave_2_a_gen_sse710_sctrl_apb #(
  ...
  assign psel_uart_apb_i = psel_i[0];

  assign prdata  = prdata_uart_apb_i;
  assign pslverr = pslverr_uart_apb_i & psel_i[0];
  assign pready  = pready_uart_apb_i | psel_i[1];
