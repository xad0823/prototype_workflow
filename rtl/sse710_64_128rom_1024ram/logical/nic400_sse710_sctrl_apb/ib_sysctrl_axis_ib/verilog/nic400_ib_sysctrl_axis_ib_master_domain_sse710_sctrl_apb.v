...
`include "nic400_ib_sysctrl_axis_ib_defs_sse710_sctrl_apb.v"



module nic400_ib_sysctrl_axis_ib_master_domain_sse710_sctrl_apb
  (
  ...
  output  [2:0]       awvalid_vect_axi4_m;      
  ...
  output  [2:0]       arvalid_vect_axi4_m;      
  ...
  nic400_ib_sysctrl_axis_ib_aw_fifo_rd_sse710_sctrl_apb
  u_aw_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_sysctrl_axis_ib_ar_fifo_rd_sse710_sctrl_apb
  u_ar_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_sysctrl_axis_ib_r_fifo_wr_sse710_sctrl_apb
  u_r_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_sysctrl_axis_ib_w_fifo_rd_sse710_sctrl_apb
  u_w_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_sysctrl_axis_ib_b_fifo_wr_sse710_sctrl_apb
  u_b_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
...
nic400_ib_sysctrl_axis_ib_maskcntl_sse710_sctrl_apb u_maskcntl (
...
`include "nic400_ib_sysctrl_axis_ib_undefs_sse710_sctrl_apb.v"
