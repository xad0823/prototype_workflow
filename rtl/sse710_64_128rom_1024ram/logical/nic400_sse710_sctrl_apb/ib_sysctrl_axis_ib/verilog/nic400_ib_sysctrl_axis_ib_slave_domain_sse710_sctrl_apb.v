...
module nic400_ib_sysctrl_axis_ib_slave_domain_sse710_sctrl_apb
  (
  ...
  input   [13:0]      b_data;                   
  output  [3:0]       b_rpntr_gry;              
  output  [2:0]       b_rpntr_bin;              
  input   [3:0]       b_wpntr_gry;              

  output  [71:0]      ar_data;                  
  input   [2:0]       ar_rpntr_gry;             
  input   [1:0]       ar_rpntr_bin;             
  output  [2:0]       ar_wpntr_gry;             
  ...
  wire [71:0]         aw_boundary_src_data;     
  wire [71:0]         aw_boundary_dst_data;     
  ...
  wire [71:0]         ar_boundary_src_data;     
  wire [71:0]         ar_boundary_dst_data;     
  ...
  nic400_ib_sysctrl_axis_ib_aw_fifo_wr_sse710_sctrl_apb
  u_aw_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_sysctrl_axis_ib_ar_fifo_wr_sse710_sctrl_apb
  u_ar_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_sysctrl_axis_ib_r_fifo_rd_sse710_sctrl_apb
  u_r_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_sysctrl_axis_ib_w_fifo_wr_sse710_sctrl_apb
  u_w_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_sysctrl_axis_ib_b_fifo_rd_sse710_sctrl_apb
  u_b_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
