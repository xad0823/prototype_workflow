...
`include "nic400_dmu_a_defs_sse710_sctrl_apb.v"

module nic400_dmu_a_sse710_sctrl_apb
  (
  ...
  input               sysctrl_axis_cactive;             


  input               sysctrl_axis_cactive_wakeup;      


  output              sysctrl_axis_port_enable;         
  ...
  wire          sysctrl_axis_cactive;
  wire          sysctrl_axis_cactive_wakeup;
  wire          domain_active;
  wire          cactive_wakeup;
  wire          cactive_ot;
  ...
  assign cactive_ot = (sysctrl_axis_cactive); 

  

  assign cactive_wakeup = sysctrl_axis_cactive_wakeup;
  
  nic400_cdc_comb_or2_sse710_sctrl_apb u_nic400_cdc_comb_or2_sse710_sctrl_apb (
  ...
  assign sysctrl_axis_port_enable = port_enable_reg;
...
`include "nic400_dmu_a_undefs_sse710_sctrl_apb.v"
