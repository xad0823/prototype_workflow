...
// This is the specification for the interface between the BIU and the RAMs.

// This file was automatically generated from the interface specification,
// do not edit it directly.
`ifdef ARM_ASSERT_ON

`include "ca53_biu_rams_defs.v"
`include "cortexa53params.v"

module ca53_biu_rams #(parameter INOPTIONS = `OVL_ASSERT, parameter OUTOPTIONS = `OVL_ASSERT) (
  input         clk,
  input         reset_n,
  input   [2:0] dc_size_i);
