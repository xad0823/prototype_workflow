...
module ca53_btacram_stg0_tb (
  ...
  //BTACRam TB
  //------------
  wire [((`CA53_BTAC_RAM_S0D_W * `BTACRAM_NUM_BANKS) -1):0] btacram_rdata;
  wire [(`CA53_BTAC_RAM_ADDR_W-1):0]                        btac_stg0_ram_addr_tst_out;
  ...
  wire [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_num1;
  wire [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_check_num1;
  wire [(`BTACRAM_NUM_BANKS -1)       :0]                   btacram_en_num1;
  wire [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_check0_num1;
  wire [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_check1_num1;
  wire [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_check2_num1;
  wire [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_check3_num1;
  wire [((`CA53_BTAC_RAM_S0D_W * `BTACRAM_NUM_BANKS) -1):0] expected_btacram_wdata_num1;
  wire                                                      in_progress_num1;
  wire [(`CA53_BTAC_RAM_ADDR_W-1)     :0]                   btac_ram_addr_tst1;
  wire [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btac_ram_wdata_tst1;
  ...
  wire [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_num2;
  wire [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_check_num2;
  wire [(`BTACRAM_NUM_BANKS -1)       :0]                   btacram_en_num2;
  wire [((`CA53_BTAC_RAM_S0D_W * `BTACRAM_NUM_BANKS) -1):0] expected_btacram_wdata_num2;
  wire                                                      in_progress_num2;
  wire [(`CA53_BTAC_RAM_ADDR_W-1)     :0]                   btac_ram_addr_tst2;
  wire [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btac_ram_wdata_tst2;
  wire [(`BTACRAM_NUM_BANKS - 1)      :0]                   btac_ram_en_tst2;
  wire                                                      btac_ram_wr_num2;
  wire                                                      reset_data_word_num2;

  reg  [3:0]                                                btacram_wr_en_num2;
  reg  [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_check0_num2;
  reg  [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_check1_num2;
  reg  [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_check2_num2;
  reg  [(`CA53_BTAC_RAM_S0D_W -1)     :0]                   btacram_wdata_check3_num2;

  //########### Generic Code for all test#######
  //--------------------------------------------

  assign btacram_rdata = btac_stg0_ram_rdata_i;

  //##########Test Number-1 Code###########
  //---------------------------------------

  ca53_ramtest_number1     #(.RAM_ID     ( `BTACRAM_RAM_STG0_ID),   // Unique ID
                             ...
                             .WORD_WIDTH ( `CA53_BTAC_RAM_S0D_W),  // width of RAM to test
                             .NUM_STRBS  ( ),
  ...
  ca53_ramtest_number2     #(.RAM_ID     ( `BTACRAM_RAM_STG0_ID),  // Unique ID
                             .ADDR_WIDTH ( `BTACRAM_ADDR_WIDTH),   // Addr bits
                             .RAM_TYPE   ( `BTACRAM_RAM_TYPE  ),   // RAM type
                             .NUM_BANKS  ( `BTACRAM_NUM_BANKS),    // Number of Banks
                             .BYTE_WIDTH ( `BTACRAM_BYTE_WIDTH),   // Byte or bit granularity
  ...
  assign btac_ram_en_tst2 = (btacram_wdata_num2 == {`CA53_BTAC_RAM_S0D_W{1'b0}} | btacram_en_num2 == {`BTACRAM_NUM_BANKS{1'b0}}) ? btacram_en_num2[(`BTACRAM_NUM_BANKS - 1):0] : (btac_ram_wr_num2 ? btacram_wr_en_num2[(`BTACRAM_NUM_BANKS - 1):0] : btacram_en_num2[(`BTACRAM_NUM_BANKS - 1):0]);
 ...
 assign btac_stg0_ram_addr_tst_out  = in_progress_num1 ? btac_ram_addr_tst1  : in_progress_num2 ? btac_ram_addr_tst2  : {`CA53_BTAC_RAM_ADDR_W{1'b0}};
 
 assign btac_stg0_ram_addr_o        = btac_stg0_ram_wr_o ? (~max_btacram_range | btac_stg0_ram_addr_tst_out) : btac_stg0_ram_addr_tst_out;
 assign btac_stg0_ram_wdata_o       = in_progress_num1 ? btac_ram_wdata_tst1 : in_progress_num2 ? btac_ram_wdata_tst2 : {`CA53_BTAC_RAM_S0D_W{1'b0}};
 assign btac_stg0_ram_en_o          = in_progress_num1 ? btac_ram_en_tst1    : in_progress_num2 ? btac_ram_en_tst2    : 1'b0;
 assign btac_stg0_ram_wr_o          = in_progress_num1 ? btac_ram_wr_num1    : in_progress_num2 ? btac_ram_wr_num2    : 1'b0;
 ...
 always@(*)
   begin
     btacram_wdata_check0_num2 = {`CA53_BTAC_RAM_S0D_W{1'b0}};
     btacram_wdata_check1_num2 = {`CA53_BTAC_RAM_S0D_W{1'b0}};
     btacram_wdata_check2_num2 = {`CA53_BTAC_RAM_S0D_W{1'b0}};
     btacram_wdata_check3_num2 = {`CA53_BTAC_RAM_S0D_W{1'b0}};
     case (btacram_bank_cnt_num2)
