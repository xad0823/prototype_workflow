...
module nic400_ib_dbg_axim_ib_master_domain_sse710_dbg3s1m
  (
  ...
  output  [5:0]       b_data;              
  input   [4:0]       b_rpntr_gry;         
  input   [3:0]       b_rpntr_bin;         
  output  [4:0]       b_wpntr_gry;         
  ...
  wire [5:0]          b_boundary_src_data;     
  wire [5:0]          b_boundary_dst_data;     
  ...
  nic400_ib_dbg_axim_ib_aw_fifo_rd_sse710_dbg3s1m
  u_aw_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_dbg_axim_ib_w_fifo_rd_sse710_dbg3s1m
  u_w_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_dbg_axim_ib_b_fifo_wr_sse710_dbg3s1m
  u_b_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
...
nic400_ib_dbg_axim_ib_maskcntl_sse710_dbg3s1m u_maskcntl (
