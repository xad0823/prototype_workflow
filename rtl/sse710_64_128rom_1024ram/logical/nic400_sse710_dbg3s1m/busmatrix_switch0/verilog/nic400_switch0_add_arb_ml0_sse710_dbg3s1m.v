...
module nic400_switch0_add_arb_ml0_sse710_dbg3s1m
  (
    a_sel,
    a_valid_vector,
    aready,
...
nic400_switch0_qv_cmp_sse710_dbg3s1m #(.REQUESTS (REQUESTS), .QOS_WIDTH (QOS_WIDTH)) u_highest_qos (
...
nic400_switch0_lrg_arb_sse710_dbg3s1m #(.WIDTH(REQUESTS)) u_lrg_arb (
  .aclk       (aclk),
  .aresetn    (aresetn),
  .update_en  (update),
  .request    (request),
