...
module nic400_switch0_ml_mlayer_0_sse710_dbg3s1m
  (
    awuser_m,
    awid_m,
    awaddr_m,
...
nic400_switch0_add_sel_ml0_sse710_dbg3s1m u_nic400_switch0_add_sel_ml0_sse710_dbg3s1m (
        .awuser_m       (awuser_m),
        .awid_m         (awid_m),
        .awaddr_m       (awaddr_m),
        .awlen_m        (awlen_m),
...
nic400_switch0_wr_sel_ml0_sse710_dbg3s1m u_nic400_switch0_wr_sel_ml0_sse710_dbg3s1m (
        .wdata_s0     (wdata_s0),
        .wstrb_s0     (wstrb_s0),
        .wlast_s0     (wlast_s0),
        .wvalid_s0    (wvalid_s0),
...
nic400_switch0_ret_sel_ml0_sse710_dbg3s1m u_nic400_switch0_ret_sel_ml0_sse710_dbg3s1m (
        .wr_cnt_empty (wr_cnt_empty),
        .bid_s0       (bid_s0),
        .bresp_s0     (bresp_s0),
        .bvalid_s0    (bvalid_s0),
 ...
 wire [2:0] rsel;
 wire [2:0] bsel;
 assign rsel = u_nic400_switch0_ret_sel_ml0_sse710_dbg3s1m.rsel;
 assign bsel = u_nic400_switch0_ret_sel_ml0_sse710_dbg3s1m.rsel;
