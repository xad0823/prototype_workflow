...
module nic400_switch0_add_sel_ml0_sse710_dbg3s1m
  (
    awuser_m,
    awid_m,
    awaddr_m,
  ...
  wire   [2:0]      ar_sel_i;
  wire              last_rd;
  wire   [2:0]      awuser_masked0;
  wire   [3:0]      awid_masked0;
  ...
  wire   [2:0]      aruser_masked0;
  wire   [3:0]      arid_masked0;
  ...
  wire   [2:0]      awuser_masked1;
  wire   [3:0]      awid_masked1;
  ...
  wire   [2:0]      aruser_masked1;
  wire   [3:0]      arid_masked1;
  ...
  wire   [2:0]      awuser_masked2;
  wire   [3:0]      awid_masked2;
  ...
  wire   [2:0]      aruser_masked2;
  wire   [3:0]      arid_masked2;
...
nic400_switch0_maskcntl_ml0_sse710_dbg3s1m u_nic400_switch0_maskcntl_ml0_sse710_dbg3s1m (
...
nic400_switch0_add_arb_ml0_sse710_dbg3s1m u_nic400_switch0_aw_arb_ml0_sse710_dbg3s1m (
        .a_sel          (aw_sel_i),
...
nic400_switch0_add_arb_ml0_sse710_dbg3s1m u_nic400_switch0_ar_arb_ml0_sse710_dbg3s1m (
        .a_sel          (ar_sel_i),
    ...
    assign awuser_masked0  = awuser_s0_i & {3{aw_sel_i[0]}}; 
    assign awid_masked0    = awid_s0_i & {4{aw_sel_i[0]}};
    ...
    assign aruser_masked0  = aruser_s0_i & {3{ar_sel_i[0]}};
    assign arid_masked0   = arid_s0_i & {4{ar_sel_i[0]}};
    ...
    assign awuser_masked1  = awuser_s1_i & {3{aw_sel_i[1]}}; 
    assign awid_masked1    = awid_s1_i & {4{aw_sel_i[1]}};
    ...
    assign aruser_masked1  = aruser_s1_i & {3{ar_sel_i[1]}};
    assign arid_masked1   = arid_s1_i & {4{ar_sel_i[1]}};
    ...
    assign awuser_masked2  = awuser_s2_i & {3{aw_sel_i[2]}}; 
    assign awid_masked2    = awid_s2_i & {4{aw_sel_i[2]}};
    ...
    assign aruser_masked2  = aruser_s2_i & {3{ar_sel_i[2]}};
    assign arid_masked2   = arid_s2_i & {4{ar_sel_i[2]}};
