...
module nic400_ib_p0_axis_ib_chan_slice_sse710_dbg3s1m
  (
   aresetn,
   aclk,
...
`endif
  ...
  nic400_ful_regd_slice_sse710_dbg3s1m #(PAYLD_WIDTH) u_ful_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_fwd_regd_slice_sse710_dbg3s1m #(PAYLD_WIDTH) u_fwd_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_rev_regd_slice_sse710_dbg3s1m #(PAYLD_WIDTH) u_rev_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
