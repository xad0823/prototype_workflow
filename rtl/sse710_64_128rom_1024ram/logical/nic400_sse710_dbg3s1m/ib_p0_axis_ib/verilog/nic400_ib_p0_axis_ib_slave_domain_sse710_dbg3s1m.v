...
module nic400_ib_p0_axis_ib_slave_domain_sse710_dbg3s1m
  (
  ...
  nic400_ib_p0_axis_ib_aw_fifo_wr_sse710_dbg3s1m
  u_aw_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_p0_axis_ib_w_fifo_wr_sse710_dbg3s1m
  u_w_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  nic400_ib_p0_axis_ib_b_fifo_rd_sse710_dbg3s1m
  u_b_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
