...
module nic400_ib_p0_axis_ib_master_domain_sse710_dbg3s1m
  (
  ...
  nic400_ib_p0_axis_ib_aw_fifo_rd_sse710_dbg3s1m
  u_aw_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_p0_axis_ib_w_fifo_rd_sse710_dbg3s1m
  u_w_fifo_rd
    (
     .rresetn               (aresetn),
     .rclk                  (aclk),
  ...
  nic400_ib_p0_axis_ib_b_fifo_wr_sse710_dbg3s1m
  u_b_fifo_wr
    (
     .wresetn               (aresetn),
     .wclk                  (aclk),
  ...
  assign asib_p0_axis_ib_siid = 2'b0;





  assign awid_axi4_m = {awid,asib_p0_axis_ib_siid};
  assign arid_axi4_m = {arid,asib_p0_axis_ib_siid};
...
nic400_ib_p0_axis_ib_maskcntl_sse710_dbg3s1m u_maskcntl (
