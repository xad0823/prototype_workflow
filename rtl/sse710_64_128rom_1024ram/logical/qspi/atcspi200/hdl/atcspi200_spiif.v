...
output			spi_miso_out;
output			spi_miso_oe;
output                  first_slv_tx_word_clear;
// 2906ce13 rnd
`ifndef NDS_FPGA
...
`ifdef ATCSPI200_SLAVE_SUPPORT
	...
	assign first_slv_tx_word_clear =  (spi_mode[1]==1'b1) ? spi_clk_negedge : spi_clk_posedge;
...
`else
	...
	assign first_slv_tx_word_clear = 1'b0;
`endif
