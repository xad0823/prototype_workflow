...
#####################################################
# main body
# NOTE: $seed + 0 converts the CLI string to a number
#####################################################
my $seed = $opt_log;
&logSeed(
  jsonfile => $opt_json,
...
logseed.pl --log <type> [--json <path to json file>]

command line utility to log a test seed in a test.json file

 Options:
   --log  <seed>      : mandatory argument ; it's the seed to log
