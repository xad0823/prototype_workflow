...
//
// Description : DW_axi_x2h_bcm99.v Verilog module for DW_axi_x2h
//
// DesignWare IP ID: 80de7735
//
////////////////////////////////////////////////////////////////////////////////

module DW_axi_x2h_bcm99 (
  clk_d,
  rst_d_n,
  data_s,
  data_d
...
generate if (ACCURATE_MISSAMPLING == 1) begin : GEN_ACCURATE_MS_EQ1
...
`ifndef SYNTHESIS
generate if (ACCURATE_MISSAMPLING==1) begin : GEN_ASSERT_ACCURATE_MS_EQ1
