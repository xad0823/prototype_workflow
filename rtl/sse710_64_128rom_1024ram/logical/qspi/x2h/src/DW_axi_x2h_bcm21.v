...
//
// Description : DW_axi_x2h_bcm21.v Verilog module for DW_axi_x2h
//
// DesignWare IP ID: 200bbedf
//
////////////////////////////////////////////////////////////////////////////////
...
`ifdef DWC_SYNC_1_STAGE_SRC
      ...
      `DWC_SYNC_1_STAGE_SRC(U_SAMPLE_META_1_N, WIDTH, ~clk_d, rst_d_n, data_s_int, sample_meta)
...
`endif
  ...
  generate
    ...
    if (SVA_TYPE_BIT1BIT0 == 1) begin : GEN_SVATP_EQ_1
      ...
      DW_axi_x2h_sva01 #(WIDTH, (F_SYNC_TYPE & 7), VERIF_EN) P_SYNC_HS (.*);
    end
    ...
    if (SVA_TYPE_BIT2 == 0) begin : GEN_SVATP_BIT2_EQ_0
      DW_axi_x2h_sva08 #(WIDTH,0) P_SYNC_EQ_RST (.*);
    end
  endgenerate
  `else
    `ifdef DW_MODEL_MISSAMPLES
  DW_axi_x2h_bvm02 U_CLK_DET (
    .clk         (clk_d        ),
    .rst_n       (rst_d_n      ),
    .clk_stopped (clk_d_stopped),
    .clk_period  (clk_d_period )
