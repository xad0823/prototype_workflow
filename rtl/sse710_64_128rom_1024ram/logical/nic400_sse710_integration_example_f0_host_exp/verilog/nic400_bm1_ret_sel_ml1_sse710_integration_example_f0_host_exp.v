...
module nic400_bm1_ret_sel_ml1_sse710_integration_example_f0_host_exp
  (
    wr_cnt_empty,
  ...
  wire            rsel; 
   ...
   assign bvalid_masked = bvalid_m & ~wr_cnt_empty;
    ...
    assign bid_s0  = bid_m & {18{bsel}};
    assign bresp_s0  = bresp_m & {2{bsel}};
    assign bvalid_s0  = bvalid_masked & bsel;



    assign rid_s0 = rid_m & {18{rsel}};
    assign rdata_s0 = rdata_m & {64{rsel}};
