...
module nic400_amib_apb_group0_apb_m_sse710_integration_example_f0_host_exp
(
  aclk,
  aresetn,
  ...
  pclken,
  psel_vultan_apb_m_i,
  psel_extsys0_ppu_abp_m_i,
  psel_extsys1_ppu_abp_m_i,
  pready_vultan_apb_m_i,
  pready_extsys0_ppu_abp_m_i,
  pready_extsys1_ppu_abp_m_i,
  pslverr_vultan_apb_m_i,
  pslverr_extsys0_ppu_abp_m_i,
  pslverr_extsys1_ppu_abp_m_i,
  prdata_vultan_apb_m_i,
  prdata_extsys0_ppu_abp_m_i,
  prdata_extsys1_ppu_abp_m_i,
  penable,
  pwrite,
  paddr,
  pwdata,
  ...
  input                 pclken;               
  output                psel_vultan_apb_m_i;     
  output                psel_extsys0_ppu_abp_m_i;     
  output                psel_extsys1_ppu_abp_m_i;     
  input                 pready_vultan_apb_m_i;   
  input                 pready_extsys0_ppu_abp_m_i;   
  input                 pready_extsys1_ppu_abp_m_i;   
  input                 pslverr_vultan_apb_m_i;  
  input                 pslverr_extsys0_ppu_abp_m_i;  
  input                 pslverr_extsys1_ppu_abp_m_i;  
  input         [31:0]  prdata_vultan_apb_m_i;   
  input         [31:0]  prdata_extsys0_ppu_abp_m_i;   
  input         [31:0]  prdata_extsys1_ppu_abp_m_i;   
  output                penable;              
  output                pwrite;               
  ...
  wire                  pclken;               
  wire                  psel_vultan_apb_m_i;     
  wire                  psel_extsys0_ppu_abp_m_i;     
  wire                  psel_extsys1_ppu_abp_m_i;     
  wire                  pready_vultan_apb_m_i;   
  wire                  pready_extsys0_ppu_abp_m_i;   
  wire                  pready_extsys1_ppu_abp_m_i;   
  wire                  pslverr_vultan_apb_m_i;  
  wire                  pslverr_extsys0_ppu_abp_m_i;  
  wire                  pslverr_extsys1_ppu_abp_m_i;  
  wire          [31:0]  prdata_vultan_apb_m_i;   
  wire          [31:0]  prdata_extsys0_ppu_abp_m_i;   
  wire          [31:0]  prdata_extsys1_ppu_abp_m_i;   
  wire                  penable;              
  wire                  pwrite;               
  ...
  reg                  accumulated_err;
  wire [52:0]       axi_resp_payload_in;
  wire [52:0]       axi_resp_payload_out;

  nic400_amib_apb_group0_a_gen_sse710_integration_example_f0_host_exp #(
  ...
  assign psel_dec[3] = ~|psel_dec[2:0];
          ...
          begin
            ...
            if (ok_to_start_nxt_apb_trans) begin
               ...
               nxt_bridge_state = 1'b1;
                ...
                nxt_psel     = (|psel_i) ? {4{~pready}} & psel_i : {4{1'b0}};
  ...
  assign psel_vultan_apb_m_i = psel_i[0];
  assign psel_extsys0_ppu_abp_m_i = psel_i[1];
  assign psel_extsys1_ppu_abp_m_i = psel_i[2];

  assign prdata = (prdata_vultan_apb_m_i & {32{psel_vultan_apb_m_i}}) |
                  (prdata_extsys0_ppu_abp_m_i & {32{psel_extsys0_ppu_abp_m_i}}) |
                  (prdata_extsys1_ppu_abp_m_i & {32{psel_extsys1_ppu_abp_m_i}});

  assign pslverr = ((pslverr_vultan_apb_m_i & psel_vultan_apb_m_i) |
                     (pslverr_extsys0_ppu_abp_m_i & psel_extsys0_ppu_abp_m_i) |
                     (pslverr_extsys1_ppu_abp_m_i & psel_extsys1_ppu_abp_m_i));

  assign pready = (pready_vultan_apb_m_i & psel_vultan_apb_m_i) |
                  (pready_extsys0_ppu_abp_m_i & psel_extsys0_ppu_abp_m_i) |
                  (pready_extsys1_ppu_abp_m_i & psel_extsys1_ppu_abp_m_i) |
                  psel_i[3];
  ...
  nic400_rev_regd_slice_sse710_integration_example_f0_host_exp #(53) u_axi_resp_ouput_buffer
  (
    .aresetn           (aresetn),
    .aclk              (aclk),
...
`include "std_ovl_defines.h"
  ...
  (
   ...
   assert_zero_one_hot #(0,4,0,"ERROR, More than one psel selected")
...
`else
  ...
  assert_never #(`OVL_WARNING, `OVL_ASSERT,
                 "Sub-word or sparse writes may not be supported by APB")
  amib_apb_illegal_wstrb
  (
    .clk            (aclk),
    .reset_n        (aresetn),
    .test_expr      (wvalid && wready && 
                     (wstrb != 4'b1111) && (wstrb != 4'b0000))
  );
