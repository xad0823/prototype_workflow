...
module nic400_bm1_add_sel_ml0_sse710_integration_example_f0_host_exp
  (
    awuser_m,
    awid_m,
    awaddr_m,
  ...
  wire   [1:0]      ar_sel_i;
  wire              last_rd;
  wire   [3:0]      awuser_masked0;
  wire   [17:0]      awid_masked0;
  ...
  wire   [1:0]      awvalid_vect_masked0;
  wire   [3:0]      aruser_masked0;
  wire   [17:0]      arid_masked0;
  ...
  wire   [1:0]      arvalid_vect_masked0;

  wire   [3:0]      awuser_masked1;
  wire   [17:0]      awid_masked1;
  ...
  wire   [1:0]      awvalid_vect_masked1;
  wire   [3:0]      aruser_masked1;
  wire   [17:0]      arid_masked1;
  ...
  wire              arvalid_s0_i;
  wire   [1:0]      arvalid_vect_s0_i;
  wire              arready_s0_i;
  wire   [3:0]      ar_qv_s0_i;
  

  wire   [3:0]      awuser_s1_i;
  wire   [17:0]      awid_s1_i;
  ...
  wire              awvalid_s1_i;
  wire   [1:0]      awvalid_vect_s1_i;
  wire              awready_s1_i;
  wire   [3:0]      aw_qv_s1_i;
  
  wire   [3:0]      aruser_s1_i;
  wire   [17:0]      arid_s1_i;
...
nic400_bm1_maskcntl_ml0_sse710_integration_example_f0_host_exp u_nic400_bm1_maskcntl_ml0_sse710_integration_example_f0_host_exp (
...
nic400_bm1_add_arb_ml0_sse710_integration_example_f0_host_exp u_nic400_bm1_aw_arb_ml0_sse710_integration_example_f0_host_exp (
        .a_sel          (aw_sel_i),
...
nic400_bm1_add_arb_ml0_sse710_integration_example_f0_host_exp u_nic400_bm1_ar_arb_ml0_sse710_integration_example_f0_host_exp (
        .a_sel          (ar_sel_i),
    ...
    assign awuser_masked0  = awuser_s0_i & {4{aw_sel_i[0]}}; 
    assign awid_masked0    = awid_s0_i & {18{aw_sel_i[0]}};
    ...
    assign awvalid_vect_masked0 = awvalid_vect_s0_i & {2{aw_sel_i[0]}};
  
    assign aruser_masked0  = aruser_s0_i & {4{ar_sel_i[0]}};
    assign arid_masked0   = arid_s0_i & {18{ar_sel_i[0]}};
    ...
    assign arvalid_vect_masked0 = arvalid_vect_s0_i & {2{ar_sel_i[0]}};

    assign awuser_masked1  = awuser_s1_i & {4{aw_sel_i[1]}}; 
    assign awid_masked1    = awid_s1_i & {18{aw_sel_i[1]}};
    ...
    assign awvalid_vect_masked1 = awvalid_vect_s1_i & {2{aw_sel_i[1]}};
  
    assign aruser_masked1  = aruser_s1_i & {4{ar_sel_i[1]}};
    assign arid_masked1   = arid_s1_i & {18{ar_sel_i[1]}};
    ...
    assign arvalid_vect_masked1 = arvalid_vect_s1_i & {2{ar_sel_i[1]}};
