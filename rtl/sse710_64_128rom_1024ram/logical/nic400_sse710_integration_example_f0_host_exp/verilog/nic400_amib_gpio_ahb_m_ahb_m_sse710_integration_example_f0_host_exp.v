...
module nic400_amib_gpio_ahb_m_ahb_m_sse710_integration_example_f0_host_exp
(
  aclk,
  aresetn,
  ...
  wire                  aready_i;             
  wire                  avalid_i;             
  wire          [70:0]  a_src_data;           
  wire          [70:0]  a_dst_data;           
  wire                  awrite_mux;           
  wire        [17:0]    aid_mux;              
  wire        [7:0]     alen_mux;             
  wire           [2:0]  asize_mux;            
  ...
  wire           [3:0]  acache_mux;           
  wire                  ach_hndshk;           
  wire          [18:0]  acb_data_in;          
  wire                  acb_push;             
  wire                  acb_push_in;          
  wire                  acb_pop;              
  wire                  acb_pop_in;           
  wire          [18:0]  acb_data_out;         
  wire                  acb_ready;            
  wire                  acb_not_empty;        
  ...
  nic400_rev_regd_slice_sse710_integration_example_f0_host_exp #(
    .PAYLD_WIDTH     (71)
  ) u_ach_reg_slice
  (
    .aresetn         (aresetn),
  ...
  nic400_ful_regd_slice_sse710_integration_example_f0_host_exp #(
    .PAYLD_WIDTH    (19)
  ) u_ahb_amib_acb
  (
    .aresetn        (aresetn),
  ...
  nic400_amib_gpio_ahb_m_s_gen_sse710_integration_example_f0_host_exp #(
    .DATA_WIDTH     (32)
  ) u_ahb_amib_s_gen
  (
  ...
  nic400_amib_gpio_ahb_m_a_gen_sse710_integration_example_f0_host_exp #(
    .ADDR_WIDTH     (12)
  ) u_a_gen
  (
  ...
  assign hreadymux_r = hsel_o_reg ? hready : 1'b1;
  assign hreadymux_w = hsel_o_reg ? hready : 1'b1;
