...
module nic400_amib_extsys1_axi_m_chan_slice_sse710_integration_example_f0_host_exp
  (
   aresetn,
   aclk,
...
`else
  localparam  INT_HNDSHK_MODE = HNDSHK_MODE; 
`endif
  ...
  nic400_ful_regd_slice_sse710_integration_example_f0_host_exp #(PAYLD_WIDTH) u_ful_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_fwd_regd_slice_sse710_integration_example_f0_host_exp #(PAYLD_WIDTH) u_fwd_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
  ...
  nic400_rev_regd_slice_sse710_integration_example_f0_host_exp #(PAYLD_WIDTH) u_rev_regd_slice
    (
     .aresetn        (aresetn),
     .aclk           (aclk),
