...
module nic400_ib_ib2_downsize_wr_resp_block_sse710_integration_example_f0_host_exp
  (
  bvalid_m,
  bready_s,
  bresp_m,
  ...
  input [21:0]            bchannel_data;
   ...
   always @(match_bus)
    ...
    assign bvalid_s = (bvalid_m && match);
     ...
     nic400_ib_ib2_downsize_resp_cam_slice_sse710_integration_example_f0_host_exp u_downsize_resp_cam_slice_0
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
     ...
     nic400_ib_ib2_downsize_resp_cam_slice_sse710_integration_example_f0_host_exp u_downsize_resp_cam_slice_1
     (
        .aresetn              (aresetn),
        .aclk                 (aclk),
