...
module nic400_ib_ib2_downsize_rd_addr_fmt_sse710_integration_example_f0_host_exp
  (
    aresetn,
    aclk,
...
`include "Axi.v"
 ...
 always @(posedge aclk or negedge aresetn)
  ...
  assign araddr_incr = {araddr_s[31:12],addr_result};
 ...
 always @(posedge aclk or negedge aresetn)
  ...
  assign araddr_boundary = ({araddr_aligned[31:12],boundary_incr,araddr_aligned[5:0]});
