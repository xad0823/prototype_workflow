...
//----------------------------------------------------------------------------
  ...
  localparam ST_APBMSTR_IDLE      = 2'b00;
  localparam ST_APBMSTR_SETUP     = 2'b01;
  localparam ST_APBMSTR_ACCESS    = 2'b10;
  localparam ST_APBMSTR_UNDEF     = 2'bxx;
  ...
  localparam REGV_IDR_REVISION         = 4'h2;
  ...
  localparam REGV_PIDR0_PART0          = 8'hE2;
  ...
  localparam APBM_PPROT_DEFAULT = 3'b011;
