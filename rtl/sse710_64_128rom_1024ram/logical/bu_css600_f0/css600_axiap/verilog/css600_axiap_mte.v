...
//----------------------------------------------------------------------------
//   Description :
//   Top level of css600_axiap_mte
//
//----------------------------------------------------------------------------


module css600_axiap_mte #(parameter
  AXI_ADDR_WIDTH        = 64,
  AXI_DATA_WIDTH        = 128,
  FF_SYNC_DEPTH         = 2,
  REVAND                = 4'h0
...
(
  ...
  output wire [(L_MTE_TAG_WIDTH/4)-1:0]    wtagupdate_m;
  output wire [L_MTE_TAG_WIDTH-1:0]        wtag_m;
  output wire [1:0]                        artagop_m;
  input  wire [L_MTE_TAG_WIDTH-1:0]        rtag_m;
