...
//----------------------------------------------------------------------------
//   Description :
//   Top level of css600_tsintp
//
//----------------------------------------------------------------------------


module css600_tsintp #(parameter
  FF_SYNC_DEPTH = 2
)
(
  clk,
...
localparam SYNC_DEPTH_LOC = (FF_SYNC_DEPTH == 3) ? 3 : 2;
  ...
  css600_tsintp_core u_tsintp
    (
    .clk(clk),
    .resetn(reset_n),
    .tsvalueb(tsvalue_b_s),
    .tsvalueintpb(tsvalue_b_m),
    .lp_req(lp_req_w),
    .lp_ack(lp_ack_w)
    );
  ...
  css600_lpislave u_tsintp_lpi_slave (
