...
module ca53dpu_fp_clz24 (
  ...
  assign check_byte[0] = |(opa[ 7: 0]);
  assign check_byte[1] = |(opa[15: 8]);
  assign check_byte[2] = |(opa[23:16]);
  ...
  always @*
    case (check_byte[2:0])
      ...
      `ca53dpu_sel_1xx : clz_result[4:0] = {2'b00, clz_byte2[2:0]};
      // Most significant '1' is in Byte1
      `ca53dpu_sel_01x : clz_result[4:0] = {2'b01, clz_byte1[2:0]};
      // Most significant '1' is in Byte0
        3'b001         : clz_result[4:0] = {2'b10, clz_byte0[2:0]};
      // Operand value is zero
        3'b000         : clz_result[4:0] = 5'b11_000;
      default          : clz_result[4:0] = 5'bxx_xxx;
    endcase
