...
module e_clk_f1_unit_dbgclk_dbgtop (
    input   wire                        RESETN,  
...
u_clkrst_f1_clkdiv_modulate_top_syspll(
    .clkin                  (SYSPLL), 
    .divratio               (DBGCLK_ON_SYSPLL_DIVRATIO), 
    ...
    .dftdivbypass           (DFTDBGCLKDIVBYPASS_ON_SYSPLL), 
    .dftcgen                (DFTCGEN), 
    .dftrstdisable          (DFTRSTDISABLE), 
        
    .divratio_cur           (DBGCLK_ON_SYSPLL_DIVRATIO_CUR), 
...
clkselNway_f0_2 u_clkselnway_f0_2(
    ...
    .clksel                 (DBGCLK_CLKSEL), 
    .select_cur             (DBGCLK_CLKSEL_CUR), 
    .dftclksel              (DFTDBGCLKSEL), 
    
    .resetn                 (RESETN), 
    
    .dftclkselen            (DFTDBGCLKSELEN), 
    .dftrstdisable          (DFTRSTDISABLE), 
...
e_clk_f1_clock_buffer_dbgtop 
#(
    .CLOCK_DELAY    (0)
)
u_e_clk_f1_clock_buffer_dbgclk 
(
    .clk_in                 (clk_sel), 
    .clk_out                (c_clk_buf) 
);
