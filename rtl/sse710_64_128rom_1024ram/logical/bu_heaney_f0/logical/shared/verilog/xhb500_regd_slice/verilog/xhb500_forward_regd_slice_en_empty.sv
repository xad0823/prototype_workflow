...
module xhb500_forward_regd_slice_en_empty
#(
...
(
  ...
  assign ready_src = en & (ready_dst | ~valid_dst);

  wire logic payload_en = en & ((valid_src & ~valid_dst) |
  ...
  wire logic valid_dst_en = en & (valid_src | ready_dst);
