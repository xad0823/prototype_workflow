...
module xhb500_axi_to_ahb_bridge_flash_core
(
  ...
  wire xhb500_axi_to_ahb_bridge_flash_pkg::ahb_mpayld_t hreg_ahb_in;
  wire logic              hreg_hready_out;
  wire xhb500_axi_to_ahb_bridge_flash_pkg::ahb_m_trq_t hreg_ahb_tr_q;


  xhb500_axi_to_ahb_bridge_flash_core_xin u_core_xin
  (
    .clk                  (clk),
    .resetn               (resetn),
  ...
  wire xhb500_axi_to_ahb_bridge_flash_pkg::ahb_mpayld_t hreg_ahb_out;

  xhb500_axi_to_ahb_bridge_flash_hreg u_hreg
  (
    .clk                  (clk),
    .resetn               (resetn),
  ...
  xhb500_axi_to_ahb_bridge_flash_core_h_xout u_core_h_xout
  (
    .clk                   (clk),
    .resetn                (resetn),
