...
module xhb500_axi_to_ahb_bridge_flash_xreg
(

  input wire logic                                                  clk,
  input wire logic                                                  resetn,

  input  wire xhb500_axi_to_ahb_bridge_flash_pkg::ctrl_lpi_en_t                 ctrl_lpi_en,
  ...
  input wire xhb500_axi_to_ahb_bridge_flash_pkg::axi_awsppayld_t                awsppayld,
  ...
  output xhb500_axi_to_ahb_bridge_flash_pkg::axi_axpayld_t                      xreg_arpayld,
  output     logic                                                  xreg_awvalid,
  input wire logic                                                  xreg_awready,
  output xhb500_axi_to_ahb_bridge_flash_pkg::axi_awsppayld_t                    xreg_awsppayld,
  output     logic                                                  xreg_wvalid,
  input wire logic                                                  xreg_wready,
  output xhb500_axi_to_ahb_bridge_flash_pkg::axi_wpayld_t                       xreg_wpayld
);
  ...
  xhb500_forward_regd_slice_en_empty
  #(
    .PAYLD_WIDTH($bits(xhb500_axi_to_ahb_bridge_flash_pkg::axi_axpayld_t))
  )
  u_xreg_ar
  (
    .clk                (clk),
    .resetn             (resetn),
    .en                 (ctrl_lpi_en.en_ar),
    .empty              (xreg_arempty),
  ...
  xhb500_forward_regd_slice_en_empty
  #(
    .PAYLD_WIDTH($bits(xhb500_axi_to_ahb_bridge_flash_pkg::axi_awsppayld_t))
  )
  u_xreg_aw
  (
    .clk                (clk),
    .resetn             (resetn),
    .en                 (ctrl_lpi_en.en_aw),
    .empty              (xreg_awempty),
  ...
  xhb500_forward_regd_slice_en_empty
  #(
    .PAYLD_WIDTH($bits(xhb500_axi_to_ahb_bridge_flash_pkg::axi_wpayld_t))
  )
  u_xreg_w
  (
