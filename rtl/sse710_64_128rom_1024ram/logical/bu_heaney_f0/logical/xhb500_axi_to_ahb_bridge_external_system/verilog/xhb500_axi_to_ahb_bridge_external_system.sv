...
module xhb500_axi_to_ahb_bridge_external_system
(
  ...
  input  wire logic     [4-1:0]                        wstrb,
  input  wire logic     [32-1:0]                       wdata,

  output      logic                                    rvalid,
  input  wire logic                                    rready,
  output      logic     [18-1:0]                       rid,
  output      logic                                    rlast,
  ...
  output      logic                                    hexcl,
  output      logic     [18-1:0]                       hmaster,

  input  wire logic     [32-1:0]                       hrdata,
  ...
  wire logic unused_in                      = arsize[2] | awsize[2];


  wire xhb500_axi_to_ahb_bridge_external_system_pkg::axi_axpayld_t   axi_arpayld;
  ...
  assign axi_arpayld.axsize                 = arsize[1:0];
  ...
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::axi_awsppayld_t axi_awsppayld;
  ...
  assign axi_awsppayld.awpayld.axsize       = awsize[1:0];
  ...
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::axi_wpayld_t axi_wpayld;
  assign axi_wpayld.wlast                   = wlast;
  assign axi_wpayld.wstrb                   = wstrb;
  assign axi_wpayld.wdata                   = wdata;

  wire xhb500_axi_to_ahb_bridge_external_system_pkg::axi_rpayld_t   axi_rpayld;
  assign rid                                = axi_rpayld.rid;
  assign rdata                              = axi_rpayld.rdata;
  assign rlast                              = axi_rpayld.rlast;
  assign rresp                              = axi_rpayld.rresp;

  wire xhb500_axi_to_ahb_bridge_external_system_pkg::axi_bpayld_t   axi_bpayld;
  assign bid                                = axi_bpayld.bid;
  assign bresp                              = axi_bpayld.bresp;

  wire xhb500_axi_to_ahb_bridge_external_system_pkg::ahb_mpayld_t ahb_mpayld;
  ...
  assign hsize                              = {1'b0, ahb_mpayld.hfix.hsize};
  ...
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::ahb_spayld_t   ahb_spayld;
  ...
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::ctrl_lpi_en_t  ctrl_lpi_en;
  wire logic                                  ctrl_core_active;
  wire logic                                  ctrl_xreg_active;

  xhb500_axi_to_ahb_bridge_external_system_lpi u_lpi
  (
    .clk                (clk),
    .resetn             (resetn),
  ...
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::axi_axpayld_t   xreg_arpayld;
  wire logic                                   xreg_awvalid;
  wire logic                                   xreg_awready;
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::axi_awsppayld_t xreg_awsppayld;
  wire logic                                   xreg_wvalid;
  wire logic                                   xreg_wready;
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::axi_wpayld_t    xreg_wpayld;

  xhb500_axi_to_ahb_bridge_external_system_xreg u_xreg
  (
  ...
  xhb500_axi_to_ahb_bridge_external_system_core
  u_core
  (
    .clk                (clk),
    .resetn             (resetn),
