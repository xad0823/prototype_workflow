...
module xhb500_axi_to_ahb_bridge_external_system_core_xin
(
  ...
  output      xhb500_axi_to_ahb_bridge_external_system_pkg::ahb_mpayld_t                    ahb_out,

  input wire logic                                                    hready_in,
  input wire  xhb500_axi_to_ahb_bridge_external_system_pkg::ahb_m_trq_t                     ahb_tr_q_in
);

  wire xhb500_axi_to_ahb_bridge_external_system_pkg::axi_axpayld_t                          aw = awpayld;
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::axi_axpayld_t                          ar = arpayld;
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::axi_wpayld_t                           w  = wpayld;
  ...
  localparam MAXSIZE = $clog2(4);
  typedef enum logic [1:0] {SIZE000= 2'b00, SIZE001= 2'b01, SIZE010= 2'b10, SIZE011= 2'b11} e_xhb_size_t;
  typedef xhb500_axi_to_ahb_bridge_external_system_pkg::xhb_size_t xhb_size_t;

  xhb500_axi_to_ahb_bridge_external_system_pkg::xhb_fsm_ctrl_t    fsm_ctrl;
  xhb500_axi_to_ahb_bridge_external_system_pkg::xhb_fsm_out_t     fsm_out;

  xhb500_axi_to_ahb_bridge_external_system_pkg::ahb_m_trfix_t     ahb_tr;
  xhb500_axi_to_ahb_bridge_external_system_pkg::ahb_m_hfix_t      ahb_h;
  xhb500_axi_to_ahb_bridge_external_system_pkg::ahb_m_wdata_t     ahb_w;

  logic                                     hmastlock_q;
  logic                                     hmastlock_err_q;
  logic [7:0]                               rd_left_q;
  xhb500_axi_to_ahb_bridge_external_system_pkg::xhb_size_t        tr_axsize_q;
  ...
  xhb500_axi_to_ahb_bridge_external_system_pkg::ahb_m_trq_t       sp_trq_q;
  logic                                     sp_tr_is_fixed_q;

  xhb500_axi_to_ahb_bridge_external_system_pkg::xhb_size_t        sp_axsize_tr_q;
  logic     [3:0]                           sp_wraplen_tr_q;
  logic     [11:0]                          sp_addr_11_0_q;
  logic                                     sp_tr_break_q;
  logic     [4-1:0]                         sp_strb_left_q;
  ...
  wire logic [4-1:0] aw_strb_mask;
  xhb500_axi_to_ahb_bridge_external_system_strbgen u_aw_strb_chk
  (
      .addr_in            (aw.axaddr[$clog2(4)-1:0]),
      .size_in            (aw.axsize),
  ...
  xhb500_axi_to_ahb_bridge_external_system_pkg::xhb_size_t        ar_bgst_size;
  xhb500_axi_to_ahb_bridge_external_system_pkg::xhb_size_t        nxt_unmr_bgst_size;
  ...
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::xhb_size_t   sp_aw_size_out;
  wire logic [4-1:0]                        sp_aw_strb_left;
  wire logic                                sp_aw_beat_finished;
  wire logic                                sp_aw_beat_sparse;
  wire logic                                sp_aw_beat_empty;
  wire logic                                sp_aw_beat_is_full;

  xhb500_axi_to_ahb_bridge_external_system_sparse u_aw_sparse
  (
  ...
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::xhb_size_t   sp_w_size_out;
  wire logic [4-1:0]                        sp_w_strb_left;
  wire logic                                sp_w_beat_finished;
  wire logic                                sp_w_beat_sparse;
  wire logic                                sp_w_beat_empty;
  wire logic                                sp_w_beat_is_full;

  xhb500_axi_to_ahb_bridge_external_system_sparse u_w_sparse
  (
  ...
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::xhb_size_t   sp_q_size_out;
  wire logic [4-1:0]                        sp_q_strb_left;
  wire logic                                sp_q_beat_finished;
  wire logic                                sp_q_beat_sparse;
  wire logic                                sp_q_beat_empty;
  wire logic                                sp_q_beat_is_full;

  xhb500_axi_to_ahb_bridge_external_system_sparse u_q_sparse
  (
      .addr_6_0_in        (sp_addr_11_0_q[6:0]),
      .axsize_in          (sp_axsize_tr_q),
  ...
  wire xhb500_axi_to_ahb_bridge_external_system_pkg::xhb_size_t   sp_size_out       = (sp_beat_finished_q & wvalid) ? sp_w_size_out      : sp_q_size_out;
  wire logic [4-1:0]                        sp_strb_left      = (sp_beat_finished_q & wvalid) ? sp_w_strb_left     : sp_q_strb_left;
  ...
  wire logic [4-1:0] wr_strb_mask;
  xhb500_axi_to_ahb_bridge_external_system_strbgen u_wr_strb_chk
  (
  ...
  xhb500_axi_to_ahb_bridge_external_system_pkg::ahb_m_trq_t   ar_trq;
  ...
  xhb500_axi_to_ahb_bridge_external_system_pkg::ahb_m_trq_t   aw_trq;
